 ...
 *
 * - **发布时机改判（2026-09-20 船长令）**：「寻找人类的任务只在完成所有第一次任务后才出现」——
 *   由 `core/onboarding.publishFindHumansWhenReady` 闸门在 13 条「第一次」全部做完的那一拍发布
 *   （**序章结束不再是发布点**，旧口径已作废）；发布本身照旧「正常发布、不告诉做法」（船长 2026-09-05）。
