    ...
    entries: [
      {
        title: '采矿',
        paras: [
          [tr("ui.Handbook.018"), '出港页「矿带开采」选带出击：原矿进驾驶船货仓，到港自动整仓卸入物品仓库。'],
      ...
      },
      {
        title: '精炼',
        paras: [
          [tr("ui.Handbook.018"), '工业页把原矿炼成原材料（「产出倍率」由精炼学与高级回收处理提升：基础 120%、技能最高 165%——无技能时炼矿净收益约为原料价值两成）。'],
          ['用途', '原材料是制造原料，也可卖出。'],
      ...
      },
      {
        ...
        paras: [
          [tr("ui.Handbook.023"), '市场可购到所有装备与舰船（协会保底艇、异星原型科技除外）的蓝图书：购图到「蓝图书架」学习一次即永久可造，再到工业页组装机按图备料开工，到点自动入库（装备进装备库、舰船进舰船仓库）。'],
          [tr("ui.Handbook.024"), '图纸价格随产物档位升高、在市场上出现得也稀罕；赶时间可以继续直接买成品现货，两条渠道并存。'],
    ...
    entries: [
      {
        title: '远征讨伐',
        paras: [
          [tr("ui.Handbook.018"), '星图「悬赏情报」选目标「出发」即开战：按火力结算，胜利得奖金 / 战利品 / 声望后自动返航（途中不可召回；停靠最近已建成站，无副站 = 母港）。'],
          [tr("ui.Handbook.028"), '失利扣耐久、可能弃船，同样自动返航（途中可召回）。'],
      ...
      },
      {
        ...
        paras: [
          ...
          [tr("ui.Handbook.029"), '抗性按递减方式合成（同一层装得越多越接近上限 90%，基础抗高的船提升越小）；伤害 / 射速 / 容量可以多装全量叠加（只受 CPU 限制），命中 / 闪避 / 抗性 / 速度同类多装收益递减（第 2 件约剩八成七、第 3 件约剩五成七）。「动力」影响弃船避险与跃迁充能。'],
      ...
      },
      {
        title: '耐久与维修',
        paras: [
          [tr("ui.Handbook.033"), '战斗磨损「结构」（= 耐久）与装甲：损伤跨场保留，结构归零弃船（货随船失）；护盾损失不保留（战斗中被动回充、脱战回满）。'],
          [tr("ui.Handbook.034"), '恢复：空间站付费维修，或货仓带「修理组件」野外应急（民用 / 军用两档，市场可买、工业页可自制；重复清剿会自动消耗）。'],
          [tr("ui.Handbook.035"), '想战中续命，可挂「船体维修装置」——每 5 秒自动修复装甲与结构，每跳吃掉一枚修理组件；实际修复量随装甲与结构容量加成、以及舰体快修学与维修工程学放大。'],
        ],
      },
    ],
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        paras: [
          [tr("ui.Handbook.040"), '打捞的残骸在工业页「残骸回收」里拆解：回收卡按敌群列出这批残骸的「保底原材料」，随 星系危险度 × 敌群威胁 上浮。'],
    ...
    entries: [
      {
        ...
        paras: [
          ...
          [tr("ui.Handbook.043"), '同时启用的 AI 核心总数受 AI 核心上限技能约束（Lv0 无法启用），AI 副船与站内精炼炉 / 回收炉 / 制造线共用该上限；站内产业可另练「工业自动化」扩容工业专用工位（每级 +2 枚、不占副船名额）。'],
      ...
      },
      {
        ...
        paras: [
          [tr("ui.Handbook.046"), '建成的副站并入协会基地网络：市场买卖、精炼与残骸回收、组装机制造线、维修补给、换驾驶卸货全部可用——设施与仓库和母港共享（同一市场与仓库）。'],
      ...
      },
      {
        ...
        paras: [
          ...
          [tr("ui.Handbook.053"), '同档之内还有子型号（炮舰、无人机母舰等）与更精贵的奇货版本。'],
        ],
      },
    ],
  },
    ...
    entries: [
      {
        title: tr("ui.App.033"),
        paras: [
          [tr("ui.Handbook.055"), '市场页：常驻供应 / 稀有订单 / 限定奇货三个标签，挂单与市价买卖；卖出成交收贸易税（练贸易技能减免）。'],
    ...
    entries: [
      {
        ...
        paras: [
          [tr("ui.Handbook.057"), '在星图「扫描虫洞」选项卡开始扫描（主控活动，深空工业协会声望 40 解锁）：扫描窗口基准 12 小时，受「信号分析学 / 星图测绘学 / 信号过滤学」与「星际奇遇学」（每级 −4%，满级 −20%）缩短。'],
    ...
    entries: [
      {
        ...
        paras: [
          ['标色', '星图星系标色：越高越安全。'],
          [tr("ui.Handbook.066"), '安全等级 ≥ 0.5 为高安，0 至 0.5 之间为中安，≤ 0 为低安——只有低安会遇到巡逻拦截与海盗伏击，安全等级越低越危险、越频繁。'],
        ],
      },
      {
      ...
      },
      {
        ...
        paras: [
          ...
          [tr("ui.Handbook.076"), '受损：敌方火力越强挨得越狠——先扣装甲、装甲吃穿才伤结构（底线 5%，绝不弃船）。'],
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        title: '重复舰船',
        paras: [
          [tr("ui.Handbook.086"), '同型可买多艘：第 2 艘起默认带「#N」。'],
      ...
      },
      {
        ...
        paras: [
          ...
          [tr("ui.Handbook.089"), '扫描艇无人驾驶——扫描期间照常采矿 / 打捞 / 远征 / 长途运输 / 进虫洞，反过来这些在忙时也能派艇；一次只派一艘，换目标先在星图页「终止扫描」（已扫部分保留，下次对该星系只补扫剩余窗口）。'],
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        paras: [
          [tr("ui.Handbook.099"), '扫描与前往各耗 1 回合，打捞、采集每次动作各耗 1 回合；激活地点不耗回合（含迎战层末守卫）。'],
