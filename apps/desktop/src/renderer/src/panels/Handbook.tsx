...
const GUIDE_GROUPS: GuideGroup[] = [
  ...
  },
  {
    title: '残骸与回收',
    rows: [
      ['打捞残骸', '驾驶船低槽装打捞器（无伤害件，升级只减周期）后，在星图「残骸打捞」选星系开捞：自动循环作业，满舱自动返航卸货后自动续捞（勾「本次返航卸货后停止」可做单趟）；低安星系打捞作业中可能遇袭，规则见「航行须知」。'],
  ...
  },
  {
    title: '市场与世界',
    rows: [
      ['交易', '市场页：常驻供应 / 稀有订单两栏，挂单与市价买卖；卖出成交收贸易税（练贸易技能减免）。市场全程挂单簿撮合，收购价低于供应价；集中买卖会带动价格短时偏离（冲击动量），原矿 / 原材料另受库存池调节。'],
...
const RULE_SECTS: RuleSect[] = [
  {
    ...
    rows: [
      ['安全等级', '星图星系标色：越高越安全。安全等级 ≥ 0.5 为高安，0 至 0.5 之间为中安，≤ 0 为低安——只有低安会遇到巡逻拦截与海盗伏击（中安与高安不会），安全等级越低越危险、越频繁。'],
