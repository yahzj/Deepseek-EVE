...
const GUIDE_ROWS: Array<[string, string]> = [
  ...
  ['精炼', '工业页把矿石炼成矿物（产出倍率由精炼学与高级回收处理提升：基础 120%、技能最高 150%——无技能时炼矿净收益约为原料价值的两成）；矿物是制造原料，也可卖出。精炼炉可多单位并行：主控亲自运转限 1 台（占主控工作位），每枚 AI 核心各驱动一台——同时启用的 AI 核心总数受 AI 核心上限技能约束（与 AI 副船任务等共用）；原料不锁定，每批到点从货仓+仓库实时扣取。'],
