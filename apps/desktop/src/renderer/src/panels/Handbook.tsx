...
const GUIDE_GROUPS: GuideGroup[] = [
  ...
  },
  {
    title: '虫洞探索',
    rows: [
      ['发现虫洞', '在星图「扫描虫洞」选项卡开始扫描（主控活动，深空工业协会声望 40 解锁）：扫描窗口基准 12 小时，受「信号分析学 / 星图测绘学 / 信号过滤学」与「星际奇遇学」（满级 −20%）缩短；进度满即发现一处虫洞存入库存，最多同时囤 5 处；每处锁定一个敌族、从第 1 层开始探索，进入即消耗该处——也可以派副船自动探索（约 5 分钟，收益约为亲自探索的四成，参与舰受损但不丢船），或直接放弃。'],
