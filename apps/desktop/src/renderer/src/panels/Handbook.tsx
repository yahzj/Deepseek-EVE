...
const GUIDE_ROWS: Array<[string, string]> = [
  ...
  ['远征', '出港页选悬赏目标出发（去程已取消，即时开战）：按火力胜率结算，胜利得奖金/战利品/声望，随后自动返航回港（去程并入返航，不可召回）；失利扣耐久、可能弃船，也会自动返航。'],
  ['AI 副船', '练「人工智能专家」+ 买基础 AI 核心，可给闲置舰船指派自动采矿/打捞/掩护巡逻任务（核心效率越高越快）。AI 远征已下线：悬赏请主控亲自出击。'],
...
const RULES_LOWSEC: Array<[string, string]> = [
  ...
  ['什么会遇袭', '低安只对「停留与就地作业」动手：矿带采掘中、打捞作业中、扫描期间、掩护巡逻驻留都可能撞见巡逻拦截或海盗伏击；航行与返航途中不会遇袭（移动不暴露，2026-09-06 口径）。AI 副船同样适用。'],
