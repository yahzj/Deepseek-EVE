    ...
    entries: [
      ...
      },
      {
        ...
        paras: [
          ...
          ['修不动就撤', '组件不足、或补完后结构仍低于 50%，才收手返港待命——驾驶船停下采掘 / 打捞 / 扫描虫洞并即时返航最近已建成站，副船中止任务召回（副船结构低于 50% 需修好才能再派）。'],
        ],
      },
      {
        title: '迎战也有保险',
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        title: '星系扫描',
        paras: [
          ['怎么扫', '星图上对「未知信号」（剪影星系）派出一艘无人深空扫描艇：窗口走完即点亮该星系，航线、矿带与悬赏情报全部解锁。窗口基准约 10 分钟，越危险的星系扫得越久。'],
