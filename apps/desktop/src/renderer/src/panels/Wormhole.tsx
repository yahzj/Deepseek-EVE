/**
 * 终局玩法「虫洞」· 面板（E 批 2026-09-13 起 · F3a-2 层内网格 2026-09-13 · **2026-09-14 上线**）。
 *
 * ✅ **可见性（船长 2026-09-14 解除不可见）**：虫洞**已对玩家开放** —— 玩家入口 = 星图「扫描虫洞」选项卡
 * （`pages/MapPage.tsx`，常显；解锁门槛 = 协会声望 40），数据侧的 `unreleased` 闸门同批撤除；
 * 调试入口（远征页行动区，免库存直接开一趟）保留给验收用。作废留档：2026-09-13 施工期铁律见设计稿
