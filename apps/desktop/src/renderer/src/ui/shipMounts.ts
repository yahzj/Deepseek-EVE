...
export const FOE_SHIP_MOUNTS: Record<string, ShipMounts> = {
  ...
  // 畸变幼虫：獠牙尖(pod 220,31 右端 224,31) + 两片膜翼端点(24,46)/(24,82)
  ...
  // 星髓幼虫：背部晶簇三尖 (118,26)/(136,20)/(152,28) + 体前短螯端(72,40)
  ...
  // 星髓成虫：节间缝上三处结晶尖 (98,22)/(120,18)/(152,26) + 头部甲壳前缘(60,48)
  ...
  // 孢群异虫：口器两瓣尖端 (38,64)/(38,78) + 四枚孢子囊囊口 (112,23)/(140,21)/(112,105)/(140,107)
  ...
  // 噬口巨兽：巨口最前缘(210,64) + 背部骨刺三尖 (138,20)/(114,28)/(92,34)
  'foe-alien-maw': {
    engines: [],
    muzzles: [
      { x: 210, y: 64 },
