...
const SHAPES: Record<string, ReactNode> = {
  ...
  /* ── 虫洞敌族徽（丁 · 2026-09-14 船长定案：一处虫洞锁一族，列表里给玩家看） ──
     ...
     A 劫掠支队=交叉刃 · C 星髓游猎群=三点群 · D 守墓巡哨=陵柱 · E 巨构残响=菱形残壳 · G 亡军封锁=封锁斜栅 */
  'fam-a': (
    <g>
   ...
   * 第二批（里程碑成就 · 2026-09-20 已落码）的六枚图案见本族末尾 `ach-mile-*`。
   */
  'ach-first': (
    <g>
      {/* 任务纪念徽：盾 + 中央星点 */}
  ...
  /**
   * ── **里程碑成就的图案族**（第二批 · 船长 2026-09-20「开始第二批」）──
   *
   * 命名 = `ach-mile-<家族>`（与数据侧 `pattern: 'mile-<slot>'` 一一对应）。
   * ⚠ **与链徽章的分工**：链徽章是"**同图案 · 靠颜色分档**"，里程碑反过来 =
   * "**同颜色（金）· 靠图案分家族**" ⇒ 两类徽章在同一张网格里一眼可辨。
   * 每个家族一个形状，族内多档（如深渊 2/3/4/5 层）**共用一枚底纹**。
   */
  'ach-mile-depth': (
    <g>
      {/* 深渊层深：向下的层叠箭标 */}
      <path d="M12 3.4l7 2.6v6.2c0 4-3 6.8-7 8.4-4-1.6-7-4.4-7-8.4V6z" />
      <path d="M12 7.4v7.2" />
      <path d="M9.4 12l2.6 2.6 2.6-2.6" />
    </g>
  ),
  'ach-mile-guard': (
    <g>
      {/* 层末守卫：交叉双刃 */}
      <path d="M12 3.4l7 2.6v6.2c0 4-3 6.8-7 8.4-4-1.6-7-4.4-7-8.4V6z" />
      <path d="M9 8.4l6 6.4M15 8.4l-6 6.4" />
    </g>
  ),
  'ach-mile-cache': (
    <g>
  ...
  'ach-mile-core': (
    <g>
      ...
      <path d="M8.8 11.2a3.2 3.2 0 106.4 0 3.2 3.2 0 00-6.4 0" />
    </g>
  ),
  'ach-mile-outpost': (
    <g>
  ...
  'ach-mile-tech': (
    <g>
      {/* 谜质科技：节点与连线 */}
      <path d="M12 3.4l7 2.6v6.2c0 4-3 6.8-7 8.4-4-1.6-7-4.4-7-8.4V6z" />
      <circle cx="9.6" cy="9.4" r="1.2" />
      <circle cx="14.4" cy="13" r="1.2" />
      <path d="M10.6 10.2l2.8 2" />
      <path d="M12 12.4v2.8" />
    </g>
  ),
  fallback: (
