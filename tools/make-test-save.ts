...
function injectShipArt(state: GameState): string[] {
  ...
  notes.push('全舰耐久回满')
  notes.push('测试路径：星图·战斗悬赏逐敌族开战对照造型——A 海盗（赤潮/碎晶/灰霾/蜃影/边境海盗/信标猎手）、B 拾荒者（演习场驱逐令/新港护航/占港拾荒）、C 异形（裂谷畸变/星髓/噬口/深渊之门）、D 守墓（坟场/虚海/穹顶/幽灵舰）、E 泰坦（泰坦残骸/奥罗残骸）、F 制式巡逻（低安遭遇伏击）、G 烬火流亡（烬火/回音/天底静区）；重点看新规格 240×110：舰首朝右、族色件与敌族发光件、尾焰/枪口闪光落点、敌我大小比例、受击/残骸表现、翻转移位；细节锚点与比例问题回传（详见 ship-battle-art 验收清单文档）')
  return notes
}
