 ...
 * ⚠ **2026-09-16 当日回调**：船长看读数后「**D族的血量削弱回调为85%**」⇒ 由 0.7 改为 **0.85**）。
 *
 * 依据：其他族「洞内层 1 血 ÷ 该卡自然血」= A 4.79 / C 1.86 / E 3.53 / G 7.46 ⇒ 平均 **4.41×**；
 * 按 4.41 折算 D 的洞外血（幽灵舰信号 555）得 2,448（= 现值 ×0.7）——**偏狠**，船长回调到 ×0.85：
 * 层 1 **2,967** · 层 2 3,833 · 守卫 5,086（等价放大倍率 5.35，仍在其他族 1.86~7.46 的带内）。
 * 此时 D 的「血/火力比」= 31~34，落在**洞外 D 带 21.8~45.3** 里。
 */
export const WORMHOLE_GRAVE_HP_MUL = 0.85
