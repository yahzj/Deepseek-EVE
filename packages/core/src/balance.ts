...
export const DEFAULT_BALANCE: BalanceConfig = {
  ...
  combat: {
     ...
     *
     * ⚠ **2026-09-14 船长改判：「玩家撤离战斗按照 10 秒算」⇒ 1 秒作废，现值 10 秒**。
     * 范围经船长逐条裁定：**四档一起改、同一 K**——玩家主动撤退 / 结构<50% 自动脱离 /
     * 战斗超时被迫撤退 / **无法交战**（够不着、一炮未发）；**虫洞的撤离战不在内**
     * （走真实战斗损伤，不吃本值）。读数：一口 = 威胁 × 8 HP（威胁 42 的入门低安卡 ⇒ 336 HP；
     * 参照船体总量 沙猫级 51 / 灰鲭鲨级 192 / 长尾鲨级 323 / 玳瑁级 790 / 玄武级 1107）。
     * 窝点档按**派生后威胁**算（见 `expedition.settleBattleRetreat`，与界面/战斗同口径）。
     */
    retreatHitFirepowerSec: 10,
