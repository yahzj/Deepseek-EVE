...
export const DEFAULT_BALANCE: BalanceConfig = {
  ...
  battle: {
    ...
    // 2N/(N+1)、**不含机群**、**不含被 droneFireShare / firepowerAnchor 拆分的条目**。现值 150 ⇒
    // 现有 27 张卡全部未越线（实测最高 = 虚海守望者 131.25 DPS）⇒ **零行为变化**，只为将来的
    // 战列舰/旗舰级内容留天花板：每单位威胁触顶值 = 150 ÷ 0.8 ÷ 补偿 ⇒ N=1 187.5 · N=3 125 · N=4 117.2 · N=11 102.3。
    foeDpsCap: 150,
