 ...
 *    货舱 **5,600 m³**（原案 ×3 = 6,600；2026-09-26 船长令「鹦鹉螺货仓减少1000」）· 循环 14 秒产 **39** 单位 · 行价 9,000,000（贴长尾鲨级）；
...
describe('鹦鹉螺级测绘巡洋舰（2026-09-13 船长新增）', () => {
  it('舰体定案：T3 侦察舰 · 11 槽（4/4/3，2026-09-14 +1）· 机舱 160 · 货舱 5,600 · 产 39/14 秒', () => {
    ...
    expect(s.cargoM3).toBe(5_600) // 原案「货仓可以乘*3」= 6,600；2026-09-26 船长令「鹦鹉螺货仓减少1000」⇒ 5,600
