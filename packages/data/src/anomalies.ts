...
export const ANOMALIES: readonly AnomalyDef[] = [
  {
    ...
    combatSeconds: 20,
    description:
      "深空工业协会的例行清场令：拾荒船常年在演习场边缘翻捡演习残骸，协会按次悬赏驱逐。悬赏常设、可反复接取——新手的第一张长期单。",
  },
  {
    id: "ano-pirate-post",
    ...
    combatSeconds: 20,
    description:
      "通缉册上的老面孔：柯尔边境的前哨海盗团长期袭扰新手商路。悬赏常设，击溃即结算，可反复接取。",
  },
  {
    ...
    combatSeconds: 20,
    description:
      "长期通缉：武装拾荒者盘踞废弃采掘平台多年，协会悬赏清除其火力点。",
  },
  {
    ...
    ships: [
      {
        ...
        rangeMinM: Math.round(
          FOE_SHIP_PIRATE_SNIPER.rangeMinM * REDRING_RANGE_MUL,
        ),
        rangeMaxM: Math.round(
          FOE_SHIP_PIRATE_SNIPER.rangeMaxM * REDRING_RANGE_MUL,
        ),
        tactic: "kite",
    ...
    combatSeconds: 70,
    description:
      "红环航道的老牌劫掠舰队，通缉令在协会悬赏板上挂了五年——击退其主力即可结算，可反复接取。",
  },
  {
    id: "ano-gravekeeper",
    ...
    combatSeconds: 60,
    description:
      "暗星坟场的守墓舰队从不轮换，协会对它的通缉令也从未撤销：击退一次，结算一次。",
  },
  {
    id: "ano-ghost-signal",
    foeFamily: "D", // 敌族（与美术层 FOE_ART 族字母同源）
    ...
    combatSeconds: 90,
    description:
      "一桩悬了许久的疑案：幽灵舰定期在红环深处现身又消失。协会对每一次成功接触都发放调查赏金——它到底是什么，至今没人说清。",
  },
  {
    id: "ano-abyss-guard",
    ...
    combatSeconds: 75,
    description:
      "深渊之门常年有人值守，也常年需要民间火力分担防务。协会常驻悬赏：按次结算，声望仅首胜授予。",
  },
  {
    id: "ano-titan-wreck",
    ...
    combatSeconds: 90,
    description:
      "一具远古泰坦残骸静卧深渊航道，协会长期征集武装护航下的勘探与清剿——击退守墓编队，赏金照发。",
  },
  {
    id: "ano-auro-raiders",
    foeFamily: "E", // 敌族（与美术层 FOE_ART 族字母同源）
    ...
    combatSeconds: 100,
    description:
      "奥罗荒环的武装残骸会被风暴反复激活，协会的猎杀令因此常年有效：按次结算，可反复接取。",
  },
  {
    ...
    combatSeconds: 100,
    description:
      "星髓迷宫深处有东西在筑巢。协会将它列入最高级长期悬赏：进去的人要自己数着命回来。",
  },
  ...
  // ── 星图拓展（V12 深空悬赏：20 星系网络的远端目标） ──
  {
    ...
    combatSeconds: 85,
    description:
      "烬火星区的防线战事常年不断，协会长期悬赏民间火力增援——击退一次围攻编队，结算一次赏金。",
  },
  {
    id: "ano-echo-haunt",
    dmgMix: { kinetic: 8, explosive: 2 }, // 混伤 8:2（2026-09-10 船长：主系 80% + 副系 20%，副系按族签名）
    ...
    combatSeconds: 110,
    description:
      "回音荒区的残舰群会不断“复活”，协会认为是残余自动化程序作祟。长期清剿令按次结算。",
  },
  {
    id: "ano-nadir-static",
    dmgMix: { kinetic: 8, explosive: 2 }, // 混伤 8:2（2026-09-10 船长：主系 80% + 副系 20%，副系按族签名）
    ...
    combatSeconds: 100,
    description:
      "天底是条死胡同，也是流亡舰队最后的据点。协会长年封锁此区，悬赏每一次突破防线的清剿。",
  },
  {
    id: "ano-maw-hunt",
    foeFamily: "C", // 敌族（与美术层 FOE_ART 族字母同源）
    ...
    combatSeconds: 160,
    description:
      "星噬之口吞噬过太多舰队。协会悬赏一切能削弱其守军的行动——常设令，可反复接取。",
  },
  {
    ...
    combatSeconds: 55,
    description:
      "穹顶墓园的守墓舰队是现存最古老的武装力量，协会将其列为全星域最高悬赏——无人知晓它们为何仍在巡弋。",
  },
  {
    ...
    combatSeconds: 60,
    description:
      "虚海边缘的守望者只对强敌回应。协会常年保留这份最高级通缉，等待能活着带回战报的人。",
  },
  // ══════════ V16.1 内容补充：为空缺星系添加的长期悬赏 ══════════
  {
    ...
    combatSeconds: 20,
    description:
      "新港走廊的商路劫案从未断过。协会长期悬赏护航协防：击退小型劫掠艇按次结算——新手练兵的第一张常驻单。",
  },
  {
    ...
    combatSeconds: 25,
    description:
      "碎晶带的晶尘里藏着一伙专劫曦棱晶货船的惯匪。通缉长期有效，可反复接取。",
  },
  {
    ...
    combatSeconds: 20,
    description:
      "灯塔长廊的信标阵列屡遭破坏，修复费用高昂。协会悬赏猎杀破坏信标的惯犯——本单长期有效。",
  },
  {
    id: "ano-haze-ambush",
    foeFamily: "A", // 敌族（与美术层 FOE_ART 族字母同源）
    ...
    combatSeconds: 70,
    description:
      "灰霾带的电离云是天然的伏击场——一伙劫掠团常年盘踞环心航路。协会发布长期清剿令，按次结算。",
  },
  {
    ...
    ships: [
      {
        ...
        // ⇒ 同卡同带（与杂鱼同式的变体倍率推导，**不手抄数字**）
        rangeMinM: Math.round(
          FOE_SHIP_PIRATE_SNIPER.rangeMinM * MIRAGE_RANGE_MUL,
        ),
        rangeMaxM: Math.round(
          FOE_SHIP_PIRATE_SNIPER.rangeMaxM * MIRAGE_RANGE_MUL,
        ),
        tactic: "kite",
        dmgMix: { plasma: 8, kinetic: 2 },
      },
    ...
    combatSeconds: 100,
    description:
      "蜃影的引力透镜是天然的埋伏场，海盗借此劫持迷航商船。协会长期悬赏清除这些导航劫持者。",
  },
  {
    ...
    combatSeconds: 100,
    description:
      "裂谷深带的引力畸变催生出集群异形，威胁深层矿道。协会将其列为长期高危猎杀令。",
  },
...
export const ANOMALIES_FLAVORED: readonly AnomalyDef[] =
  ANOMALIES.map(withRecycleFlavor);
