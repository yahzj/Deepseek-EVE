...
export const SKILLS: readonly SkillDef[] = [
  ...
  },
  {
    ...
    group: '工业',
    rank: 3,
    // 2026-09-08 工业工位收益体检再定：基础 100%→120%（无技能净率 ≈+20%）；每级 8%→4%
    description: '精炼炉产出倍率：每级提高 ⟦4%⟧（基础 ⟦120%⟧，无技能时炼矿净收益约两成；与高级回收处理双修满级合计 ⟦150%⟧）。',
  },
  {
    id: 'reprocessing',
    name: '高级回收处理',
    group: '工业',
    rank: 4,
    description: '进一步提高精炼产出倍率：每级 +⟦2%⟧（与精炼学双修满级合计 ⟦150%⟧）。',
  },
  {
    id: 'industry',
    name: '工业理论',
