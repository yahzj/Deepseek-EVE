...
export const SKILLS: readonly SkillDef[] = [
   ...
   * 四条新技能覆盖"打得更痛 / 更耐打 / 更难被点中 / 战后捡得回来"四个维度；数值接线在 core/combat.ts */
  {
    id: 'drone-strike',
    name: '无人机打击学',
    group: '战斗',
  ...
  },
  {
    ...
    group: '战斗',
    rank: 2,
    description: '机体加固与冗余线路：无人机三层血量（护盾 / 装甲 / 结构）每级 +⟦10%⟧（满级 +⟦50%⟧，直接放大全血条）。',
  },
  {
    id: 'drone-recovery',
    name: '无人机回收学',
  ...
  },
  {
    ...
    group: '战斗',
    rank: 4,
    description: '机群规避机动训练：无人机闪避每级 +⟦4%⟧（相对乘算，闪避上限 ⟦90%⟧；对近防炮尤其有效）。',
  },
