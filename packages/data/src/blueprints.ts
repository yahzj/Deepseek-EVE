...
export const BLUEPRINTS: readonly BlueprintDef[] = [
  ...
  },
  {
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「掠袭加力器」的制造工艺，写在整块母岩切片上——**只能用一次**。红线标着过载上限：别越过去。',
  },
  {
    id: 'bp-wh-a-coat',
    name: '赃物折射涂层图纸（一次性）',
  ...
  },
  {
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「赃物扫描阵」的制造工艺，写在整块母岩切片上——**只能用一次**。校准次序是这门手艺的关键。',
  },
  {
    id: 'bp-wh-a-shield',
    name: '掠夺者护盾笼图纸（一次性）',
  ...
  },
  {
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「活性甲壳层」的制造工艺，写在整块母岩切片上——**只能用一次**。它是要"养"出来的，图上写着养护的温度。',
  },
  {
    id: 'bp-wh-c-prism',
    name: '甲壳棱镜层图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「甲壳棱镜层」的制造工艺，写在整块母岩切片上——**只能用一次**。析晶方向错一格，整层就白做。',
  },
  {
    id: 'bp-wh-c-pulse',
    name: '生体脉搏加速器图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「生体脉搏加速器」的制造工艺，写在整块母岩切片上——**只能用一次**。节拍器那一页被翻得最旧。',
  },
  {
    id: 'bp-wh-c-missile',
    name: '孢子导弹巢图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「孢子导弹巢」的制造工艺，写在整块母岩切片上——**只能用一次**。散布参数写得极宽，像是故意的。',
  },
  {
    id: 'bp-wh-c-frame',
    name: '几丁质骨架层图纸（一次性）',
  ...
  },
  {
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「陵墓护盾芯」的制造工艺，写在整块母岩切片上——**只能用一次**。核心的对齐公差，图上写到了小数第三位。',
  },
  {
    id: 'bp-wh-d-lock',
    name: '守墓者丧钟图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「守墓者丧钟」的制造工艺，写在整块母岩切片上——**只能用一次**。锁定逻辑只有一页，字迹却格外用力。',
  },
  {
    id: 'bp-wh-d-laser',
    name: '陵寝棱镜炮图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「陵寝棱镜炮」的制造工艺，写在整块母岩切片上——**只能用一次**。棱镜的切割角度是整张图的核心机密。',
  },
  {
    id: 'bp-wh-d-loader',
    name: '守墓者速装填机图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「守墓者速装填机」的制造工艺，写在整块母岩切片上——**只能用一次**。机械臂的行程图，是整卷里最细的一张。',
  },
  {
    id: 'bp-wh-d-steady',
    name: '陵墓弹道铭文图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「陵墓弹道铭文」的制造工艺，写在整块母岩切片上——**只能用一次**。刻痕深浅写得很讲究：那是校准量。',
  },
  {
    id: 'bp-wh-e-dc',
    name: '巨构损管阵列图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「巨构损管阵列」的制造工艺，写在整块母岩切片上——**只能用一次**。管网走向图，密得像一张地图。',
  },
  {
    id: 'bp-wh-e-tac',
    name: '巨构导控塔图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「巨构导控塔」的制造工艺，写在整块母岩切片上——**只能用一次**。塔身的每一层都有独立的校准记录。',
  },
  {
    id: 'bp-wh-e-cpu',
    name: '巨构协处理器图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「巨构协处理器」的制造工艺，写在整块母岩切片上——**只能用一次**。算力预算那一页，被反复圈过好几道。',
  },
  {
    id: 'bp-wh-e-pd',
    name: '巨构近防阵列图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「巨构近防阵列」的制造工艺，写在整块母岩切片上——**只能用一次**。阵列的布点图是一圈同心环。',
  },
  {
    id: 'bp-wh-e-shield',
    name: '巨构护盾矩阵图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「巨构护盾矩阵」的制造工艺，写在整块母岩切片上——**只能用一次**。三系抗性的配平表，是整卷的最后一页。',
  },
  {
    id: 'bp-wh-e-steady',
    name: '巨构稳态器图纸（一次性）',
    moduleId: 'mod-wh-e-steady',
    singleUse: true,
    unreleased: true,
    materials: [
      { itemId: 'min-tritanium', count: 14_000 },
      ...
      { itemId: 'min-darkiron', count: 160 },
      { itemId: 'min-voidcrystal', count: 75 },
    ],
    buildSeconds: 3600,
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「巨构稳态器」的制造工艺，写在整块母岩切片上——**只能用一次**。减振结构的剖面图，一层套着一层。',
  },
  {
    id: 'bp-wh-g-hangar',
    name: '亡军蜂巢坞图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「亡军蜂巢坞」的制造工艺，写在整块母岩切片上——**只能用一次**。六边形格架的画法，是从实物上描下来的。',
  },
  {
    id: 'bp-wh-g-fcs',
    name: '亡军火控残响图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「亡军火控残响」的制造工艺，写在整块母岩切片上——**只能用一次**。参数旁边写着批注，署名已经看不清了。',
  },
  {
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「幽灵弹道校正器」的制造工艺，写在整块母岩切片上——**只能用一次**。校正曲线只画了动能那一条。',
  },
  {
    id: 'bp-wh-g-hull',
    name: '残兵结构层图纸（一次性）',
  ...
  },
  {
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「亡军残炮」的制造工艺，写在整块母岩切片上——**只能用一次**。三门炮的零件图被剪下来贴成了一页。',
  },
  {
    id: 'bp-wh-g-prop',
    name: '幽灵推进器图纸（一次性）',
    ...
    buildCostIsk: 0,
    priceIsk: 0,
    description: '「幽灵推进器」的制造工艺，写在整块母岩切片上——**只能用一次**。喷口那一页是空白的：它不留痕迹。',
  },
]
