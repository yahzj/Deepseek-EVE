...
export const BLUEPRINTS: readonly BlueprintDef[] = [
  ...
  },
  {
    ...
    materials: [
      ...
      { itemId: 'part-qchip', count: 427 },
      { itemId: 'part-circuit', count: 1 },
    ],
    buildSeconds: 4600,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    materials: [
      ...
      { itemId: 'part-qchip', count: 324 },
      { itemId: 'part-circuit', count: 2 },
    ],
    buildSeconds: 3600,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    materials: [
      ...
      { itemId: 'part-qchip', count: 511 },
      { itemId: 'part-circuit', count: 3 },
    ],
    buildSeconds: 5000,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    materials: [
      ...
      { itemId: 'min-voidcrystal', count: 100 },
      { itemId: 'part-qchip', count: 502 },
      { itemId: 'part-circuit', count: 4 },
    ],
    buildSeconds: 5400,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    materials: [
      ...
      { itemId: 'part-qchip', count: 797 },
      { itemId: 'part-circuit', count: 5 },
    ],
    buildSeconds: 5000,
    buildCostIsk: 0,
  ...
  // ═══════════ 零件蓝图（2026-09-20 船长「组装机内新增零件分页」；基础 = 隐式蓝图无需学习 · 高级 = 需学习） ═══════════
  {
    ...
    partTier: 'basic',
    materials: [
      { itemId: 'min-pyerite', count: 4 },
      { itemId: 'min-mexallon', count: 1 },
    ],
    buildSeconds: 45,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    partTier: 'basic',
    materials: [
      { itemId: 'min-tritanium', count: 15 },
      { itemId: 'min-pyerite', count: 5 },
    ],
    buildSeconds: 60,
    buildCostIsk: 0,
    priceIsk: 0,
  ...
  },
  {
    ...
    partTier: 'basic',
    materials: [
      { itemId: 'min-tritanium', count: 10 },
      { itemId: 'min-pyerite', count: 2 },
    ],
    buildSeconds: 50,
    buildCostIsk: 0,
    priceIsk: 0,
  ...
  },
  {
    ...
    partTier: 'basic',
    materials: [
      { itemId: 'min-pyerite', count: 6 },
      { itemId: 'min-mexallon', count: 2 },
    ],
    buildSeconds: 55,
    buildCostIsk: 0,
    priceIsk: 0,
  ...
  },
  {
    ...
    partTier: 'basic',
    materials: [
      { itemId: 'min-nocxium', count: 2 },
      { itemId: 'min-pyerite', count: 10 },
    ],
    buildSeconds: 90,
    buildCostIsk: 0,
    priceIsk: 0,
  ...
  },
  {
    ...
    partTier: 'basic',
    materials: [
      { itemId: 'min-mexallon', count: 4 },
      { itemId: 'min-isotope', count: 1 },
    ],
    buildSeconds: 75,
    buildCostIsk: 0,
    priceIsk: 0,
  ...
  },
  {
    ...
    materials: [
      { itemId: 'part-circuit', count: 2 },
      { itemId: 'min-mexallon', count: 8 },
      { itemId: 'min-nocxium', count: 3 },
    ],
    buildSeconds: 300,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    partTier: 'advanced',
    materials: [
      { itemId: 'part-cable', count: 2 },
      { itemId: 'min-mexallon', count: 10 },
      { itemId: 'min-isotope', count: 3 },
    ],
    buildSeconds: 360,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    partTier: 'advanced',
    materials: [
      { itemId: 'part-lens', count: 2 },
      { itemId: 'min-nocxium', count: 6 },
      { itemId: 'min-isotope', count: 2 },
    ],
    buildSeconds: 480,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    partTier: 'advanced',
    materials: [
      { itemId: 'part-frame', count: 6 },
      { itemId: 'min-nocxium', count: 8 },
      { itemId: 'min-starcore', count: 2 },
    ],
    buildSeconds: 900,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    partTier: 'advanced',
    materials: [
      { itemId: 'part-keel', count: 1 },
      { itemId: 'min-nocxium', count: 10 },
      { itemId: 'min-starcore', count: 4 },
    ],
    buildSeconds: 1_200,
    buildCostIsk: 0,
