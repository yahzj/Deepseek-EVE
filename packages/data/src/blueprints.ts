...
export const BLUEPRINTS: readonly BlueprintDef[] = [
   ...
   * 材料 = **零件为主 + 该族特色矿物**（2026-09-20 船长「调整专属舰船和装备使用零件的比例，需要提高」：
   * 按**材料价值**基础零件 45% + 高级零件 30% + 矿物 25%，**等值替换**（总价分文不变）、
   * 每张只留至多 4 行矿物——原「材料必须全是矿物」的硬契约同日作废，`content:check` 的材料契约已放宽为矿物/零件）；
   ...
   * ⚠ **施工期闸门**：全部标 `unreleased: true`（手册蓝图图鉴 / 组装机蓝图下拉都遍历全目录）。 */
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-voidcrystal', count: 41 },
      { itemId: 'min-tritanium', count: 9_840 },
      { itemId: 'min-mexallon', count: 3_590 },
      { itemId: 'part-frame', count: 1_467 },
      { itemId: 'part-armor-plate', count: 425 },
      { itemId: 'part-cable', count: 514 },
      { itemId: 'part-circuit', count: 839 },
      { itemId: 'part-coolant', count: 462 },
      { itemId: 'part-jet-array', count: 102 },
      { itemId: 'part-fire-control', count: 74 },
      { itemId: 'part-qchip', count: 101 },
    ],
    buildSeconds: 5400,
    buildCostIsk: 0, // 制造费已取消（字段历史遗留）
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-voidcrystal', count: 32 },
      { itemId: 'min-tritanium', count: 7_555 },
      { itemId: 'min-mexallon', count: 2_510 },
      { itemId: 'part-frame', count: 1_111 },
      { itemId: 'part-armor-plate', count: 322 },
      { itemId: 'part-cable', count: 390 },
      { itemId: 'part-circuit', count: 637 },
      { itemId: 'part-coolant', count: 351 },
      { itemId: 'part-drone-neural', count: 130 },
      { itemId: 'part-qchip', count: 134 },
      { itemId: 'part-shield-gen', count: 53 },
    ],
    buildSeconds: 4600,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-voidcrystal', count: 25 },
      { itemId: 'min-tritanium', count: 5_805 },
      { itemId: 'min-mexallon', count: 1_959 },
      { itemId: 'part-frame', count: 845 },
      { itemId: 'part-armor-plate', count: 245 },
      { itemId: 'part-cable', count: 296 },
      { itemId: 'part-circuit', count: 483 },
      { itemId: 'part-coolant', count: 266 },
      { itemId: 'part-grav-comp', count: 12 },
      { itemId: 'part-keel', count: 22 },
      { itemId: 'part-qchip', count: 58 },
    ],
    buildSeconds: 3600,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-voidcrystal', count: 23 },
      { itemId: 'min-tritanium', count: 5_170 },
      { itemId: 'min-mexallon', count: 1_921 },
      { itemId: 'part-frame', count: 761 },
      { itemId: 'part-armor-plate', count: 220 },
      { itemId: 'part-cable', count: 267 },
      { itemId: 'part-circuit', count: 435 },
      { itemId: 'part-coolant', count: 239 },
      { itemId: 'part-keel', count: 29 },
      { itemId: 'part-qchip', count: 78 },
  ...
  },
  {
    ...
    materials: [
      ...
      { itemId: 'min-tritanium', count: 5_305 },
      { itemId: 'min-mexallon', count: 1_935 },
      { itemId: 'part-frame', count: 785 },
      { itemId: 'part-armor-plate', count: 228 },
      { itemId: 'part-cable', count: 276 },
      { itemId: 'part-circuit', count: 451 },
      { itemId: 'part-coolant', count: 248 },
      { itemId: 'part-qchip', count: 136 },
      { itemId: 'part-fire-control', count: 34 },
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-voidcrystal', count: 37 },
      { itemId: 'min-tritanium', count: 9_030 },
      { itemId: 'min-mexallon', count: 3_194 },
      { itemId: 'part-frame', count: 1_333 },
      { itemId: 'part-armor-plate', count: 386 },
      { itemId: 'part-cable', count: 467 },
      { itemId: 'part-circuit', count: 763 },
      { itemId: 'part-coolant', count: 420 },
      { itemId: 'part-shield-gen', count: 191 },
      { itemId: 'part-qchip', count: 184 },
    ],
    buildSeconds: 5000,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-voidcrystal', count: 39 },
      { itemId: 'min-tritanium', count: 9_080 },
      { itemId: 'min-mexallon', count: 3_554 },
      { itemId: 'part-frame', count: 1_397 },
      { itemId: 'part-armor-plate', count: 405 },
      { itemId: 'part-cable', count: 490 },
      { itemId: 'part-circuit', count: 800 },
      { itemId: 'part-coolant', count: 440 },
      { itemId: 'part-jet-array', count: 98 },
      { itemId: 'part-fire-control', count: 70 },
      { itemId: 'part-qchip', count: 96 },
    ],
    buildSeconds: 5400,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-voidcrystal', count: 40 },
      { itemId: 'min-mexallon', count: 3_637 },
      { itemId: 'min-tritanium', count: 8_550 },
      { itemId: 'part-frame', count: 1_365 },
      { itemId: 'part-armor-plate', count: 396 },
      { itemId: 'part-cable', count: 479 },
      { itemId: 'part-circuit', count: 782 },
      { itemId: 'part-coolant', count: 430 },
      { itemId: 'part-keel', count: 52 },
      { itemId: 'part-qchip', count: 141 },
  ...
  },
  {
    ...
    materials: [
      { itemId: 'min-voidcrystal', count: 22 },
      { itemId: 'min-mexallon', count: 2_233 },
      { itemId: 'min-tritanium', count: 5_355 },
      { itemId: 'part-frame', count: 808 },
      { itemId: 'part-armor-plate', count: 235 },
      { itemId: 'part-cable', count: 284 },
      { itemId: 'part-circuit', count: 464 },
      { itemId: 'part-coolant', count: 255 },
      { itemId: 'part-qchip', count: 140 },
      { itemId: 'part-fire-control', count: 35 },
      { itemId: 'part-grav-comp', count: 5 },
    ],
    buildSeconds: 3600,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    materials: [
      { itemId: 'min-voidcrystal', count: 37 },
      { itemId: 'min-mexallon', count: 3_346 },
      { itemId: 'min-tritanium', count: 8_350 },
      { itemId: 'part-frame', count: 1_308 },
      { itemId: 'part-armor-plate', count: 379 },
      { itemId: 'part-cable', count: 459 },
      { itemId: 'part-circuit', count: 749 },
      { itemId: 'part-coolant', count: 412 },
      { itemId: 'part-jet-array', count: 91 },
      { itemId: 'part-fire-control', count: 66 },
      { itemId: 'part-qchip', count: 90 },
    ],
    buildSeconds: 5400,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    materials: [
      { itemId: 'min-voidcrystal', count: 40 },
      { itemId: 'min-tritanium', count: 9_680 },
      { itemId: 'min-mexallon', count: 3_251 },
      { itemId: 'part-frame', count: 1_375 },
      { itemId: 'part-armor-plate', count: 399 },
      { itemId: 'part-cable', count: 483 },
      { itemId: 'part-circuit', count: 788 },
      { itemId: 'part-coolant', count: 434 },
      { itemId: 'part-keel', count: 53 },
      { itemId: 'part-qchip', count: 142 },
      { itemId: 'part-grav-comp', count: 8 },
    ],
    buildSeconds: 5000,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    materials: [
      ...
      { itemId: 'min-starcore', count: 492 },
      { itemId: 'min-darkiron', count: 113 },
      { itemId: 'min-tritanium', count: 9_220 },
      { itemId: 'part-frame', count: 2_194 },
      { itemId: 'part-armor-plate', count: 636 },
      { itemId: 'part-cable', count: 769 },
      { itemId: 'part-circuit', count: 1_256 },
      { itemId: 'part-coolant', count: 691 },
      { itemId: 'part-jet-array', count: 153 },
      { itemId: 'part-fire-control', count: 111 },
      { itemId: 'part-qchip', count: 151 },
    ],
    buildSeconds: 5600,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-darkiron', count: 242 },
      { itemId: 'min-voidcrystal', count: 43 },
      { itemId: 'min-tritanium', count: 9_520 },
      { itemId: 'part-frame', count: 2_079 },
      { itemId: 'part-armor-plate', count: 603 },
      { itemId: 'part-cable', count: 729 },
      { itemId: 'part-circuit', count: 1_190 },
      { itemId: 'part-coolant', count: 655 },
      { itemId: 'part-shield-gen', count: 298 },
      { itemId: 'part-qchip', count: 287 },
    ],
    buildSeconds: 5000,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-voidcrystal', count: 36 },
      { itemId: 'min-starcore', count: 388 },
      { itemId: 'min-darkiron', count: 84 },
      { itemId: 'min-tritanium', count: 6_670 },
      { itemId: 'part-frame', count: 1_670 },
      { itemId: 'part-armor-plate', count: 484 },
      { itemId: 'part-cable', count: 586 },
      { itemId: 'part-circuit', count: 956 },
      { itemId: 'part-coolant', count: 526 },
      { itemId: 'part-qchip', count: 288 },
      { itemId: 'part-fire-control', count: 72 },
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-voidcrystal', count: 46 },
      { itemId: 'min-starcore', count: 558 },
      { itemId: 'min-darkiron', count: 120 },
      { itemId: 'min-tritanium', count: 10_315 },
      { itemId: 'part-frame', count: 2_369 },
      { itemId: 'part-armor-plate', count: 687 },
      { itemId: 'part-cable', count: 831 },
      { itemId: 'part-circuit', count: 1_356 },
      { itemId: 'part-coolant', count: 746 },
      { itemId: 'part-jet-array', count: 166 },
      { itemId: 'part-fire-control', count: 120 },
      { itemId: 'part-qchip', count: 163 },
    ],
    buildSeconds: 5600,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-voidcrystal', count: 30 },
      { itemId: 'min-starcore', count: 334 },
      { itemId: 'min-darkiron', count: 68 },
      { itemId: 'min-tritanium', count: 5_795 },
      { itemId: 'part-frame', count: 1_421 },
      { itemId: 'part-armor-plate', count: 412 },
      { itemId: 'part-cable', count: 498 },
      { itemId: 'part-circuit', count: 813 },
      { itemId: 'part-coolant', count: 448 },
      { itemId: 'part-qchip', count: 245 },
      { itemId: 'part-fire-control', count: 61 },
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-voidcrystal', count: 28 },
      { itemId: 'min-starcore', count: 321 },
      { itemId: 'min-darkiron', count: 65 },
      { itemId: 'min-tritanium', count: 5_405 },
      { itemId: 'part-frame', count: 1_328 },
      { itemId: 'part-armor-plate', count: 385 },
      { itemId: 'part-cable', count: 465 },
      { itemId: 'part-circuit', count: 760 },
      { itemId: 'part-coolant', count: 418 },
      { itemId: 'part-qchip', count: 229 },
      { itemId: 'part-fire-control', count: 57 },
      { itemId: 'part-grav-comp', count: 8 },
    ],
    buildSeconds: 3600,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-darkiron', count: 214 },
      { itemId: 'min-voidcrystal', count: 41 },
      { itemId: 'min-tritanium', count: 9_980 },
      { itemId: 'part-frame', count: 1_925 },
      { itemId: 'part-armor-plate', count: 559 },
      { itemId: 'part-cable', count: 676 },
      { itemId: 'part-circuit', count: 1_103 },
      { itemId: 'part-coolant', count: 607 },
      { itemId: 'part-keel', count: 74 },
      { itemId: 'part-qchip', count: 199 },
      { itemId: 'part-grav-comp', count: 12 },
    ],
    buildSeconds: 5000,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-darkiron', count: 175 },
      { itemId: 'min-voidcrystal', count: 35 },
      { itemId: 'min-tritanium', count: 7_250 },
      { itemId: 'part-frame', count: 1_574 },
      { itemId: 'part-armor-plate', count: 457 },
      { itemId: 'part-cable', count: 553 },
      { itemId: 'part-circuit', count: 902 },
      { itemId: 'part-coolant', count: 497 },
      { itemId: 'part-qchip', count: 272 },
      { itemId: 'part-fire-control', count: 68 },
      { itemId: 'part-grav-comp', count: 10 },
    ],
    buildSeconds: 4200,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    materials: [
      { itemId: 'min-voidcrystal', count: 43 },
      { itemId: 'min-nocxium', count: 873 },
      { itemId: 'min-darkiron', count: 86 },
      { itemId: 'min-tritanium', count: 6_080 },
      { itemId: 'part-frame', count: 1_720 },
      { itemId: 'part-armor-plate', count: 499 },
      { itemId: 'part-cable', count: 603 },
      { itemId: 'part-circuit', count: 985 },
      { itemId: 'part-coolant', count: 542 },
      { itemId: 'part-qchip', count: 297 },
      { itemId: 'part-fire-control', count: 74 },
  ...
  },
  {
    ...
    materials: [
      ...
      { itemId: 'min-tritanium', count: 7_995 },
      { itemId: 'part-frame', count: 1_623 },
      { itemId: 'part-armor-plate', count: 470 },
      { itemId: 'part-cable', count: 569 },
      { itemId: 'part-circuit', count: 929 },
      { itemId: 'part-coolant', count: 511 },
      { itemId: 'part-jet-array', count: 113 },
      { itemId: 'part-fire-control', count: 82 },
      { itemId: 'part-qchip', count: 112 },
    ],
    buildSeconds: 4600,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-darkiron', count: 205 },
      { itemId: 'min-voidcrystal', count: 43 },
      { itemId: 'min-tritanium', count: 9_555 },
      { itemId: 'part-frame', count: 1_935 },
      { itemId: 'part-armor-plate', count: 561 },
      { itemId: 'part-cable', count: 679 },
      { itemId: 'part-circuit', count: 1_108 },
      { itemId: 'part-coolant', count: 610 },
      { itemId: 'part-shield-gen', count: 278 },
      { itemId: 'part-qchip', count: 267 },
    ],
    buildSeconds: 5000,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-starcore', count: 571 },
      { itemId: 'min-voidcrystal', count: 37 },
      { itemId: 'min-tritanium', count: 8_160 },
      { itemId: 'part-frame', count: 1_667 },
      { itemId: 'part-armor-plate', count: 483 },
      { itemId: 'part-cable', count: 584 },
      { itemId: 'part-circuit', count: 954 },
      { itemId: 'part-coolant', count: 525 },
      { itemId: 'part-drone-neural', count: 194 },
      { itemId: 'part-qchip', count: 201 },
      { itemId: 'part-shield-gen', count: 79 },
    ],
    buildSeconds: 4800,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-starcore', count: 466 },
      { itemId: 'min-voidcrystal', count: 30 },
      { itemId: 'min-tritanium', count: 5_905 },
      { itemId: 'part-frame', count: 1_310 },
      { itemId: 'part-armor-plate', count: 380 },
      { itemId: 'part-cable', count: 459 },
      { itemId: 'part-circuit', count: 750 },
      { itemId: 'part-coolant', count: 413 },
      { itemId: 'part-qchip', count: 226 },
      { itemId: 'part-fire-control', count: 56 },
      { itemId: 'part-grav-comp', count: 8 },
    ],
    buildSeconds: 3800,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-starcore', count: 444 },
      { itemId: 'min-voidcrystal', count: 28 },
      { itemId: 'min-tritanium', count: 5_555 },
      { itemId: 'part-frame', count: 1_223 },
      { itemId: 'part-armor-plate', count: 354 },
      { itemId: 'part-cable', count: 429 },
      { itemId: 'part-circuit', count: 700 },
      { itemId: 'part-coolant', count: 385 },
      { itemId: 'part-qchip', count: 211 },
      { itemId: 'part-fire-control', count: 53 },
      { itemId: 'part-grav-comp', count: 7 },
    ],
    buildSeconds: 3600,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-starcore', count: 582 },
      { itemId: 'min-voidcrystal', count: 39 },
      { itemId: 'min-tritanium', count: 9_325 },
      { itemId: 'part-frame', count: 1_759 },
      { itemId: 'part-armor-plate', count: 510 },
      { itemId: 'part-cable', count: 617 },
      { itemId: 'part-circuit', count: 1_006 },
      { itemId: 'part-coolant', count: 554 },
      { itemId: 'part-keel', count: 68 },
      { itemId: 'part-qchip', count: 182 },
      { itemId: 'part-grav-comp', count: 11 },
    ],
    buildSeconds: 4800,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-starcore', count: 554 },
      { itemId: 'min-voidcrystal', count: 37 },
      { itemId: 'min-tritanium', count: 8_360 },
      { itemId: 'part-frame', count: 1_656 },
      { itemId: 'part-armor-plate', count: 480 },
      { itemId: 'part-cable', count: 581 },
      { itemId: 'part-circuit', count: 948 },
      { itemId: 'part-coolant', count: 522 },
      { itemId: 'part-jet-array', count: 116 },
      { itemId: 'part-fire-control', count: 83 },
      { itemId: 'part-qchip', count: 114 },
    ],
    buildSeconds: 5200,
    buildCostIsk: 0,
  ...
  },
  {
    ...
    singleUse: true,
    materials: [
      { itemId: 'min-starcore', count: 452 },
      { itemId: 'min-voidcrystal', count: 26 },
      { itemId: 'min-tritanium', count: 5_960 },
      { itemId: 'part-frame', count: 1_221 },
      { itemId: 'part-armor-plate', count: 354 },
      { itemId: 'part-cable', count: 428 },
      { itemId: 'part-circuit', count: 698 },
      { itemId: 'part-coolant', count: 384 },
      { itemId: 'part-grav-comp', count: 17 },
      { itemId: 'part-keel', count: 33 },
      { itemId: 'part-qchip', count: 84 },
    ],
    buildSeconds: 3800,
    buildCostIsk: 0,
   ...
   * ⚠ 连带读数见 `docs/glossary.md`「零件体系（14 种 · 两档）」条与 `docs/roadmap.md` 2026-09-20「零件工时两批」那条。
   */
  {
    id: 'bp-part-circuit',
    name: '电路基板制造',
  ...
  {
    id: 'bp-part-armor-plate',
    name: '装甲板制造',
    itemId: 'part-armor-plate',
    outputUnits: 10,
    learnless: true,
    partTier: 'basic',
    materials: [
  ...
  {
    id: 'bp-part-drone-neural',
    name: '无人机神经原件蓝图',
    itemId: 'part-drone-neural',
    outputUnits: 10,
    partTier: 'advanced',
    materials: [
  ...
  {
    id: 'bp-part-shield-gen',
    name: '护盾发生装置蓝图',
    itemId: 'part-shield-gen',
    outputUnits: 10,
    partTier: 'advanced',
    materials: [
  ...
  {
    id: 'bp-part-jet-array',
    name: '能量射流阵列蓝图',
    itemId: 'part-jet-array',
    outputUnits: 10,
    partTier: 'advanced',
    materials: [
      { itemId: 'part-lens', count: 20 },
