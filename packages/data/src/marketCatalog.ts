...
export const MARKET_GOODS: readonly MarketGoodDef[] = [
  ...
  { key: 'min-isotope', kind: 'item', refId: 'min-isotope', rarity: 'common', basePrice: 45, poolTarget: 2_400, supplyFlow: 60 },
  { key: 'min-starcore', kind: 'item', refId: 'min-starcore', rarity: 'common', basePrice: 220, poolTarget: 900, supplyFlow: 18 },
  ...
  { key: 'mod-cargo-1', kind: 'module', refId: 'mod-cargo-1', rarity: 'common', basePrice: 26_000, demandMultiplier: 0.4 },
  { key: 'mod-turret-kin-1', kind: 'module', refId: 'mod-turret-kin-1', rarity: 'common', basePrice: 36_000, demandMultiplier: 0.4 },
  { key: 'mod-turret-exp-1', kind: 'module', refId: 'mod-turret-exp-1', rarity: 'common', basePrice: 42_000, demandMultiplier: 0.4 },
  { key: 'mod-turret-pla-1', kind: 'module', refId: 'mod-turret-pla-1', rarity: 'common', basePrice: 44_000, demandMultiplier: 0.4 },
  ...
  // MK2 装备（制造党自用为主；偶有现货）
  { key: 'mod-miner-2', kind: 'module', refId: 'mod-miner-2', rarity: 'rare', basePrice: 150_000, demandMultiplier: 0.35 },
  { key: 'mod-cargo-2', kind: 'module', refId: 'mod-cargo-2', rarity: 'rare', basePrice: 130_000, demandMultiplier: 0.35 },
  { key: 'mod-turret-kin-2', kind: 'module', refId: 'mod-turret-kin-2', rarity: 'rare', basePrice: 240_000, demandMultiplier: 0.35 },
  { key: 'mod-turret-exp-2', kind: 'module', refId: 'mod-turret-exp-2', rarity: 'rare', basePrice: 280_000, demandMultiplier: 0.35 },
  { key: 'mod-turret-pla-2', kind: 'module', refId: 'mod-turret-pla-2', rarity: 'rare', basePrice: 300_000, demandMultiplier: 0.35 },
  // MK3 攻坚装备（V10：无蓝图，市场专供）
  { key: 'mod-miner-3', kind: 'module', refId: 'mod-miner-3', rarity: 'rare', basePrice: 420_000, demandMultiplier: 0.35 },
  { key: 'mod-cargo-3', kind: 'module', refId: 'mod-cargo-3', rarity: 'rare', basePrice: 380_000, demandMultiplier: 0.35 },
  { key: 'mod-turret-kin-3', kind: 'module', refId: 'mod-turret-kin-3', rarity: 'rare', basePrice: 620_000, demandMultiplier: 0.35 },
  { key: 'mod-turret-exp-3', kind: 'module', refId: 'mod-turret-exp-3', rarity: 'rare', basePrice: 700_000, demandMultiplier: 0.35 },
  { key: 'mod-turret-pla-3', kind: 'module', refId: 'mod-turret-pla-3', rarity: 'rare', basePrice: 750_000, demandMultiplier: 0.35 },
  // 战斗家族 MK2/MK3（V17：分系专精 ×3 款；MK3 市场专供）
  { key: 'mod-shield-kin-2', kind: 'module', refId: 'mod-shield-kin-2', rarity: 'rare', basePrice: 20_000, demandMultiplier: 0.35 },
  { key: 'mod-shield-exp-2', kind: 'module', refId: 'mod-shield-exp-2', rarity: 'rare', basePrice: 20_000, demandMultiplier: 0.35 },
  { key: 'mod-shield-pla-2', kind: 'module', refId: 'mod-shield-pla-2', rarity: 'rare', basePrice: 20_000, demandMultiplier: 0.35 },
  { key: 'mod-armor-kin-2', kind: 'module', refId: 'mod-armor-kin-2', rarity: 'rare', basePrice: 24_000, demandMultiplier: 0.35 },
  { key: 'mod-armor-exp-2', kind: 'module', refId: 'mod-armor-exp-2', rarity: 'rare', basePrice: 24_000, demandMultiplier: 0.35 },
  { key: 'mod-armor-pla-2', kind: 'module', refId: 'mod-armor-pla-2', rarity: 'rare', basePrice: 24_000, demandMultiplier: 0.35 },
  { key: 'mod-prop-2', kind: 'module', refId: 'mod-prop-2', rarity: 'rare', basePrice: 28_000, demandMultiplier: 0.35 },
  { key: 'mod-shield-kin-3', kind: 'module', refId: 'mod-shield-kin-3', rarity: 'rare', basePrice: 100_000, demandMultiplier: 0.35 },
  { key: 'mod-shield-exp-3', kind: 'module', refId: 'mod-shield-exp-3', rarity: 'rare', basePrice: 100_000, demandMultiplier: 0.35 },
  { key: 'mod-shield-pla-3', kind: 'module', refId: 'mod-shield-pla-3', rarity: 'rare', basePrice: 100_000, demandMultiplier: 0.35 },
  { key: 'mod-armor-kin-3', kind: 'module', refId: 'mod-armor-kin-3', rarity: 'rare', basePrice: 130_000, demandMultiplier: 0.35 },
  { key: 'mod-armor-exp-3', kind: 'module', refId: 'mod-armor-exp-3', rarity: 'rare', basePrice: 130_000, demandMultiplier: 0.35 },
  { key: 'mod-armor-pla-3', kind: 'module', refId: 'mod-armor-pla-3', rarity: 'rare', basePrice: 130_000, demandMultiplier: 0.35 },
  { key: 'mod-shield-ext-2', kind: 'module', refId: 'mod-shield-ext-2', rarity: 'rare', basePrice: 20_000, demandMultiplier: 0.35 },
  { key: 'mod-armor-plate-2', kind: 'module', refId: 'mod-armor-plate-2', rarity: 'rare', basePrice: 24_000, demandMultiplier: 0.35 },
  { key: 'mod-shield-ext-3', kind: 'module', refId: 'mod-shield-ext-3', rarity: 'rare', basePrice: 100_000, demandMultiplier: 0.35 },
  { key: 'mod-armor-plate-3', kind: 'module', refId: 'mod-armor-plate-3', rarity: 'rare', basePrice: 130_000, demandMultiplier: 0.35 },
  { key: 'mod-prop-3', kind: 'module', refId: 'mod-prop-3', rarity: 'rare', basePrice: 160_000, demandMultiplier: 0.35 },
  ...
  { key: 'mod-turret-proto', kind: 'module', refId: 'mod-turret-proto', rarity: 'exotic', basePrice: 2_400_000, demandMultiplier: 0.3, standingReq: 10 },
