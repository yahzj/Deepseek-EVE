...
export const MARKET_GOODS_RAW: readonly MarketGoodDef[] = [
  ...
  // ⚠ 2026-09-26 船长令「黑匣的价格需要提高到8000万」⇒ basePrice 80 万 → 8,000 万（与物品 `baseSellPriceIsk` 同值）
  { key: 'blackbox-h', kind: 'item', refId: 'blackbox-h', rarity: 'exotic', basePrice: 80_000_000, demandMultiplier: 1.0, playerBuyable: false },
