...
export const MARKET_GOODS: readonly MarketGoodDef[] = [
  ...
  // 占位家族 MK1（护盾/装甲/推进：低价收藏位，效果随战斗系统开放）
  { key: 'mod-shield-1', kind: 'module', refId: 'mod-shield-1', rarity: 'common', basePrice: 5_000, demandMultiplier: 0.4 },
  { key: 'mod-armor-1', kind: 'module', refId: 'mod-armor-1', rarity: 'common', basePrice: 5_500, demandMultiplier: 0.4 },
  ...
  // 占位家族 MK2/MK3（效果随战斗系统开放）
  { key: 'mod-shield-2', kind: 'module', refId: 'mod-shield-2', rarity: 'rare', basePrice: 20_000, demandMultiplier: 0.35 },
  { key: 'mod-armor-2', kind: 'module', refId: 'mod-armor-2', rarity: 'rare', basePrice: 24_000, demandMultiplier: 0.35 },
  { key: 'mod-prop-2', kind: 'module', refId: 'mod-prop-2', rarity: 'rare', basePrice: 28_000, demandMultiplier: 0.35 },
  { key: 'mod-shield-3', kind: 'module', refId: 'mod-shield-3', rarity: 'rare', basePrice: 100_000, demandMultiplier: 0.35 },
  { key: 'mod-armor-3', kind: 'module', refId: 'mod-armor-3', rarity: 'rare', basePrice: 130_000, demandMultiplier: 0.35 },
