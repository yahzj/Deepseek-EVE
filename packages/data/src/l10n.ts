...
export const EN_MODULES: EnTable = {
  ...
  'mod-shieldfield-2': { name: 'Shield Charge Field MK2', description: 'Deploys a field every 10 s, restoring shield to every ship in the fleet — the amount is 10% of this ship’s shield capacity.' },
  'mod-shieldfield-3': { name: 'Shield Charge Field MK3', description: 'Deploys a field every 8 s, restoring shield to every ship in the fleet — the amount is 10% of this ship’s shield capacity.' },
  ...
  'mod-lair-web-h': { name: 'Ink Tide Capture Web', description: 'A cycling web: within 3,800 m it pins one un-webbed enemy ship — speed ×0.5, thrusters offline, evasion nullified. The web breaks and cools down for 20 seconds when the range exceeds 4,500 m or the target is sunk; sinking the webbing ship releases it.' },
  // 虫洞族专属（mod-wh-*）
...
export const EN_SKILLS: EnTable = {
  ...
  'furnace-precision': { name: 'Furnace Precision', description: 'Furnace temperature trimming and thermal control: each level shortens a refinery batch cycle by a further ⟦4%⟧ (max −⟦20%⟧; applies to manual and AI-core operation alike, and multiplies with Core Smelting and Production Cadence).' },
