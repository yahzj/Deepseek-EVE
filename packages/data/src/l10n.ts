...
export const EN_MODULES: EnTable = {
  ...
  'mod-lair-web-h': { name: 'Ink Tide Capture Web', description: 'A cycling web: it pins one un-webbed enemy ship — speed ×0.5, thrusters offline, evasion nullified. The web breaks and cools down for 20 seconds when the range exceeds 4,000 m or the target is sunk; sinking the webbing ship releases it.' },
  // 虫洞族专属（mod-wh-*）
