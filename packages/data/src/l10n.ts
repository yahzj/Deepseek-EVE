...
export const EN_MODULES: EnTable = {
  ...
  'mod-lair-web-h': { name: 'Ink Tide Capture Web', description: 'A cycling web: it pins one un-webbed enemy ship the moment battle opens — speed ×0.5, thrusters offline, evasion nullified; the web snaps if the range exceeds 4,000 m. It releases when the target or the webbing ship is sunk, then cools down for 20 seconds before choosing a new target.' },
  // 虫洞族专属（mod-wh-*）
