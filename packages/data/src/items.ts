...
export const AMMO: readonly ItemDef[] = [
  {
    ...
    unitM3: 0.02,
    baseSellPriceIsk: 6,
    description: '动能弹：实心高速弹，破盾专精（对护盾 ×1.5、对装甲 ×0.5）。战斗开放后由轻型炮台消耗。',
    damageType: 'kinetic',
    ammoSize: 'light',
    dmg: 6,
  },
  {
    ...
    unitM3: 0.02,
    baseSellPriceIsk: 14,
    description: '动能弹：重口径破盾弹（对护盾 ×1.5、对装甲 ×0.5）。战斗开放后由重型炮台消耗。',
    damageType: 'kinetic',
    ammoSize: 'heavy',
    dmg: 14,
  },
  {
    ...
    unitM3: 0.02,
    baseSellPriceIsk: 7,
    description: '高爆弹：拆甲专精（对装甲 ×1.5、对护盾 ×0.5）。战斗开放后由轻型炮台消耗。',
  ...
  },
  {
    ...
    unitM3: 0.02,
    baseSellPriceIsk: 16,
    description: '高爆弹：重型破甲弹头（对装甲 ×1.5、对护盾 ×0.5）。战斗开放后由重型炮台消耗。',
    damageType: 'explosive',
    ammoSize: 'heavy',
    dmg: 16,
  },
  {
    ...
    unitM3: 0.02,
    baseSellPriceIsk: 8,
    description: '能量弹（等离子）：全场景中游的通用弹（对护盾 ×0.75、其余 ×1.0），新手备弹首选。战斗开放后由轻型炮台消耗。',
    damageType: 'plasma',
    ammoSize: 'light',
    dmg: 9,
  },
  {
    ...
    unitM3: 0.02,
    baseSellPriceIsk: 18,
    description: '能量弹（等离子）：重型通用弹（对护盾 ×0.75、其余 ×1.0）。战斗开放后由重型炮台消耗。',
    damageType: 'plasma',
    ammoSize: 'heavy',
    dmg: 19,
  },
