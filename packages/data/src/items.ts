 ...
 *   balance.refining 基础倍率 1.2（无技能净率 ≈+20%）、精炼学 +4%/级、高级回收处理 +2%/级、
 *   满级倍率 1.5（满技净率在原 60~79% 基础上下调约两成 ≈+55%）。2026-09-08 工业工位收益体检
 *   再定（配方仍按倍率 1.0 时代的 perOre 值，由引擎倍率驱动产值；perOre 取整允许 ±2pp 漂移；
 *   护栏见 tools/content-check.ts）；
