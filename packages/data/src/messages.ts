...
export const COMMS_MESSAGES: readonly CommsMessageDef[] = [
  ...
  },
  {
    ...
    deptId: 'dept-route-safety',
    kind: '提示',
    subject: '航线须知：安全等级不到 +0.5 的空域',
    body: [
      '你已经探到安全等级不到 +0.5 的星系了。那里的规矩与高安不同，航线安全处一次讲清。',
      '第一件：在那类星系里，采矿、打捞、扫描与野外驻留都可能被盯上，会有人来拦你——能迎战，也能快速脱离。航行途中不会被拦，这一点可以放心。',
      '第二件：安全等级越低，就地扫描越慢，最差的一档会把十分钟的窗口拖到二十二分钟。',
      '第三件：安全等级为负的星系，残骸更值钱——拆出来的料档位更高，运气好还能缴获完整的成装。',
      '最后一条保命的规矩：舰体结构掉到一半以下会自动脱离，这条线一直都在，但也别指望它替你扛。',
    ],
    trigger: { kind: 'lowSec' },
