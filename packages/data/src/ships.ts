...
//   （旧的「总槽位 3~12」契约同日废除——它当初是为驱逐舰设的）；CPU T3 = 350 ⇒ **×1.4/档**；
  ...
  },
  {
    ...
    role: 'armed',
    subClass: '炮艇',
    // 子分类「炮艇」（船长 2026-09-13）：族武 动能 +0.15 · 命中 +0.03 ｜ 货舱 −30% · 护盾血占比 −20% · 分辨率 −20%
    ...
    description: '海盗的炮艇：动能炮阵加持，正面火力扎实；舱位很窄、护盾让位给装甲，全靠一门门炮说话。',
  },
  {
    id: 'sh-wh-a-cruiser',
    name: '掠袭重型突击巡洋舰',
    role: 'armed',
    subClass: '重型突击巡洋舰',
    // 子分类「重型突击巡洋舰」（船长 2026-09-13）：族武 动能 +0.15 · 甲/壳血占比提高 ｜ 机动 −30% · 货舱 −30% · 信号 +20%
    ...
    shieldResist: {"kinetic":0.5},
    weaponFamilyBonus: { kinetic: 0.15 },
    description: '海盗的重型突击巡洋舰：动能火力全开、甲壳同步加厚，专啃硬目标；代价是转身慢、舱位小。',
  },
  {
    id: 'sh-wh-c-frigate',
    name: '幼虫截击舰',
  ...
  },
  {
    ...
    role: 'armored',
    subClass: '重型突击巡洋舰',
    // 子分类「重型突击巡洋舰」（船长 2026-09-13）：族武 能量 +0.15 · 甲/壳血占比提高 · 低槽 +1（装甲舰槽位契约：低槽须多于高槽）｜ 机动 −30% · 货舱 −30% · 信号 +20%
    ...
    armorResist: {"explosive":0.5},
    hullResist: {"kinetic":0.25},
    weaponFamilyBonus: { plasma: 0.15 },
    description: '巢群的重型突击巡洋舰：能量主炮配厚甲厚壳，正面硬碰硬；转身极慢，空间全让给装甲。',
  },
  {
    id: 'sh-wh-d-frigate',
    name: '哨戒电子舰',
  ...
  },
  {
    ...
    shieldResist: {"plasma":0.25},
    armorResist: {"explosive":0.5},
    description: '陵墓的重装巡洋舰：三层血最厚、炮位最多，是能站在阵线中央扛住火力的平台。',
  },
  {
    id: 'sh-wh-e-frigate',
    name: '构件鱼雷舰',
