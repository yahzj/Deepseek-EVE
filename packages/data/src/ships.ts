...
//   （旧的「总槽位 3~12」契约同日废除——它当初是为驱逐舰设的）；CPU T3 = 350 ⇒ **×1.4/档**；
   ...
   * ⚠ **定制船口径**：无市场行 ⇒ `priceIsk` 必须为 0；唯一来源 = 各自的**一次性舰船图纸**。 */
  {
    ...
    name: '掠私艇级护卫舰',
    role: 'armed',
    slots: { high: 3, mid: 2, low: 1 },
    tier: 1,
    unreleased: true,
    cargoM3: 1800, // 同档武装护卫里货舱最大（虎鲨级 1500）
    cycleSeconds: 14,
    oreUnitsPerCycle: 8,
    priceIsk: 0, // 定制船：无市场行
    agility: 0.75,
    ...
    signatureM: 44,
    scanResMm: 660,
    description: '海盗的入门艇：跑得快、舱位比同级护卫都宽，专为"抢完就走"设计。火力只够自保，别拿它硬顶。',
  },
  {
    id: 'sh-wh-a-destroyer',
    name: '掠私驱逐舰',
    role: 'armed',
    slots: { high: 4, mid: 3, low: 2 },
    tier: 2,
    unreleased: true,
    cargoM3: 4400, // 同档驱逐里最大（大白鲨级 3200）
    cycleSeconds: 13,
    oreUnitsPerCycle: 14,
    priceIsk: 0,
    agility: 0.62,
    ...
    signatureM: 72,
    scanResMm: 570,
    description: '把弹药舱削掉一半换成货舱的驱逐舰：抢来的东西直接塞得下，不用来回跑。代价是打得没那么久。',
  },
  {
    id: 'sh-wh-a-cruiser',
    name: '掠袭巡洋舰',
    ...
    signatureM: 92,
    scanResMm: 525,
    description: '海盗手里的主力舰：火力与货舱兼顾，一艘顶得上一支小队的活。它不是最快的，但走的时候总带着东西。',
  },
  {
    id: 'sh-wh-c-frigate',
    name: '幼虫艇级护卫舰',
    role: 'armored',
    slots: { high: 2, mid: 2, low: 3 },
    tier: 1,
    unreleased: true,
    cargoM3: 900,
    cycleSeconds: 14,
    ...
    signatureM: 62,
    scanResMm: 600,
    description: '刚从巢里出来的东西：护盾几乎不设防，靠一层甲壳和一段厚骨架撑住。它贴上去就不退。',
  },
  {
    id: 'sh-wh-c-destroyer',
    name: '甲壳驱逐舰',
    role: 'armored',
    slots: { high: 2, mid: 3, low: 4 },
    tier: 2,
    unreleased: true,
    cargoM3: 1900,
    cycleSeconds: 13,
    ...
    signatureM: 120,
    scanResMm: 460,
    description: '甲壳一层压一层：三层血里装甲最厚，慢，但很难被打穿。适合当编队里那个"先挨打"的。',
  },
  {
    id: 'sh-wh-c-cruiser',
    name: '巢群巡洋舰',
    role: 'armored',
    slots: { high: 3, mid: 4, low: 4 },
    tier: 3,
    unreleased: true,
    cargoM3: 4200,
    cycleSeconds: 13,
    ...
    signatureM: 170,
    scanResMm: 400,
    description: '一整窝长成的一艘舰：三层血总量是全游最高的一档，代价是慢得几乎没有机动。它靠"活着"赢。',
  },
  {
    id: 'sh-wh-d-frigate',
    name: '哨戒艇级护卫舰',
    ...
    warpSpeedAus: 3.4,
    massKg: 2_300_000,
    lockRangeM: 34_000, // 守墓系：锁定远、打得准
    signatureM: 70,
    scanResMm: 560,
    description: '守在陵寝外围的小艇：锁定距离比同级护卫都远，命中加成也高。它不追你，它只是先看见你。',
  },
  {
    ...
    signatureM: 140,
    scanResMm: 420,
    description: '三层血配得极匀，没有明显短板，也没有快的地方。守墓者的打法是站着不动，把对手耗完。',
  },
  {
    id: 'sh-wh-d-cruiser',
    name: '陵寝巡洋舰',
    ...
    signatureM: 200,
    scanResMm: 350,
    description: '把整座陵寝的护墙拆下来装在自己身上：血厚、抗性全、跑得最慢。它出厂就不是为了追谁。',
  },
  {
    id: 'sh-wh-e-frigate',
    name: '构件艇级护卫舰',
    ...
    signatureM: 52,
    scanResMm: 640,
    description: '用巨构残件拼起来的小艇：装配位与算力在同级里最宽裕，机库也留了位置。它自己打不痛谁，但能带一群。',
  },
  {
    ...
    hullHp: 105,
    cpu: 250,
    droneBayM3: 70, // 同档机库最大（梭鱼级 30 量级）
    maxSpeedMps: 275,
    warpSpeedAus: 3.4,
    massKg: 4_600_000,
    lockRangeM: 37_000,
    signatureM: 80,
    scanResMm: 540,
    description: '为机群腾出半条船身的驱逐舰：无人机舱比同级大一倍有余，CPU 也留得足。它的火力在机库里。',
  },
  {
    id: 'sh-wh-e-carrier',
    name: '巨构母舰',
    ...
    armorHp: 160,
    hullHp: 190,
    cpu: 400, // 同档 CPU 最高（牛鲨级 390）
    droneBayM3: 95, // 全游最大的无人机舱
    maxSpeedMps: 250,
    warpSpeedAus: 3.1,
    massKg: 9_200_000,
    lockRangeM: 42_000,
    signatureM: 105,
    scanResMm: 500,
    description: '一座会飞的机库：搭载上限与算力都是全游最高的一档，自己那几门炮只是自卫。它打的是机群，不是炮。',
  },
  {
    id: 'sh-wh-g-frigate',
    name: '幽影艇级护卫舰',
    ...
    droneBayM3: 10,
    maxSpeedMps: 365, // 全游最快
    warpSpeedAus: 4.0,
    massKg: 1_000_000,
    lockRangeM: 38_000,
    signatureM: 34, // 全游最小信号
    scanResMm: 700,
    description: '快得几乎看不见：信号最小、速度最快，锁定距离却不短。它负责先到、先看、先报。',
  },
  {
    ...
    warpSpeedAus: 3.8,
    massKg: 3_400_000,
    lockRangeM: 44_000, // 同档锁定最远
    signatureM: 58, // 同档信号最小
    scanResMm: 620,
    description: '整条船就是一套传感器：锁定最远、扫描最细、信号压得最低。它先替编队把对手看清楚。',
  },
  {
    id: 'sh-wh-g-cruiser',
    name: '亡军巡洋舰',
    role: 'armed',
    slots: { high: 4, mid: 5, low: 3 },
    tier: 3,
    unreleased: true,
    cargoM3: 3200,
    cycleSeconds: 14,
    ...
    warpSpeedAus: 3.5,
    massKg: 7_400_000,
    lockRangeM: 48_000, // 全游锁定最远
    signatureM: 78,
    scanResMm: 580,
    description: '亡军的指挥舰：锁得最远、看得最清，机群也养得最好。它不抢头功，它决定谁去打。',
  },
]
