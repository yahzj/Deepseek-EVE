...
export const RARITY_TIER: Readonly<Record<string, number>> = {
  ...
  'bp-cargo-3': 3,
  'bp-cargo-civ': 1,
  // 2026-09-11 协处理器（原：MK1 稀有 2 档、MK2 稀有 3 档；**MK3 无蓝图**故无 bp-cpu-3）
  // **2026-09-26 船长令**：「**协处理器 MK1和MK2新增蓝图，稀有度比产品高一个级别**」
  // ⇒ 两张蓝图各上调一级（产品 mod-cpu-1 = 2 / mod-cpu-2 = 3 ⇒ 蓝图 3 / 4），**渠道照旧在稀有订单**
  //   （先例：2026-09-16 五艘官方巡洋舰「数字档保持 4 不动、只把渠道挪进稀有订单」＝同一条"数字档与渠道分离"口径）。
  //   ⚠ 这是**有意偏离**"蓝图与产物同档"的全仓惯例（129 张里 121 张同档）⇒ 由测试单独锁定，别顺手改回去。
  'bp-cpu-1': 3,
  'bp-cpu-2': 4,
  'bp-drone-rack-1': 1,
  'bp-drone-rack-2': 2,
