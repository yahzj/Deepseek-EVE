...
export const MODULES: readonly ModuleDef[] = [
  ...
  // 蓝图 = 动能款（协会制式）；高爆/能量款市场专供；弹药每型单档（-l），全炮台通用。
  {
    ...
    minRangeM: 250,
    hitRate: 0.8,
    falloff: 0.5, // 2026-09-11 船长定：我方动能炮台远端命中衰减统一 0.5（民用 0.3 → 0.5）
    reloadMs: 2400,
    dmgMult: 1.0,
  },
  {
    ...
    minRangeM: 250,
    hitRate: 0.8,
    falloff: 0.5, // 2026-09-11 船长定：动能炮台远端命中衰减 0.3 → 0.5（远端命中 ×0.3 → ×0.5）
    reloadMs: 1540,
    dmgMult: 1.25,
  },
  {
    ...
    minRangeM: 700,
    hitRate: 0.78,
    falloff: 0.5, // 2026-09-11 船长定：动能炮台远端命中衰减 0.28 → 0.5
    reloadMs: 2380,
    dmgMult: 3.73,
  },
  {
  ...
  // - 距离衰减作用在**威力**而非命中——**2026-09-11 船长定：合并旧修正、不再与命中衰减挂钩**，
  ...
  // - 市场专供（无蓝图；沿用原能量炮渠道与价位）。异星原型 → 原型激光（奇货）。
  {
    ...
    minRangeM: 0,
    hitRate: 1,
    falloff: 0.1, // 2026-09-11 船长定：能量武器远端统一「最远端威力 ×0.1」（旧 0.3 ×0.8 修正已合并作废）
    reloadMs: 2000,
    dmgMult: 1.1,
  },
  {
    ...
    minRangeM: 0,
    hitRate: 1,
    falloff: 0.1, // 2026-09-11 船长定：远端统一「最远端威力 ×0.1」（旧 0.35 ×0.8 = ×0.48 作废）
    reloadMs: 3200,
    dmgMult: 3,
  },
  {
    ...
    minRangeM: 0,
    hitRate: 1,
    falloff: 0.1, // 2026-09-11 船长定：远端统一「最远端威力 ×0.1」
    reloadMs: 4000,
    dmgMult: 4.2,
  },
  {
