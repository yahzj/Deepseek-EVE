...
export const DIALOGUES: readonly DialogueScriptDef[] = [
  {
    ...
    lines: [
      ...
      { speaker: '基建部 · 柯岚', text: '建材送到工地就行；人不在现场时，也可以从空间站一键安排「前往工地交付」航线。等它建成并入协会基地网络，泊位、维修、补给、换船会一次性全部开放。' },
    ],
  },
  {
    id: 'dlg-redring-done',
  ...
  },
  {
    ...
    lines: [
      ...
      { speaker: '基建部 · 沈灼', text: '建材可直接送到工地；人不在现场时，可从空间站一键安排「前往工地交付」航线。这片灰烬里的第一盏灯，就交给你点了。' },
    ],
  },
  {
    id: 'dlg-cinder-done',
