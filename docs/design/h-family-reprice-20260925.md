...
| 3 | 被占星系的悬赏卡 | 名字 =「**H 族舰队 · 墨潮骚扰编队**」（或「· 墨潮袭击编队」）；**威胁 = 卡面自身**（90 或 108，不再是 78）；奖励 = 该星系原卡 ×1.4 |
| 4 | 在该星系**采矿/打捞** | **高频遇袭**（高安也掷）；遭遇卡 ∈ {骚扰, 袭击}；**强度 ×0.75**、标签 = 缩放后实测价（**76 / 91**）；日志写「**入侵遭遇**」 |
| 5 | 遇袭点「迎战」打赢 | 进度 **+3%**（不是 +10%）；打输只受损、进度不动；放着不管 60 秒自动结算 ⇒ 判成击退时 **+1%** |
| 6 | 打该星系的悬赏（主动出击） | 进度 **+10%**；打满 ⇒ 该处**夺回**：钱包 +2M、稀有残骸 ×8（货舱） |
...
| 10 | 把池子打空 | 旗舰**击沉**：**墨潮旗舰黑匣 ×1** ＋ 稀有残骸 ×3（都在货舱）；日志一条结束；再等一拍 ⇒ 「**贡献奖已发放：贡献占比 x%，奖励 稀有残骸 ×N ＋ M 信用点**」（0% ⇒ 「本次入侵没有贡献，无贡献奖。」） |
