...
- **复跑读数（2026-09-17 收尾后）**：typecheck 0 错 · core **165 文件 / 1,780 例** · `content:check` ✅ ·
  `ui:rot-check` ✅ · `build` ＋ `build --prefix web` ✅ · `flow:newgame` 全通 · `save:migrate` 80/80 ·
  `tools:audit` ✅。**新档时间线**：演出+扫描 10.1 分钟 → 采矿两趟 3.0 → 精炼+生产 1.0 →
  挂单/卖矿/首战/维修 0.5 → 领奖+悬赏+学技能+指派副船 7.5 = **合计 22.1 分钟**走到「第一次指派 AI 副船」。
