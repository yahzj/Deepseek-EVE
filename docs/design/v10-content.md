...
- **资源价值曲线**：单件资源（1 m³/单位）站内收价严格递进——矿石 13→490（7 种；克洛基石/
  熔辉石/赤曜石已随 V16 矿带整合删除）、气体 85~330、冰 150~360；新矿带全部挂声望门槛（1~11），
  旧 4 矿带保持 0；
- **精炼经济（2026-09-08 船长定稿改弦）**：每资源精炼配方按「50% 收率（无技能）时每批产值 ≈ 耗料价值（双方站内收价口径）」配平——零技能精炼不吃亏（perOre 取整允许实际净率微正 +0.4%~+4.6%），精炼学每级 +8pp 收率线性转赚，满技能（95%）净 ≈ +82%~+110% 耗料值；旧规则「100% 收率 ≈ 收购价 ×1.15~1.35、初始 50% 故意亏」作废（配方实值见 §3.1 与 items.ts；护栏 tools/content-check.ts）；产物只指向矿物（气体/冰不出新物种类）；
- **矿物阶梯**：旧 4 种（8/12/20/90）不动，4 种高端矿物 55/245/780/1800（同位聚晶/星髓晶
  已于 2026-09-04 C2 复查上调，见 c2-craft-cost.md），
...
| min-isotope | 同位聚晶 | 55 |
| min-starcore | 星髓晶 | 245 |
| min-darkiron | 冥铁合金 | 780 |
| min-voidcrystal | 虚空晶 | 1800 |

**矿石（7）**（kind=ore，1 m³/单位；V16 矿带整合后 7 种，克洛基石/熔辉石/赤曜石已删）

| id | 名称 | 站内收价 | 精炼配方（perOre，2026-09-08 配平） | 100%价值/收价比 |
|---|---|---|---|---|
| ore-veldspar | 富凡晶石 | 13 | trit 2.35, pyer 0.68 | 2.07 |
| ore-scorched | 灼烧岩 | 18 | pyer 1.97, mex 0.70 | 2.09 |
| ore-hemorphite | 希莫非特 | 55 | noc 1.06, trit 2.89 | 2.16 |
| ore-glowstone | 辉云岩 | 150 | iso 5.28, trit 4.30 | 2.17 |
| ore-sunshard | 曦棱晶 | 115 | iso 4.15, pyer 1.54 | 2.15 |
| ore-voidshard | 玄晶 | 340 | star 2.37, dark 0.19, noc 0.48 | 2.27 |
| ore-nebulite | 星幽矿 | 490 | dark 1.00, star 1.37 | 2.28 |

> 2026-09-08 精炼配平刷新：旧表（比值 0.95~1.93，希莫非特按历史略亏保留）作废；比价基准 =
> 资源站内收价（baseSellPriceIsk，市场均衡价 ≈ catalog 基价、微差不参与配平）；比值 ≈2.0 =
> 「50% 收率（无技能）产值 ≈ 耗料价值」的理论锚，floor 实际净率 +0.4%~+4.6%，见
> docs/design/refine-balance-50.md。

**气体（4）**（kind=gas，1 m³/单位，可采集可精炼）

| id | 名称 | 站内收价 | 精炼配方（perOre，2026-09-08 配平） | 100%价值/收价比 |
|---|---|---|---|---|
| gas-neon | 氖云气 | 85 | iso 2.86, trit 1.84 | 2.02 |
| gas-phosphor | 磷光霾 | 330 | iso 4.58, star 1.62, mex 1.26 | 2.04 |
| gas-ionstorm | 离子风暴云 | 230 | star 1.54, dark 0.13, iso 0.63 | 2.23 |
| gas-aurora | 极光云 | 330 | star 1.47, dark 0.50 | 2.27 |

**冰矿（3）**（kind=ice，1 m³/单位，可采集可精炼）

| id | 名称 | 站内收价 | 精炼配方（perOre，2026-09-08 配平） | 100%价值/收价比 |
|---|---|---|---|---|
| ice-frost | 蓝霜冰 | 150 | iso 4.95, mex 1.46 | 2.01 |
| ice-marrow | 寒髓冰 | 230 | star 1.32, iso 2.42, mex 0.88 | 2.06 |
| ice-darkstar | 暗星冰 | 360 | dark 0.59, star 1.10, iso 1.83 | 2.31 |
