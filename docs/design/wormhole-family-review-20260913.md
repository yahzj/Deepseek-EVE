...
> ⚠ **2026-09-14 追补**（本表是 **09-13 快照**；下列 6 处已按船长新裁定改动，最新一律以 `packages/data/src/ships.ts` 与设计稿 **§4.9** 为准）：鱼雷舰强化 —— 构件鱼雷舰 `电力 0.25→0.5`；亡军鱼雷舰 `电力 0.62→0.82` · `命中 0.21→0.11` · `回避 0.105→0.005` · 槽位 `5/5/3→6/4/2`；槽位基准线核账 —— 掠袭电子舰 `3/3/1→3/4/1` · 机库无人机作战舰 `4/4/3→4/3/3` · 亡军后勤舰 `4/4/3→4/4/2` · 巨构无人机作战舰 `5/5/3→5/4/3`。
> 另注（给后来者）：本表由 `tools/wh-family-review.ts --write` 重跑生成，但**重跑会把全篇按当天数据重写**（会卷进其它批次的漂移：CPU 数值、`**` 记号的移除等）⇒ 作为**按日期快照**保留时**不要重跑**；需要新快照请复制成新日期文件再跑。
...
|---|---|---|---|---|---|---|---|---|---|
| **掠袭电子舰** | `sh-wh-a-frigate` | 电子舰 | T1/armed | 3/4/1 | 165 | 130/60/55 | 10 | **虫洞扫码 +1 圈（编队即生效、可叠加）** · 命中 +0.25 · 电力 +0.3 · 抗性：shield {"kinetic":0.5} | 回避 0.216 · 速 350 · 机动 0.675 · 货舱 1260 · 机巢 10m³ |
...
| 舰船 | id | 子分类 | 档/角色 | 槽 高/中/低 | CPU | 盾/甲/壳 | 机巢 | 特色与加成 | 机动侧 |
|---|---|---|---|---|---|---|---|---|---|
| **构件鱼雷舰** | `sh-wh-e-frigate` | 鱼雷舰 | T1/armed | 4/2/2 | 200 | 115/60/80 | 30 | 族武 {"explosive":0.15} · 命中 +0.17 · 电力 +0.5 · 抗性：shield {"kinetic":0.5} / hull {"plasma":0.25} | 回避 0.105 · 速 315 · 机动 0.7 · 货舱 1000 · 机巢 30m³ |
| **机库无人机作战舰** | `sh-wh-e-destroyer` | 无人机作战舰 | T2/armed | 4/3/3 | 290 | 230/90/115 | 105 | 无人机伤害 +0.1 · 命中 +0.14 · 电力 +0.4 · 抗性：shield {"kinetic":0.5} / hull {"plasma":0.25} | 回避 0.1 · 速 275 · 机动 0.6 · 货舱 1960 · 机巢 105m³ |
| **巨构无人机作战舰** | `sh-wh-e-carrier` | 无人机作战舰 | T3/armed | 5/4/3 | 440 | 410/160/200 | 145 | 无人机伤害 +0.14 · 命中 +0.14 · 电力 +0.6 · 抗性：shield {"kinetic":0.5} / hull {"plasma":0.25} | 回避 0.1 · 速 250 · 机动 0.5 · 货舱 2660 · 机巢 145m³ |
...
| **亡军后勤舰** | `sh-wh-g-destroyer` | 后勤舰 | T2/armed | 4/4/2 | 260 | 230/75/115 | 45 | 无人机伤害 +0.1 · 命中 +0.15 · 电力 +0.45 · 抗性：shield {"kinetic":0.5} | 回避 0.147 · 速 310 · 机动 0.68 · 货舱 3480 · 机巢 45m³ |
| **亡军鱼雷舰** | `sh-wh-g-cruiser` | 鱼雷舰 | T3/armed | 6/4/2 | 410 | 345/185/225 | 60 | 族武 {"explosive":0.15} · 无人机伤害 +0.14 · 命中 +0.11 · 电力 +0.82 · 抗性：shield {"kinetic":0.5} | 回避 0.005 · 速 285 · 机动 0.493 · 货舱 3200 · 机巢 60m³ |
