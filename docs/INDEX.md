...
- 文档总数 **271** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5204** KB · **36869** 行
- 状态分布：**未标注** 146 · **已确认/已实现** 108 · **进行中** 9 · **待裁定** 7 · **历史留档** 1
- 孤儿文档（0 引用）**21** 份 · 状态未标注 **146** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 81 KB / 277 行 | 253 / 10 |
...
| `docs/design/battle-speed-20260919.md` | 战斗倍速（挂起）· 2026-09-19 | 未标注（挂起） | 2026-09-19 | 3 KB / 38 行 | 1 / 0 |
...
| `docs/design/matter-tech-20260919.md` | 谜质科技树（2026-09-19 · 船长逐线裁定） | 待裁定（待船长确认） | 2026-09-19 | 12 KB / 150 行 | 0 / 0 |
...
- `docs/design/matter-tech-20260919.md`（2026-09-19 · 12 KB）—— 谜质科技树（2026-09-19 · 船长逐线裁定）
