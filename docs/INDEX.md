...
- 文档总数 **270** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5181** KB · **36639** 行
- 状态分布：**未标注** 145 · **已确认/已实现** 108 · **待裁定** 9 · **进行中** 7 · **历史留档** 1
- 孤儿文档（0 引用）**21** 份 · 状态未标注 **145** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 371 KB / 831 行 | 187 / 8 |
...
| `docs/design/fit-preset-overwrite-20260919.md` | 装配方案「替换」按钮：用当前装配覆盖目标方案（2026-09-19 船长令） | 待裁定（已实现 · 待船长实机验收） | 2026-09-19 | 2 KB / 29 行 | 0 / 0 |
...
| `docs/design/side-task-v2-20260918.md` | 时效任务板改版：级别 / 更多席位 / 虚拟货物快递 / 限时快递 / 接单（2026-09-18 船长令） | 待裁定（已实现 · 待船长实机验收） | 2026-09-18 | 7 KB / 74 行 | 0 / 0 |
...
- `docs/design/fit-preset-overwrite-20260919.md`（2026-09-19 · 2 KB）—— 装配方案「替换」按钮：用当前装配覆盖目标方案（2026-09-19 船长令）
...
- `docs/design/side-task-v2-20260918.md`（2026-09-18 · 7 KB）—— 时效任务板改版：级别 / 更多席位 / 虚拟货物快递 / 限时快递 / 接单（2026-09-18 船长令）
