...
- 文档总数 **333** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6185** KB · **43448** 行
- 状态分布：**未标注** 182 · **已确认/已实现** 111 · **进行中** 31 · **待裁定** 8 · **历史留档** 1
- 孤儿文档（0 引用）**48** 份 · 状态未标注 **182** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 483 KB / 989 行 | 218 / 16 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 86 KB / 343 行 | 333 / 18 |
...
| `docs/design/faction-codex-cards-20260926.md` | 势力图鉴：卡片化改造（去切换 · 敌人舰船形象 · 专属件用图鉴卡 · 族徽角标） | 未标注 | 2026-09-26 | 7 KB / 78 行 | 0 / 0 |
...
| `docs/design/handbook-polish-20260926.md` | 手册优化批（势力染色 ＋ 一次全册优化）· 2026-09-26 | 待裁定（待船长验收） | 2026-09-26 | 19 KB / 215 行 | 0 / 0 |
...
| `docs/design/ship-plug-20260926.md` | 舰船插件（2026-09-26） | 进行中（进行中 —— 设计已获船长确认） | 2026-09-26 | 5 KB / 74 行 | 0 / 12 |
...
| `docs/archive/roadmap-2026-09-24.md` | 封存卷 · roadmap 批次条目 2026-09-24 | 未标注 | — | 40 KB / 34 行 | 1 / 0 |
...
| `docs/archive/roadmap-2026-09-25.md` | 封存卷 · roadmap 批次条目 2026-09-25 | 未标注 | — | 34 KB / 28 行 | 1 / 0 |
| `docs/archive/roadmap-2026-09-26.md` | 封存卷 · roadmap 批次条目 2026-09-26 | 未标注 | — | 42 KB / 34 行 | 1 / 0 |
...
- `docs/design/faction-codex-cards-20260926.md`（2026-09-26 · 7 KB）—— 势力图鉴：卡片化改造（去切换 · 敌人舰船形象 · 专属件用图鉴卡 · 族徽角标）
...
- `docs/design/handbook-polish-20260926.md`（2026-09-26 · 19 KB）—— 手册优化批（势力染色 ＋ 一次全册优化）· 2026-09-26
