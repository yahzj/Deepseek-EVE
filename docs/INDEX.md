...
- 文档总数 **323** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6038** KB · **42334** 行
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 481 KB / 987 行 | 216 / 16 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 106 KB / 316 行 | 325 / 17 |
...
| `docs/design/faction-codex-20260926.md` | 工作文档 · 敌族图鉴（手册「航行须知」新开一节）（2026-09-26 · 三号） | 进行中（进行中 —— 已落码、闸门全绿） | 2026-09-26 | 4 KB / 71 行 | 0 / 0 |
...
| `docs/design/hostile-factions-handbook-20260925.md` | 敌族手册（手册 · 新增「敌对势力」一节）—— 挂起备忘（2026-09-25） | 未标注（挂起 · 未动工） | 2026-09-25 | 6 KB / 77 行 | 1 / 1 |
...
- `docs/design/faction-codex-20260926.md`（2026-09-26 · 4 KB）—— 工作文档 · 敌族图鉴（手册「航行须知」新开一节）（2026-09-26 · 三号）
