...
- 文档总数 **329** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6002** KB · **43045** 行
- 状态分布：**未标注** 175 · **已确认/已实现** 111 · **进行中** 38 · **待裁定** 4 · **历史留档** 1
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 472 KB / 985 行 | 219 / 16 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 114 KB / 313 行 | 312 / 17 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/ink-faction-gear-20260926.md` | 墨潮帮（H 族）势力装备三件套（2026-09-26 · 二号 · d2） | 进行中（进行中 —— 四步闸门已走完） | 2026-09-26 | 4 KB / 41 行 | 1 / 0 |
