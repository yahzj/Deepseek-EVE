...
- 文档总数 **288** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5416** KB · **39436** 行
- 状态分布：**未标注** 156 · **已确认/已实现** 109 · **进行中** 21 · **待裁定** 1 · **历史留档** 1
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 383 KB / 891 行 | 197 / 11 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 88 KB / 317 行 | 259 / 10 |
...
| `docs/design/wh-grid-ladder-20260920.md` | 虫洞盘面新台阶（每层 +1 环不封顶）＋ 信标新规 · 2026-09-20 | 进行中（进行中） | 2026-09-20 | 6 KB / 65 行 | 0 / 2 |
