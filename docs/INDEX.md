...
- 文档总数 **296** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5528** KB · **40240** 行
...
| `docs/design/main-activity-win-20260920.md` | 主控活动窗口 ＋ 战斗窗口非全屏化（2026-09-20） | 进行中（进行中） | 2026-09-20 | 9 KB / 135 行 | 0 / 1 |
