...
- 文档总数 **326** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6070** KB · **42669** 行
- 状态分布：**未标注** 180 · **已确认/已实现** 111 · **进行中** 28 · **待裁定** 6 · **历史留档** 1
...
| `docs/development-conventions-changelog.md` | 开发约定 · 变更记录（development-conventions.md 的历次变更） | 未标注 | — | 215 KB / 253 行 | 14 / 2 |
| `docs/development-conventions.md` | 开发约定（Development Conventions） | 未标注 | — | 64 KB / 686 行 | 75 / 3 |
...
| `docs/design/ship-attr-ia-20260926.md` | 舰船属性表信息架构调整（动力 → 间接属性 · 机动速度进主表 · 括号瘦身） | 未标注 | 2026-09-26 | 8 KB / 96 行 | 0 / 0 |
...
- `docs/design/ship-attr-ia-20260926.md`（2026-09-26 · 8 KB）—— 舰船属性表信息架构调整（动力 → 间接属性 · 机动速度进主表 · 括号瘦身）
