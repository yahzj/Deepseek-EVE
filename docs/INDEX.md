...
- 文档总数 **263** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **4963** KB · **36104** 行
...
| `docs/design/c-family-charge-20260916.md` | C 族族格两改：全族冲锋（按档 1.5/2/2.5/3/4）＋ 孢群异虫速度 300 · 工作文档 | 进行中（进行中） | 2026-09-16 | 5 KB / 64 行 | 0 / 0 |
...
- `docs/design/c-family-charge-20260916.md`（2026-09-16 · 5 KB）—— C 族族格两改：全族冲锋（按档 1.5/2/2.5/3/4）＋ 孢群异虫速度 300 · 工作文档
