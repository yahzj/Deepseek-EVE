...
- 文档总数 **269** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5184** KB · **36669** 行
- 状态分布：**未标注** 146 · **已确认/已实现** 108 · **进行中** 8 · **待裁定** 6 · **历史留档** 1
- 孤儿文档（0 引用）**20** 份 · 状态未标注 **146** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/architecture.md` | 架构文档 | 未标注 | — | 23 KB / 223 行 | 31 / 1 |
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 373 KB / 833 行 | 189 / 8 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 81 KB / 274 行 | 253 / 10 |
...
| `docs/design/battle-speed-20260919.md` | 战斗倍速（挂起）· 2026-09-19 | 未标注（挂起） | 2026-09-19 | 3 KB / 38 行 | 0 / 0 |
...
| `docs/design/foe-reinforce-20260911.md` | 单波次内增援（2026-09-11） | 已确认/已实现（已实现 · 未启用） | 2026-09-11 | 10 KB / 145 行 | 4 / 2 |
...
| `docs/archive/roadmap-2026-09-16.md` | 封存卷 · roadmap 批次条目 2026-09-16 | 未标注 | — | 98 KB / 83 行 | 1 / 0 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/test-saves/README.md` | 测试门槛存档（Test Saves） | 未标注 | — | 52 KB / 524 行 | 51 / 9 |
...
- `docs/design/battle-speed-20260919.md`（2026-09-19 · 3 KB）—— 战斗倍速（挂起）· 2026-09-19
