...
- 文档总数 **299** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5564** KB · **40512** 行
...
| `docs/design/friend-audit-20260920.md` | 外部审查报告逐条核对与处置（朋友发来的 project_bug_analysis_report.md · 2026-09-20） | 进行中（进行中） | 2026-09-20 | 9 KB / 90 行 | 0 / 1 |
