...
- 文档总数 **262** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5104** KB · **36158** 行
- 状态分布：**未标注** 144 · **已确认/已实现** 107 · **待裁定** 6 · **进行中** 4 · **历史留档** 1
...
| `docs/design/first-tasks-rework-20260917.md` | 教程重做：「第一次」任务系列 ＋ 前置解锁（2026-09-17 · 船长） | 待裁定（实现完成 · 待船长验收） | 2026-09-17 | 13 KB / 134 行 | 0 / 0 |
...
- `docs/design/first-tasks-rework-20260917.md`（2026-09-17 · 13 KB）—— 教程重做：「第一次」任务系列 ＋ 前置解锁（2026-09-17 · 船长）
