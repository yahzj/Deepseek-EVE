...
- 文档总数 **324** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6153** KB · **42704** 行
- 状态分布：**未标注** 179 · **已确认/已实现** 111 · **进行中** 26 · **待裁定** 7 · **历史留档** 1
...
|---|---|---|---|---|---|
| `AGENTS.md` | AGENTS.md — 大鲸鱼-深空放置 · 仓库级 AI 工作约定(开工必读) | 未标注 | — | 14 KB / 97 行 | 176 / 5 |
