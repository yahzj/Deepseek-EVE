...
- 文档总数 **306** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5725** KB · **40926** 行
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/foe-mounts-20260924.md` | 敌方挂载件：A 族「姿态陀螺仪」＋ G 族「船体修理装置」（2026-09-24） | 已确认/已实现（设计已确认 · 未动工） | 2026-09-24 | 5 KB / 58 行 | 0 / 0 |
| `docs/design/one-time-blueprint-loss-20260924.md` | (无一级标题) | 未标注（已修并合入 main） | 2026-09-24 | 6 KB / 70 行 | 0 / 0 |
...
- `docs/design/foe-mounts-20260924.md`（2026-09-24 · 5 KB）—— 敌方挂载件：A 族「姿态陀螺仪」＋ G 族「船体修理装置」（2026-09-24）
- `docs/design/one-time-blueprint-loss-20260924.md`（2026-09-24 · 6 KB）—— (无一级标题)
