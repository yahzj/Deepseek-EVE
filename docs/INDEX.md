...
- 文档总数 **306** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5725** KB · **41036** 行
- 状态分布：**未标注** 167 · **已确认/已实现** 112 · **进行中** 22 · **待裁定** 4 · **历史留档** 1
- 孤儿文档（0 引用）**36** 份 · 状态未标注 **167** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/design/side-tasks-courier-and-damage-popup-20260924.md` | (无一级标题) | 未标注（已落码、四闸门全绿、已推送） | 2026-09-24 | 4 KB / 58 行 | 0 / 0 |
...
- `docs/design/side-tasks-courier-and-damage-popup-20260924.md`（2026-09-24 · 4 KB）—— (无一级标题)
...
## 附：状态未标注（167 份，待补一行 `状态：…`）

- `docs/design/side-tasks-courier-and-damage-popup-20260924.md`（2026-09-24）—— (无一级标题)
