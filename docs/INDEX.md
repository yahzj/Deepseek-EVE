...
- 文档总数 **325** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6159** KB · **42770** 行
- 状态分布：**未标注** 179 · **已确认/已实现** 111 · **进行中** 27 · **待裁定** 7 · **历史留档** 1
- 孤儿文档（0 引用）**44** 份 · 状态未标注 **179** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
- 三、现行设计稿（design）：**204** 份
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 69 KB / 362 行 | 328 / 18 |
...
| `docs/design/standing-clawback-blackbox-20260926.md` | 声望账本回正 ＋ 入侵黑匣补发（2026-09-26 晚 · 二号 · d2） | 待裁定（已实现 · 待船长验收） | 2026-09-26 | 7 KB / 86 行 | 0 / 0 |
...
- `docs/design/standing-clawback-blackbox-20260926.md`（2026-09-26 · 7 KB）—— 声望账本回正 ＋ 入侵黑匣补发（2026-09-26 晚 · 二号 · d2）
