...
- 文档总数 **327** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6091** KB · **42858** 行
...
| `docs/development-conventions-changelog.md` | 开发约定 · 变更记录（development-conventions.md 的历次变更） | 未标注 | — | 219 KB / 255 行 | 14 / 2 |
...
| `docs/design/ship-attr-ia-20260926.md` | 舰船属性表信息架构调整（动力 → 间接属性 · 机动速度进主表 · 括号瘦身） | 未标注 | 2026-09-26 | 9 KB / 109 行 | 0 / 0 |
...
- `docs/design/ship-attr-ia-20260926.md`（2026-09-26 · 9 KB）—— 舰船属性表信息架构调整（动力 → 间接属性 · 机动速度进主表 · 括号瘦身）
