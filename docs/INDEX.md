...
- 文档总数 **319** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5900** KB · **42398** 行
- 状态分布：**未标注** 172 · **已确认/已实现** 111 · **进行中** 32 · **待裁定** 3 · **历史留档** 1
- 孤儿文档（0 引用）**46** 份 · 状态未标注 **172** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
- 三、现行设计稿（design）：**205** 份
...
|---|---|---|---|---|---|
| `AGENTS.md` | AGENTS.md — 大鲸鱼-深空放置 · 仓库级 AI 工作约定(开工必读) | 未标注 | — | 14 KB / 97 行 | 169 / 5 |
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 463 KB / 985 行 | 211 / 16 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 88 KB / 316 行 | 300 / 17 |
...
| `docs/design/h-family-reprice-20260925.md` | H 族按新规调整（威胁重定价 · 入侵抽签 · 遇袭强度 ×0.75） | 未标注（落码完成 · 待验收） | 2026-09-25 | 19 KB / 161 行 | 0 / 0 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/test-saves/README.md` | 测试门槛存档（Test Saves） | 未标注 | — | 61 KB / 610 行 | 54 / 10 |
...
- `docs/design/h-family-reprice-20260925.md`（2026-09-25 · 19 KB）—— H 族按新规调整（威胁重定价 · 入侵抽签 · 遇袭强度 ×0.75）
