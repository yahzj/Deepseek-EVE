...
- 文档总数 **308** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5761** KB · **41197** 行
...
|---|---|---|---|---|---|
| `AGENTS.md` | AGENTS.md — 大鲸鱼-深空放置 · 仓库级 AI 工作约定(开工必读) | 未标注 | — | 14 KB / 98 行 | 162 / 5 |
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 79 KB / 318 行 | 292 / 14 |
