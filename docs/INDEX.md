...
- 文档总数 **279** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5316** KB · **38691** 行
- 状态分布：**未标注** 148 · **已确认/已实现** 108 · **进行中** 16 · **待裁定** 6 · **历史留档** 1
- 孤儿文档（0 引用）**25** 份 · 状态未标注 **148** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/design/l10n-en-20260919.md` | 英语本地化（可玩骨架）· 工作文档（2026-09-19） | 进行中（进行中） | 2026-09-19 | 17 KB / 197 行 | 5 / 2 |
| `docs/design/l10n-en-handover-20260919.md` | 英语本地化 · 交接卡（2026-09-19 · 三号） | 未标注 | 2026-09-19 | 11 KB / 154 行 | 0 / 0 |
...
| `docs/archive/README.md` | 封存区（docs/archive/）—— 冻结的历史件 | 未标注 | — | 2 KB / 30 行 | 56 / 9 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/glossary-en.md` | 英文术语与专名译名表（English Glossary & Naming Table） | 未标注（P0 已冻结） | — | 39 KB / 696 行 | 9 / 12 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/test-saves/README.md` | 测试门槛存档（Test Saves） | 未标注 | — | 54 KB / 544 行 | 56 / 9 |
...
| `docs/design/ship-battle-art/README.md` | 舰船战斗图形重设计(三号 · 样稿阶段,2026-09-09) | 未标注 | — | 8 KB / 87 行 | 56 / 9 |
...
| `docs/design/archive/README.md` | 归档区说明（docs/design/archive/） | 未标注 | — | 11 KB / 120 行 | 56 / 9 |
...
- `docs/design/l10n-en-handover-20260919.md`（2026-09-19 · 11 KB）—— 英语本地化 · 交接卡（2026-09-19 · 三号）
