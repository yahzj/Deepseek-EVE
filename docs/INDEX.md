...
- 文档总数 **261** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **4882** KB · **35910** 行
...
| `docs/design/hullrep-in-wormhole-20260916.md` | 报障核查：船体维修装置在虫洞里无效（2026-09-16） | 未标注（已落码待验收） | 2026-09-16 | 10 KB / 116 行 | 0 / 0 |
...
| `docs/design/wormhole-wreck-gate-20260915.md` | 虫洞战利品两件（稀有残骸闸门漏摘修复 ＋ 谜质说明）· 工作文档 | 进行中（进行中） | 2026-09-15 | 7 KB / 99 行 | 0 / 0 |
...
- `docs/design/hullrep-in-wormhole-20260916.md`（2026-09-16 · 10 KB）—— 报障核查：船体维修装置在虫洞里无效（2026-09-16）
...
- `docs/design/wormhole-wreck-gate-20260915.md`（2026-09-15 · 7 KB）—— 虫洞战利品两件（稀有残骸闸门漏摘修复 ＋ 谜质说明）· 工作文档
