...
- 文档总数 **288** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5445** KB · **39781** 行
...
| `docs/design/l10n-en-handover-20260919.md` | 英语本地化 · 交接卡（2026-09-19 · 三号） | 未标注 | 2026-09-19 | 28 KB / 346 行 | 1 / 0 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/glossary-en.md` | 英文术语与专名译名表（English Glossary & Naming Table） | 未标注（P0 已冻结） | — | 40 KB / 708 行 | 12 / 12 |
