...
- 文档总数 **297** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5642** KB · **40617** 行
- 状态分布：**未标注** 165 · **已确认/已实现** 111 · **进行中** 16 · **待裁定** 4 · **历史留档** 1
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 115 KB / 454 行 | 277 / 14 |
