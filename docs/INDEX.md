...
- 文档总数 **275** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5055** KB · **37039** 行
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 320 KB / 764 行 | 198 / 8 |
...
| `docs/design/ship-category-armor-line-20260916.md` | 舰船类别改名「装甲舰」＋「装甲线」判据（牛鲨与 E 族专属舰盾/甲互换）· 工作文档 | 进行中（进行中） | 2026-09-16 | 5 KB / 61 行 | 0 / 0 |
...
- `docs/design/ship-category-armor-line-20260916.md`（2026-09-16 · 5 KB）—— 舰船类别改名「装甲舰」＋「装甲线」判据（牛鲨与 E 族专属舰盾/甲互换）· 工作文档
