...
- 文档总数 **289** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5571** KB · **40000** 行
- 状态分布：**未标注** 159 · **已确认/已实现** 109 · **进行中** 19 · **待裁定** 1 · **历史留档** 1
- 孤儿文档（0 引用）**28** 份 · 状态未标注 **159** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 432 KB / 942 行 | 199 / 13 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 97 KB / 421 行 | 268 / 15 |
...
| `docs/review/pending-decisions-20260910.md` | 待船长裁决清单（2026-09-10 · 二号整理，供逐条审核） | 未标注 | 2026-09-10 | 29 KB / 374 行 | 14 / 0 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/activity-switch-unify-20260921.md` | 主控活动切换：现状统计 ＋ 统一方案（2026-09-21 船长令） | 未标注（方案） | 2026-09-21 | 8 KB / 101 行 | 0 / 0 |
...
| `docs/design/main-activity-win-20260920.md` | 主控活动窗口 ＋ 战斗窗口非全屏化（2026-09-20） | 进行中（进行中） | 2026-09-20 | 20 KB / 296 行 | 0 / 1 |
| `docs/design/skills-tech-tree-plan-20260920.md` | 方案：技能页改「向下生长的科技树」（2026-09-20 · 试作页已落码） | 进行中（进行中） | 2026-09-20 | 12 KB / 141 行 | 0 / 0 |
...
| `docs/design/filters-audit-20260919.md` | 全仓筛选标签盘点（供船长审核与统一口径） · 2026-09-19 | 进行中（进行中） | 2026-09-19 | 38 KB / 403 行 | 5 / 0 |
...
| `docs/design/foe-c-range-20260914.md` | C 族（虫子）全族射程 +1000 · 目标距离不变（2026-09-14） | 未标注 | 2026-09-14 | 13 KB / 181 行 | 10 / 0 |
...
| `docs/design/wormhole-exclusive-20260913.md` | 终局玩法「虫洞」· 掉落物设计（虫洞专属装备 / 舰船 / 一次性图纸）· 设计稿 | 未标注（设计稿 · 船长逐条裁定已并入 §0） | 2026-09-13 | 74 KB / 789 行 | 14 / 5 |
...
| `docs/design/foe-pending-index-20260911.md` | 敌族待办统一总表（2026-09-11 · 全仓唯一入口） | 未标注 | 2026-09-11 | 29 KB / 128 行 | 19 / 0 |
...
| `docs/design/steam-store-draft-20260911.md` | Steam 商店页文案 · 终稿（2026-09-11，三号撰稿；口径已由船长裁决） | 已确认/已实现（口径已确认） | 2026-09-11 | 9 KB / 160 行 | 1 / 0 |
...
| `docs/design/drone-losses-20260910.md` | 无人机可被击落（2026-09-10，已确认并实施） | 已确认/已实现（船长已确认并实施） | 2026-09-10 | 22 KB / 262 行 | 19 / 0 |
| `docs/design/drone-roles-20260910.md` | 无人机四型定位与现有无人机调整方案（2026-09-10，已确认并实施） | 已确认/已实现（船长已确认） | 2026-09-10 | 12 KB / 168 行 | 9 / 0 |
| `docs/design/enemy-speed-retune-20260910.md` | 敌速重标（2026-09-10 · 状态：已确认并实现） | 已确认/已实现（已确认并实现） | 2026-09-10 | 27 KB / 410 行 | 5 / 2 |
| `docs/design/faction-tactic-20260910.md` | 族系战术改判 + 能量卡火力重标（2026-09-10 · 状态：已确认并实现） | 已确认/已实现（已确认并实现） | 2026-09-10 | 9 KB / 154 行 | 6 / 0 |
...
| `docs/design/v10-content.md` | V10 设计：深空市场大扩容（占位导入） | 已确认/已实现（已确认） | — | 15 KB / 223 行 | 5 / 0 |
...
| `docs/archive/roadmap-2026-09-13.md` | 封存卷 · roadmap 批次条目 2026-09-13 | 未标注 | — | 264 KB / 231 行 | 2 / 0 |
| `docs/archive/roadmap-2026-09-14.md` | 封存卷 · roadmap 批次条目 2026-09-14 | 未标注 | — | 397 KB / 256 行 | 3 / 1 |
| `docs/archive/roadmap-2026-09-15.md` | 封存卷 · roadmap 批次条目 2026-09-15 | 未标注 | — | 132 KB / 84 行 | 3 / 0 |
...
| `docs/archive/roadmap-2026-09-18.md` | 封存卷 · roadmap 批次条目 2026-09-18 | 未标注 | — | 9 KB / 14 行 | 0 / 0 |
| `docs/archive/roadmap-2026-09-20.md` | 封存卷 · roadmap 批次条目 2026-09-20 | 未标注 | — | 34 KB / 132 行 | 0 / 0 |

## 二、其它（docs 根目录） —— 1 份

| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/glossary-en.md` | 英文术语与专名译名表（English Glossary & Naming Table） | 未标注（P0 已冻结） | — | 41 KB / 723 行 | 6 / 13 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/test-saves/README.md` | 测试门槛存档（Test Saves） | 未标注 | — | 56 KB / 565 行 | 53 / 9 |
...
| `docs/design/ship-battle-art/README.md` | 舰船战斗图形重设计(三号 · 样稿阶段,2026-09-09) | 未标注 | — | 8 KB / 87 行 | 53 / 9 |
...
| `docs/design/archive/handoff-20260912-to-new-pilot1.md` | 交接文档 · 大鲸鱼深空工业 · 2026-09-12 夜（一号 → 新一号） | 未标注 | 2026-09-12 | 16 KB / 173 行 | 9 / 0 |
...
| `docs/design/archive/announcement-draft-20260910-pending.md` | 本地未发布批次 · 更新公告待审稿（2026-09-10 第二批；未经船长批准不得写入 announcements.ts） | 未标注 | 2026-09-10 | 15 KB / 177 行 | 11 / 0 |
...
- `docs/design/activity-switch-unify-20260921.md`（2026-09-21 · 8 KB）—— 主控活动切换：现状统计 ＋ 统一方案（2026-09-21 船长令）
...
- `docs/design/skills-tech-tree-plan-20260920.md`（2026-09-20 · 12 KB）—— 方案：技能页改「向下生长的科技树」（2026-09-20 · 试作页已落码）
...
- `docs/archive/roadmap-2026-09-18.md`（无日期 · 9 KB）—— 封存卷 · roadmap 批次条目 2026-09-18
- `docs/archive/roadmap-2026-09-20.md`（无日期 · 34 KB）—— 封存卷 · roadmap 批次条目 2026-09-20
...
## 附：状态未标注（159 份，待补一行 `状态：…`）

- `docs/design/activity-switch-unify-20260921.md`（2026-09-21）—— 主控活动切换：现状统计 ＋ 统一方案（2026-09-21 船长令）
