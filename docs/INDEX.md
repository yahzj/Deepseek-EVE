...
- 文档总数 **293** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5612** KB · **40482** 行
- 状态分布：**未标注** 158 · **已确认/已实现** 109 · **进行中** 23 · **待裁定** 2 · **历史留档** 1
- 孤儿文档（0 引用）**32** 份 · 状态未标注 **158** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/announcement-draft-20260922.md` | 公告待审稿 · 2026-09-22（主控活动切换统一 / 「第一次」任务调整 / 界面更新） | 待裁定（待船长审核） | 2026-09-22 | 6 KB / 66 行 | 0 / 0 |
...
- `docs/design/announcement-draft-20260922.md`（2026-09-22 · 6 KB）—— 公告待审稿 · 2026-09-22（主控活动切换统一 / 「第一次」任务调整 / 界面更新）
