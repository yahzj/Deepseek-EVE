...
- 文档总数 **294** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5511** KB · **39997** 行
- 状态分布：**未标注** 157 · **已确认/已实现** 109 · **进行中** 26 · **待裁定** 1 · **历史留档** 1
- 孤儿文档（0 引用）**29** 份 · 状态未标注 **157** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 411 KB / 931 行 | 209 / 11 |
...
| `docs/design/task-center-seq-milestone-20260920.md` | 任务中心：「第一次」顺序解锁 ＋ 新子页「里程碑任务」（2026-09-20） | 进行中（进行中） | 2026-09-20 | 6 KB / 74 行 | 0 / 0 |
...
- `docs/design/task-center-seq-milestone-20260920.md`（2026-09-20 · 6 KB）—— 任务中心：「第一次」顺序解锁 ＋ 新子页「里程碑任务」（2026-09-20）
