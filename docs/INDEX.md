...
- 文档总数 **323** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6135** KB · **42540** 行
- 状态分布：**未标注** 180 · **已确认/已实现** 111 · **进行中** 26 · **待裁定** 5 · **历史留档** 1
- 孤儿文档（0 引用）**40** 份 · 状态未标注 **180** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/design/plug-exchange-invasion-standing-20260926.md` | 章鱼人兑换两改 ＋ 入侵结算/结束通讯写出声望（2026-09-26） | 待裁定（已实现 · 待船长验收） | 2026-09-26 | 4 KB / 52 行 | 0 / 0 |
...
- `docs/design/plug-exchange-invasion-standing-20260926.md`（2026-09-26 · 4 KB）—— 章鱼人兑换两改 ＋ 入侵结算/结束通讯写出声望（2026-09-26）
