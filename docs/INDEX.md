...
- 文档总数 **330** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6184** KB · **43126** 行
- 状态分布：**未标注** 180 · **已确认/已实现** 111 · **进行中** 27 · **待裁定** 11 · **历史留档** 1
- 孤儿文档（0 引用）**49** 份 · 状态未标注 **180** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
|---|---|---|---|---|---|
| `AGENTS.md` | AGENTS.md — 大鲸鱼-深空放置 · 仓库级 AI 工作约定(开工必读) | 未标注 | — | 14 KB / 97 行 | 178 / 5 |
...
| `docs/development-conventions.md` | 开发约定（Development Conventions） | 未标注 | — | 65 KB / 692 行 | 75 / 3 |
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 486 KB / 991 行 | 218 / 16 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 69 KB / 362 行 | 330 / 18 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/assembler-lazy-mount-20260927.md` | 组装机卡片流式加载（视口懒挂载）· 2026-09-27 | 进行中（进行中） | 2026-09-27 | 8 KB / 100 行 | 0 / 0 |
| `docs/design/announcement-draft-20260926-battleships.md` | 公告待审稿 · 两艘新战列舰入列（2026-09-26） | 待裁定（待船长审核——按 AGENTS.md） | 2026-09-26 | 4 KB / 48 行 | 0 / 0 |
| `docs/design/ecm-stacking-copy-20260926.md` | 报障修正：墨潮电子舱卡面「全额叠加」＋ 缺最短射程 3,000 m（2026-09-26 · 二号 · d2） | 待裁定（已实现 · 待船长验收） | 2026-09-26 | 4 KB / 48 行 | 0 / 0 |
| `docs/design/h-wreck-mixed-pool-20260926.md` | H 族稀有残骸改「混池」（2026-09-26 · 一号 · main） | 待裁定（实现完成 · 待船长验收） | 2026-09-26 | 4 KB / 48 行 | 0 / 0 |
| `docs/design/handoff-20260926-to-pilot2.md` | 交接卡：新二号（2026-09-26 · 旧二号交班） | 未标注（交接中） | 2026-09-26 | 11 KB / 106 行 | 0 / 0 |
| `docs/design/industry-ui-opt-20260926.md` | 工业界面优化批 ＋ 组装机/造船厂筛选合并（2026-09-26 · 二号 · d2） | 进行中（进行中 —— ①「工业界面优化」四条） | 2026-09-26 | 7 KB / 87 行 | 0 / 0 |
| `docs/design/invasion-kill-roll-20260926.md` | 报障分析：入侵活动里「没有判定击杀」（2026-09-26 晚 · 二号 · d2） | 未标注（根因已定位 · 缺失的那一掷已修） | 2026-09-26 | 6 KB / 103 行 | 0 / 0 |
| `docs/design/octopus-drain-hold-20260926.md` | 旗舰战后的章鱼人冷却（2026-09-26 · 一号 · main） | 待裁定（实现完成 · 待船长验收） | 2026-09-26 | 5 KB / 56 行 | 0 / 0 |
| `docs/design/plug-cargo-and-fit-slot-20260926.md` | 报障两条：插件装货仓再卸货「不见了」＋ 所有船的插件显示成同一套（2026-09-26 · 二号 · d2） | 待裁定（已实现 · 待船长验收） | 2026-09-26 | 5 KB / 65 行 | 0 / 0 |
| `docs/design/ship-plug-20260926.md` | 舰船插件（2026-09-26） | 进行中（进行中 —— 设计已获船长确认） | 2026-09-26 | 6 KB / 97 行 | 0 / 12 |
| `docs/design/ship-wreck-20260926.md` | 玩家舰船残骸（含加固结构插件回收接口）（2026-09-26） | 进行中（进行中 —— 设计已获船长确认） | 2026-09-26 | 9 KB / 128 行 | 1 / 4 |
| `docs/design/skill-cancel-baseline-20260926.md` | 取消技能：连带取消清单只算"因本次取消才失效"的项（2026-09-26 · 一号 · main） | 待裁定（实现完成 · 待船长验收） | 2026-09-26 | 4 KB / 57 行 | 0 / 0 |
| `docs/design/standing-clawback-blackbox-20260926.md` | 声望账本回正 ＋ 入侵黑匣补发（2026-09-26 晚 · 二号 · d2） | 待裁定（已实现 · 待船长验收） | 2026-09-26 | 9 KB / 121 行 | 0 / 0 |
| `docs/design/weekend-spoils-warehouse-20260926.md` | 入侵战利品落点与「报告 vs 实物」一致性（2026-09-26 · 一号 · main） | 进行中（进行中） | 2026-09-26 | 7 KB / 92 行 | 0 / 0 |
...
| `docs/design/wormhole-extraction-endgame-20260912.md` | 终局玩法「虫洞」（搜打撤底层）· 设计稿 | 未标注 | 2026-09-12 | 182 KB / 1818 行 | 33 / 7 |
...
| `docs/design/weekend-invasion.md` | 周末入侵活动（设计定稿 · 2026-09-25 22:00 已对玩家开放 · M2 余下三族 / M3 未开工） | 未标注（M1 机制骨架 ＋ M2 的 H 族） | — | 30 KB / 254 行 | 10 / 8 |
...
| `docs/archive/roadmap-2026-09-24.md` | 封存卷 · roadmap 批次条目 2026-09-24 | 未标注 | — | 42 KB / 36 行 | 1 / 0 |
...
| `docs/archive/roadmap-2026-09-26.md` | 封存卷 · roadmap 批次条目 2026-09-26 | 未标注 | — | 76 KB / 58 行 | 1 / 0 |
...
- `docs/design/assembler-lazy-mount-20260927.md`（2026-09-27 · 8 KB）—— 组装机卡片流式加载（视口懒挂载）· 2026-09-27
- `docs/design/announcement-draft-20260926-battleships.md`（2026-09-26 · 4 KB）—— 公告待审稿 · 两艘新战列舰入列（2026-09-26）
- `docs/design/ecm-stacking-copy-20260926.md`（2026-09-26 · 4 KB）—— 报障修正：墨潮电子舱卡面「全额叠加」＋ 缺最短射程 3,000 m（2026-09-26 · 二号 · d2）
- `docs/design/h-wreck-mixed-pool-20260926.md`（2026-09-26 · 4 KB）—— H 族稀有残骸改「混池」（2026-09-26 · 一号 · main）
- `docs/design/handoff-20260926-to-pilot2.md`（2026-09-26 · 11 KB）—— 交接卡：新二号（2026-09-26 · 旧二号交班）
- `docs/design/industry-ui-opt-20260926.md`（2026-09-26 · 7 KB）—— 工业界面优化批 ＋ 组装机/造船厂筛选合并（2026-09-26 · 二号 · d2）
- `docs/design/invasion-kill-roll-20260926.md`（2026-09-26 · 6 KB）—— 报障分析：入侵活动里「没有判定击杀」（2026-09-26 晚 · 二号 · d2）
- `docs/design/octopus-drain-hold-20260926.md`（2026-09-26 · 5 KB）—— 旗舰战后的章鱼人冷却（2026-09-26 · 一号 · main）
- `docs/design/plug-cargo-and-fit-slot-20260926.md`（2026-09-26 · 5 KB）—— 报障两条：插件装货仓再卸货「不见了」＋ 所有船的插件显示成同一套（2026-09-26 · 二号 · d2）
- `docs/design/skill-cancel-baseline-20260926.md`（2026-09-26 · 4 KB）—— 取消技能：连带取消清单只算"因本次取消才失效"的项（2026-09-26 · 一号 · main）
- `docs/design/standing-clawback-blackbox-20260926.md`（2026-09-26 · 9 KB）—— 声望账本回正 ＋ 入侵黑匣补发（2026-09-26 晚 · 二号 · d2）
- `docs/design/weekend-spoils-warehouse-20260926.md`（2026-09-26 · 7 KB）—— 入侵战利品落点与「报告 vs 实物」一致性（2026-09-26 · 一号 · main）
...
- `docs/design/offline-cap-skill-20260922.md`（2026-09-22 · 2 KB）—— 离线结算上限：技能加成与「超出上限」读数同源（2026-09-22）
...
- `docs/design/invasion-kill-roll-20260926.md`（2026-09-26）—— 报障分析：入侵活动里「没有判定击杀」（2026-09-26 晚 · 二号 · d2）
...
- `docs/archive/roadmap-2026-09-25-24.md`（无日期）—— 封存卷 · roadmap 批次条目 2026-09-25/24
