...
- 文档总数 **297** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5640** KB · **40145** 行
- 状态分布：**未标注** 164 · **已确认/已实现** 110 · **进行中** 19 · **待裁定** 3 · **历史留档** 1
- 孤儿文档（0 引用）**30** 份 · 状态未标注 **164** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/design/hold-ux-20260922.md` | 洞内货仓操作体验四条（2026-09-22） | 进行中（进行中） | 2026-09-22 | 5 KB / 59 行 | 0 / 0 |
...
- `docs/design/hold-ux-20260922.md`（2026-09-22 · 5 KB）—— 洞内货仓操作体验四条（2026-09-22）
