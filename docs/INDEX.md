...
- 文档总数 **319** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5903** KB · **42413** 行
...
| `docs/design/h-family-reprice-20260925.md` | H 族按新规调整（威胁重定价 · 入侵抽签 · 遇袭强度 ×0.75） | 未标注（落码完成 · 待验收） | 2026-09-25 | 22 KB / 176 行 | 0 / 0 |
...
- `docs/design/h-family-reprice-20260925.md`（2026-09-25 · 22 KB）—— H 族按新规调整（威胁重定价 · 入侵抽签 · 遇袭强度 ×0.75）
