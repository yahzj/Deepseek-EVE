...
- 文档总数 **299** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5569** KB · **40573** 行
- 状态分布：**未标注** 157 · **已确认/已实现** 109 · **进行中** 31 · **待裁定** 1 · **历史留档** 1
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 415 KB / 931 行 | 214 / 12 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 108 KB / 410 行 | 260 / 10 |
...
| `docs/design/friend-audit-20260920.md` | 外部审查报告逐条核对与处置（朋友发来的 project_bug_analysis_report.md · 2026-09-20） | 进行中（进行中） | 2026-09-20 | 14 KB / 151 行 | 0 / 1 |
