...
- 文档总数 **297** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5667** KB · **40481** 行
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/ironman-mode-20260923.md` | 铁人模式（Iron Man · 不可回退的存档纪律 ＋ 铁人福利）· 2026-09-23 | 进行中（进行中） | 2026-09-23 | 15 KB / 146 行 | 0 / 2 |
