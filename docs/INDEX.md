...
- 文档总数 **318** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6012** KB · **42256** 行
- 状态分布：**未标注** 176 · **已确认/已实现** 111 · **进行中** 25 · **待裁定** 5 · **历史留档** 1
- 孤儿文档（0 引用）**38** 份 · 状态未标注 **176** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 147 KB / 326 行 | 314 / 17 |
...
| `docs/design/ui-refresh-20260925.md` | 工作文档 · UI 系统级优化重置（ui-refresh 隔离分支）（2026-09-25 · 三号） | 进行中（进行中） | 2026-09-25 | 13 KB / 181 行 | 1 / 0 |
...
| `docs/design/ui-shell-layout2-20260925.md` | 工作文档 · 外壳布局第二轮（ui-redesign-2）（2026-09-25 · 三号） | 进行中（进行中） | 2026-09-25 | 17 KB / 211 行 | 1 / 0 |
