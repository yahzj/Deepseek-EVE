...
- 文档总数 **332** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6138** KB · **43216** 行
- 状态分布：**未标注** 180 · **已确认/已实现** 111 · **进行中** 29 · **待裁定** 11 · **历史留档** 1
...
| `docs/design/player-web-range-20260926.md` | 我方捕获网：距离上限 4000 米 ＋ 减速降为 50%（2026-09-26） | 待裁定（已实现 · 待船长验收） | 2026-09-26 | 5 KB / 66 行 | 0 / 0 |
...
- `docs/design/player-web-range-20260926.md`（2026-09-26 · 5 KB）—— 我方捕获网：距离上限 4000 米 ＋ 减速降为 50%（2026-09-26）
