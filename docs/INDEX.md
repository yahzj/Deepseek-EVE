...
- 文档总数 **286** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5422** KB · **39632** 行
...
| `docs/design/parts-shipyard-20260920.md` | 工作文档：造船厂拆分 + 零件体系（14 零件 + 2 技能）· 2026-09-20 | 进行中（进行中） | 2026-09-20 | 21 KB / 207 行 | 0 / 0 |
