...
- 文档总数 **315** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5862** KB · **42079** 行
- 状态分布：**未标注** 172 · **已确认/已实现** 111 · **进行中** 28 · **待裁定** 3 · **历史留档** 1
- 孤儿文档（0 引用）**42** 份 · 状态未标注 **172** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/foe-threat-rerate-20260925.md` | 洞外常驻悬赏「威胁重定标」批（单舰 ×3 定价式） | 未标注（已落码） | 2026-09-25 | 19 KB / 260 行 | 0 / 0 |
...
- `docs/design/foe-threat-rerate-20260925.md`（2026-09-25 · 19 KB）—— 洞外常驻悬赏「威胁重定标」批（单舰 ×3 定价式）
...
- `docs/design/foe-threat-rerate-20260925.md`（2026-09-25）—— 洞外常驻悬赏「威胁重定标」批（单舰 ×3 定价式）
