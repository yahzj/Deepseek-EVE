...
- 文档总数 **286** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5556** KB · **39812** 行
- 状态分布：**未标注** 158 · **已确认/已实现** 109 · **进行中** 17 · **待裁定** 1 · **历史留档** 1
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 432 KB / 942 行 | 197 / 13 |
...
| `docs/design/main-activity-win-20260920.md` | 主控活动窗口 ＋ 战斗窗口非全屏化（2026-09-20） | 进行中（进行中） | 2026-09-20 | 26 KB / 379 行 | 0 / 1 |
