...
- 文档总数 **306** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5774** KB · **41030** 行
- 状态分布：**未标注** 170 · **已确认/已实现** 110 · **进行中** 22 · **待裁定** 3 · **历史留档** 1
...
| `docs/development-conventions-changelog.md` | 开发约定 · 变更记录（development-conventions.md 的历次变更） | 未标注 | — | 205 KB / 249 行 | 14 / 1 |
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 85 KB / 321 行 | 294 / 17 |
