...
- 文档总数 **325** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5972** KB · **43105** 行
- 状态分布：**未标注** 171 · **已确认/已实现** 111 · **进行中** 38 · **待裁定** 4 · **历史留档** 1
- 孤儿文档（0 引用）**50** 份 · 状态未标注 **171** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/design/weekend-flagship-prep-20260925.md` | 旗舰战入口 ＋ 战前准备界面（选船） | 进行中（进行中） | 2026-09-25 | 40 KB / 286 行 | 1 / 0 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/test-saves/README.md` | 测试门槛存档（Test Saves） | 未标注 | — | 64 KB / 636 行 | 55 / 10 |
