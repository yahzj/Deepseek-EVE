...
- 文档总数 **296** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5529** KB · **40255** 行
- 状态分布：**未标注** 157 · **已确认/已实现** 109 · **进行中** 28 · **待裁定** 1 · **历史留档** 1
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 411 KB / 931 行 | 210 / 11 |
...
| `docs/design/main-activity-win-20260920.md` | 主控活动窗口 ＋ 战斗窗口非全屏化（2026-09-20） | 进行中（进行中） | 2026-09-20 | 10 KB / 150 行 | 0 / 1 |
