...
- 文档总数 **297** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5669** KB · **40496** 行
- 状态分布：**未标注** 163 · **已确认/已实现** 110 · **进行中** 19 · **待裁定** 4 · **历史留档** 1
- 孤儿文档（0 引用）**28** 份 · 状态未标注 **163** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 442 KB / 948 行 | 200 / 13 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 81 KB / 359 行 | 282 / 14 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/ironman-mode-20260923.md` | 铁人模式（Iron Man · 不可回退的存档纪律 ＋ 铁人福利）· 2026-09-23 | 进行中（进行中） | 2026-09-23 | 17 KB / 161 行 | 0 / 2 |
...
| `docs/design/box-seed-20260922.md` | 货柜开箱：按「存档种子 + 第 N 次拆解」现算（2026-09-22） | 进行中（进行中） | 2026-09-22 | 3 KB / 33 行 | 0 / 0 |
...
| `docs/design/ui-theme-20260922.md` | 界面配色（皮肤切换）：深空 / 亮白 / 高对比（2026-09-22） | 进行中（进行中） | 2026-09-22 | 17 KB / 169 行 | 0 / 1 |
...
- `docs/design/box-seed-20260922.md`（2026-09-22 · 3 KB）—— 货柜开箱：按「存档种子 + 第 N 次拆解」现算（2026-09-22）
