...
- 文档总数 **287** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5430** KB · **39692** 行
- 状态分布：**未标注** 157 · **已确认/已实现** 109 · **进行中** 19 · **待裁定** 1 · **历史留档** 1
- 孤儿文档（0 引用）**23** 份 · 状态未标注 **157** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/design/parts-shipyard-20260920.md` | 工作文档：造船厂拆分 + 零件体系（14 零件 + 2 技能）· 2026-09-20 | 进行中（进行中） | 2026-09-20 | 21 KB / 209 行 | 1 / 1 |
