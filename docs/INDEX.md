...
- 文档总数 **273** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5042** KB · **36899** 行
- 状态分布：**未标注** 141 · **已确认/已实现** 107 · **进行中** 19 · **待裁定** 5 · **历史留档** 1
- 孤儿文档（0 引用）**22** 份 · 状态未标注 **141** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**9** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 320 KB / 764 行 | 197 / 8 |
