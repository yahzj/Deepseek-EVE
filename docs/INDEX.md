...
- 文档总数 **289** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5573** KB · **40022** 行
- 状态分布：**未标注** 158 · **已确认/已实现** 109 · **进行中** 20 · **待裁定** 1 · **历史留档** 1
- 孤儿文档（0 引用）**28** 份 · 状态未标注 **158** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/activity-switch-unify-20260921.md` | 主控活动切换：现状统计 ＋ 统一方案（2026-09-21 船长令） | 进行中（进行中） | 2026-09-21 | 10 KB / 123 行 | 0 / 0 |
...
- `docs/design/activity-switch-unify-20260921.md`（2026-09-21 · 10 KB）—— 主控活动切换：现状统计 ＋ 统一方案（2026-09-21 船长令）
