...
- 文档总数 **323** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6148** KB · **42636** 行
- 状态分布：**未标注** 179 · **已确认/已实现** 111 · **进行中** 27 · **待裁定** 5 · **历史留档** 1
- 孤儿文档（0 引用）**42** 份 · 状态未标注 **179** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 69 KB / 362 行 | 327 / 18 |
