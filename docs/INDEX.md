...
- 文档总数 **264** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5149** KB · **36299** 行
- 状态分布：**未标注** 145 · **已确认/已实现** 108 · **待裁定** 7 · **进行中** 3 · **历史留档** 1
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 370 KB / 831 行 | 184 / 8 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 85 KB / 263 行 | 251 / 10 |
...
| `docs/design/auto-loop-toggle-20260918.md` | 重复清剿改「可随时开关」（船长 2026-09-18）· 工作文档 | 进行中（进行中） | 2026-09-18 | 5 KB / 59 行 | 0 / 0 |
...
- `docs/design/auto-loop-toggle-20260918.md`（2026-09-18 · 5 KB）—— 重复清剿改「可随时开关」（船长 2026-09-18）· 工作文档
