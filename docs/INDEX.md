...
- 文档总数 **328** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6095** KB · **42919** 行
- 状态分布：**未标注** 180 · **已确认/已实现** 111 · **进行中** 30 · **待裁定** 6 · **历史留档** 1
...
| `docs/development-conventions-changelog.md` | 开发约定 · 变更记录（development-conventions.md 的历次变更） | 未标注 | — | 219 KB / 255 行 | 14 / 3 |
...
| `docs/design/ship-plug-20260926.md` | 舰船插件（2026-09-26） | 进行中（进行中 —— 设计已获船长确认） | 2026-09-26 | 5 KB / 74 行 | 0 / 10 |
