...
- 文档总数 **316** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5859** KB · **41931** 行
- 状态分布：**未标注** 171 · **已确认/已实现** 111 · **进行中** 30 · **待裁定** 3 · **历史留档** 1
- 孤儿文档（0 引用）**43** 份 · 状态未标注 **171** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/design/h-family-reprice-20260925.md` | H 族按新规调整（威胁重定价 · 入侵抽签 · 遇袭强度 ×0.75） | 进行中（进行中） | 2026-09-25 | 4 KB / 49 行 | 0 / 0 |
...
- `docs/design/h-family-reprice-20260925.md`（2026-09-25 · 4 KB）—— H 族按新规调整（威胁重定价 · 入侵抽签 · 遇袭强度 ×0.75）
