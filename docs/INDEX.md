...
- 文档总数 **307** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5778** KB · **41116** 行
...
| `docs/design/weekend-invasion-m2-20260924.md` | 周末入侵 M2 · 三族入侵者与各自 T5 旗舰（2026-09-24 · 进行中） | 进行中（进行中 —— 逐族落地） | 2026-09-24 | 4 KB / 55 行 | 0 / 0 |
...
| `docs/design/weekend-invasion.md` | 周末入侵活动（设计定稿 · M1 已上线 · M2–M4 待开工） | 未标注（M1 机制骨架已上线） | — | 20 KB / 198 行 | 5 / 0 |
...
- `docs/design/weekend-invasion-m2-20260924.md`（2026-09-24 · 4 KB）—— 周末入侵 M2 · 三族入侵者与各自 T5 旗舰（2026-09-24 · 进行中）
