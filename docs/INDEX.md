...
- 文档总数 **328** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6164** KB · **42935** 行
- 状态分布：**未标注** 180 · **已确认/已实现** 111 · **进行中** 28 · **待裁定** 8 · **历史留档** 1
- 孤儿文档（0 引用）**45** 份 · 状态未标注 **180** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
|---|---|---|---|---|---|
| `AGENTS.md` | AGENTS.md — 大鲸鱼-深空放置 · 仓库级 AI 工作约定(开工必读) | 未标注 | — | 14 KB / 97 行 | 175 / 5 |
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 486 KB / 991 行 | 217 / 16 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 72 KB / 362 行 | 332 / 18 |
...
| `docs/design/announcement-draft-20260926-plug-shop.md` | 公告待审稿 · 章鱼人兑换（舰船插件图纸）（2026-09-26） | 待裁定（待船长审核） | 2026-09-26 | 3 KB / 38 行 | 0 / 0 |
...
| `docs/design/fit-layout-move-20260926.md` | 装配页两栏搬家：无人机舱 → 左栏 · 弹药档位 → 右栏最上方（2026-09-26 · 二号 · d2） | 待裁定（已实现 · 待船长验收） | 2026-09-26 | 4 KB / 57 行 | 0 / 0 |
...
| `docs/design/plug-exchange-invasion-standing-20260926.md` | 章鱼人兑换两改 ＋ 入侵结算/结束通讯写出声望（2026-09-26） | 待裁定（已实现 · 待船长验收） | 2026-09-26 | 5 KB / 70 行 | 0 / 0 |
...
| `docs/design/standing-thresholds-20260926.md` | 所有声望门槛改读「累计获得」那一本账（2026-09-26 · 二号 · d2） | 待裁定（已实现 · 待船长验收） | 2026-09-26 | 5 KB / 72 行 | 0 / 0 |
...
| `docs/archive/roadmap-2026-09-26.md` | 封存卷 · roadmap 批次条目 2026-09-26 | 未标注 | — | 68 KB / 48 行 | 1 / 0 |
...
- `docs/design/announcement-draft-20260926-plug-shop.md`（2026-09-26 · 3 KB）—— 公告待审稿 · 章鱼人兑换（舰船插件图纸）（2026-09-26）
- `docs/design/faction-codex-tab-20260926.md`（2026-09-26 · 6 KB）—— 工作文档 · 势力图鉴（手册独立图鉴页签）（2026-09-26 · 三号）
- `docs/design/fit-layout-move-20260926.md`（2026-09-26 · 4 KB）—— 装配页两栏搬家：无人机舱 → 左栏 · 弹药档位 → 右栏最上方（2026-09-26 · 二号 · d2）
...
- `docs/design/plug-exchange-invasion-standing-20260926.md`（2026-09-26 · 5 KB）—— 章鱼人兑换两改 ＋ 入侵结算/结束通讯写出声望（2026-09-26）
- `docs/design/standing-thresholds-20260926.md`（2026-09-26 · 5 KB）—— 所有声望门槛改读「累计获得」那一本账（2026-09-26 · 二号 · d2）
