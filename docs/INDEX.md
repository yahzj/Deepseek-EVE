...
- 文档总数 **281** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5328** KB · **38778** 行
- 状态分布：**未标注** 150 · **已确认/已实现** 108 · **进行中** 16 · **待裁定** 6 · **历史留档** 1
- 孤儿文档（0 引用）**25** 份 · 状态未标注 **150** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
|---|---|---|---|---|---|
| `AGENTS.md` | AGENTS.md — 大鲸鱼-深空放置 · 仓库级 AI 工作约定(开工必读) | 未标注 | — | 13 KB / 93 行 | 156 / 5 |
| `docs/architecture.md` | 架构文档 | 未标注 | — | 22 KB / 223 行 | 31 / 1 |
| `docs/catalog.md` | 文档目录（指路 · 开工先读） | 未标注 | — | 5 KB / 57 行 | 22 / 3 |
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 372 KB / 833 行 | 192 / 9 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/announcement-draft-20260919-filters.md` | 公告待审稿：2026-09-19 筛选整理批（一条 · 待船长审核） | 未标注（❌ 船长 2026-09-19 决定） | 2026-09-19 | 3 KB / 36 行 | 1 / 0 |
| `docs/design/announcement-draft-20260919-matter-tech.md` | 公告待审稿：虫洞「谜质科技」研究树（一条 · 已按船长三条意见修订） | 未标注（✅ 船长 2026-09-19 批准） | 2026-09-19 | 4 KB / 41 行 | 0 / 1 |
...
| `docs/design/filters-audit-20260919.md` | 全仓筛选标签盘点（供船长审核与统一口径） · 2026-09-19 | 进行中（进行中） | 2026-09-19 | 34 KB / 357 行 | 0 / 0 |
...
| `docs/design/handoff-20260919-matter-tech-d2.md` | 谜质科技批 · 续接卡（二号 · d2 · 2026-09-19） | 未标注 | 2026-09-19 | 8 KB / 97 行 | 0 / 0 |
| `docs/design/l10n-en-20260919.md` | 英语本地化（可玩骨架）· 工作文档（2026-09-19） | 进行中（进行中） | 2026-09-19 | 8 KB / 101 行 | 3 / 2 |
| `docs/design/matter-tech-20260919.md` | 谜质科技树（2026-09-19 · 船长逐线裁定） | 进行中（进行中） | 2026-09-19 | 40 KB / 405 行 | 4 / 2 |
...
- `docs/design/filters-audit-20260919.md`（2026-09-19 · 34 KB）—— 全仓筛选标签盘点（供船长审核与统一口径） · 2026-09-19
...
- `docs/design/handoff-20260919-matter-tech-d2.md`（2026-09-19 · 8 KB）—— 谜质科技批 · 续接卡（二号 · d2 · 2026-09-19）
