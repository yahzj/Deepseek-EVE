...
- 文档总数 **282** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5411** KB · **39000** 行
- 状态分布：**未标注** 156 · **已确认/已实现** 109 · **进行中** 15 · **待裁定** 1 · **历史留档** 1
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 399 KB / 921 行 | 195 / 11 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 82 KB / 336 行 | 259 / 10 |
...
| `docs/archive/roadmap-2026-09-17.md` | 封存卷 · roadmap 批次条目 2026-09-17 | 未标注 | — | 26 KB / 47 行 | 2 / 0 |

## 二、其它（docs 根目录） —— 1 份

| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/glossary-en.md` | 英文术语与专名译名表（English Glossary & Naming Table） | 未标注（P0 已冻结） | — | 41 KB / 723 行 | 5 / 12 |
