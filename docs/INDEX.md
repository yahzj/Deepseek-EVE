...
- 文档总数 **319** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6013** KB · **42011** 行
- 状态分布：**未标注** 179 · **已确认/已实现** 111 · **进行中** 23 · **待裁定** 5 · **历史留档** 1
- 孤儿文档（0 引用）**39** 份 · 状态未标注 **179** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 105 KB / 316 行 | 323 / 17 |
...
| `docs/design/h-price-salvage-order-20260926.md` | H 三件市场价改判（甲）＋ 打捞三级序口径同步（2026-09-26） | 进行中（进行中 —— 已落码、四道闸门全绿） | 2026-09-26 | 5 KB / 65 行 | 0 / 0 |
