...
- 文档总数 **332** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6070** KB · **44166** 行
- 状态分布：**未标注** 173 · **已确认/已实现** 111 · **进行中** 39 · **待裁定** 8 · **历史留档** 1
- 孤儿文档（0 引用）**54** 份 · 状态未标注 **173** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 95 KB / 318 行 | 302 / 17 |
...
| `docs/design/weekend-flagship-prep-20260925.md` | 旗舰战入口 ＋ 战前准备界面（选船） | 进行中（进行中） | 2026-09-25 | 84 KB / 659 行 | 1 / 0 |
