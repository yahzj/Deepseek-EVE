...
- 文档总数 **271** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5187** KB · **36750** 行
- 状态分布：**未标注** 145 · **已确认/已实现** 108 · **待裁定** 9 · **进行中** 8 · **历史留档** 1
- 孤儿文档（0 引用）**22** 份 · 状态未标注 **145** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 371 KB / 831 行 | 189 / 8 |
