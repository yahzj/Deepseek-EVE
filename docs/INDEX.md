...
- 文档总数 **273** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5223** KB · **37144** 行
- 状态分布：**未标注** 146 · **已确认/已实现** 108 · **进行中** 10 · **待裁定** 8 · **历史留档** 1
...
|---|---|---|---|---|---|
| `AGENTS.md` | AGENTS.md — 大鲸鱼-深空放置 · 仓库级 AI 工作约定(开工必读) | 未标注 | — | 13 KB / 93 行 | 155 / 5 |
...
| `docs/development-conventions-changelog.md` | 开发约定 · 变更记录（development-conventions.md 的历次变更） | 未标注 | — | 157 KB / 217 行 | 13 / 1 |
...
| `docs/design/l10n-en-20260919.md` | 英语本地化（可玩骨架）· 工作文档（2026-09-19） | 进行中（进行中） | 2026-09-19 | 4 KB / 58 行 | 3 / 0 |
