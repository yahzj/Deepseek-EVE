...
- 文档总数 **330** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6061** KB · **43937** 行
- 状态分布：**未标注** 172 · **已确认/已实现** 111 · **进行中** 38 · **待裁定** 8 · **历史留档** 1
- 孤儿文档（0 引用）**53** 份 · 状态未标注 **172** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
- 三、现行设计稿（design）：**216** 份
...
| `docs/design/weekend-flagship-prep-20260925.md` | 旗舰战入口 ＋ 战前准备界面（选船） | 进行中（进行中） | 2026-09-25 | 89 KB / 704 行 | 1 / 0 |
