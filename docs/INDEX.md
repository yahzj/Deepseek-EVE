...
- 文档总数 **338** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6213** KB · **43930** 行
- 状态分布：**未标注** 181 · **已确认/已实现** 112 · **进行中** 31 · **待裁定** 13 · **历史留档** 1
- 孤儿文档（0 引用）**51** 份 · 状态未标注 **181** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
|---|---|---|---|---|---|
| `AGENTS.md` | AGENTS.md — 大鲸鱼-深空放置 · 仓库级 AI 工作约定(开工必读) | 未标注 | — | 14 KB / 97 行 | 174 / 5 |
...
| `docs/design/battle-ui-opt-20260926.md` | 战斗画面 UI 优化方案（桌面 ＋ 手机）· 2026-09-26 | 待裁定（第一档 ＋ 第二档已落地 · 待船长） | 2026-09-26 | 12 KB / 132 行 | 0 / 4 |
...
| `docs/design/handbook-polish-20260926.md` | 手册优化批（势力染色 ＋ 一次全册优化）· 2026-09-26 | 待裁定（待船长验收） | 2026-09-26 | 17 KB / 172 行 | 0 / 0 |
...
| `docs/design/ink-drone-copy-fix-20260926.md` | 报障修复：墨潮重袭无人机「描述与属性对应不上」（2026-09-26） | 待裁定（已修复 · 待船长验收） | 2026-09-26 | 3 KB / 50 行 | 0 / 0 |
| `docs/design/new-battleships-20260926.md` | 两艘新官方战列舰：虎鲸级指挥舰 · 旋齿鲨级装甲战列舰（2026-09-26） | 待裁定（已实现 · 待船长验收） | 2026-09-26 | 7 KB / 93 行 | 0 / 0 |
| `docs/design/player-web-range-20260926.md` | 我方捕获网：射程 3800 米 · 断开 4500 米（敌我通用）· 减速 50%（2026-09-26） | 已确认/已实现（已实现） | 2026-09-26 | 8 KB / 91 行 | 0 / 0 |
...
| `docs/design/wormhole-exclusive-20260913.md` | 终局玩法「虫洞」· 掉落物设计（虫洞专属装备 / 舰船 / 一次性图纸）· 设计稿 | 未标注（设计稿 · 船长逐条裁定已并入 §0） | 2026-09-13 | 74 KB / 793 行 | 15 / 5 |
...
- `docs/design/handbook-polish-20260926.md`（2026-09-26 · 17 KB）—— 手册优化批（势力染色 ＋ 一次全册优化）· 2026-09-26
...
- `docs/design/ink-drone-copy-fix-20260926.md`（2026-09-26 · 3 KB）—— 报障修复：墨潮重袭无人机「描述与属性对应不上」（2026-09-26）
- `docs/design/new-battleships-20260926.md`（2026-09-26 · 7 KB）—— 两艘新官方战列舰：虎鲸级指挥舰 · 旋齿鲨级装甲战列舰（2026-09-26）
- `docs/design/player-web-range-20260926.md`（2026-09-26 · 8 KB）—— 我方捕获网：射程 3800 米 · 断开 4500 米（敌我通用）· 减速 50%（2026-09-26）
