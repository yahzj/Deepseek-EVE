...
- 文档总数 **270** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5030** KB · **36725** 行
- 状态分布：**未标注** 141 · **已确认/已实现** 106 · **进行中** 17 · **待裁定** 5 · **历史留档** 1
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 320 KB / 764 行 | 195 / 8 |
