...
- 文档总数 **313** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5836** KB · **41755** 行
- 状态分布：**未标注** 171 · **已确认/已实现** 111 · **进行中** 27 · **待裁定** 3 · **历史留档** 1
- 孤儿文档（0 引用）**40** 份 · 状态未标注 **171** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
|---|---|---|---|---|---|
| `AGENTS.md` | AGENTS.md — 大鲸鱼-深空放置 · 仓库级 AI 工作约定(开工必读) | 未标注 | — | 14 KB / 97 行 | 166 / 5 |
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 461 KB / 983 行 | 209 / 16 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 85 KB / 321 行 | 299 / 17 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/starmap-scan-curve-20260925.md` | 星图扫描时长改幂次曲线（2026-09-25） | 进行中（进行中 —— 改动已落码） | 2026-09-25 | 6 KB / 92 行 | 0 / 0 |
| `docs/design/copy-jargon-20260924.md` | 工作文档 · 玩家可见文案里的「开发字眼」清理（2026-09-24 · 三号） | 未标注（两批全部落码并过闸门） | 2026-09-24 | 8 KB / 67 行 | 3 / 0 |
| `docs/design/faction-rare-drop-readout-20260924.md` | 派系活跃掉落率读数：从"写死裸常量"收口到"随档位现算"（2026-09-24） | 进行中（进行中 —— 改动已落码） | 2026-09-24 | 5 KB / 84 行 | 0 / 0 |
...
| `docs/design/weekend-invasion.md` | 周末入侵活动（设计定稿 · M1 已上线 · M2–M4 待开工） | 未标注（M1 机制骨架已上线） | — | 20 KB / 198 行 | 5 / 1 |
...
| `docs/archive/README.md` | 封存区（docs/archive/）—— 冻结的历史件 | 未标注 | — | 2 KB / 30 行 | 54 / 10 |
...
| `docs/archive/roadmap-2026-09-22.md` | 封存卷 · roadmap 批次条目 2026-09-22 | 未标注 | — | 27 KB / 75 行 | 1 / 0 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/test-saves/README.md` | 测试门槛存档（Test Saves） | 未标注 | — | 58 KB / 583 行 | 54 / 10 |
...
| `docs/design/ship-battle-art/README.md` | 舰船战斗图形重设计(三号 · 样稿阶段,2026-09-09) | 未标注 | — | 8 KB / 87 行 | 54 / 10 |
...
- `docs/design/starmap-scan-curve-20260925.md`（2026-09-25 · 6 KB）—— 星图扫描时长改幂次曲线（2026-09-25）
- `docs/design/faction-rare-drop-readout-20260924.md`（2026-09-24 · 5 KB）—— 派系活跃掉落率读数：从"写死裸常量"收口到"随档位现算"（2026-09-24）
