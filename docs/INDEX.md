...
- 文档总数 **301** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5592** KB · **40802** 行
- 状态分布：**未标注** 157 · **已确认/已实现** 109 · **进行中** 33 · **待裁定** 1 · **历史留档** 1
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 418 KB / 932 行 | 216 / 12 |
...
| `docs/design/task-center-nav-badge-20260920.md` | 导航「任务中心」的「第一次」推进提醒（2026-09-20） | 进行中（进行中） | 2026-09-20 | 5 KB / 72 行 | 0 / 0 |
| `docs/design/task-center-seq-milestone-20260920.md` | 任务中心：「第一次」顺序解锁 ＋ 新子页「里程碑任务」（2026-09-20） | 进行中（进行中） | 2026-09-20 | 8 KB / 97 行 | 0 / 0 |
...
- `docs/design/task-center-nav-badge-20260920.md`（2026-09-20 · 5 KB）—— 导航「任务中心」的「第一次」推进提醒（2026-09-20）
- `docs/design/task-center-seq-milestone-20260920.md`（2026-09-20 · 8 KB）—— 任务中心：「第一次」顺序解锁 ＋ 新子页「里程碑任务」（2026-09-20）
