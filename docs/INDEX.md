...
- 文档总数 **282** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5360** KB · **39102** 行
- 状态分布：**未标注** 156 · **已确认/已实现** 108 · **进行中** 16 · **待裁定** 1 · **历史留档** 1
- 孤儿文档（0 引用）**22** 份 · 状态未标注 **156** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 80 KB / 276 行 | 253 / 10 |
...
| `docs/archive/README.md` | 封存区（docs/archive/）—— 冻结的历史件 | 未标注 | — | 2 KB / 30 行 | 55 / 9 |
...
| `docs/archive/roadmap-2026-09-17.md` | 封存卷 · roadmap 批次条目 2026-09-17 | 未标注 | — | 9 KB / 18 行 | 2 / 0 |

## 二、其它（docs 根目录） —— 1 份

| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/glossary-en.md` | 英文术语与专名译名表（English Glossary & Naming Table） | 未标注（P0 已冻结） | — | 39 KB / 696 行 | 5 / 12 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/test-saves/README.md` | 测试门槛存档（Test Saves） | 未标注 | — | 54 KB / 544 行 | 55 / 9 |
...
| `docs/design/ship-battle-art/README.md` | 舰船战斗图形重设计(三号 · 样稿阶段,2026-09-09) | 未标注 | — | 8 KB / 87 行 | 55 / 9 |
...
| `docs/design/archive/README.md` | 归档区说明（docs/design/archive/） | 未标注 | — | 14 KB / 159 行 | 55 / 9 |
