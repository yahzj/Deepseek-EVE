...
- 文档总数 **266** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5168** KB · **36469** 行
- 状态分布：**未标注** 145 · **已确认/已实现** 108 · **待裁定** 7 · **进行中** 5 · **历史留档** 1
- 孤儿文档（0 引用）**18** 份 · 状态未标注 **145** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 371 KB / 831 行 | 185 / 8 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 81 KB / 274 行 | 252 / 10 |
