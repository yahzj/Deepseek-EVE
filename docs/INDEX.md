...
- 文档总数 **308** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5778** KB · **41249** 行
- 状态分布：**未标注** 171 · **已确认/已实现** 110 · **进行中** 22 · **待裁定** 4 · **历史留档** 1
- 孤儿文档（0 引用）**33** 份 · 状态未标注 **171** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/development-conventions-changelog.md` | 开发约定 · 变更记录（development-conventions.md 的历次变更） | 未标注 | — | 203 KB / 248 行 | 13 / 1 |
