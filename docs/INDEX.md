...
- 文档总数 **287** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5555** KB · **39814** 行
- 状态分布：**未标注** 158 · **已确认/已实现** 109 · **进行中** 18 · **待裁定** 1 · **历史留档** 1
- 孤儿文档（0 引用）**26** 份 · 状态未标注 **158** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 432 KB / 942 行 | 198 / 13 |
