...
- 文档总数 **264** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5128** KB · **36407** 行
...
| `docs/design/first-tasks-rework-20260917.md` | 教程重做：「第一次」任务系列 ＋ 前置解锁（2026-09-17 · 船长） | 待裁定（实现完成 · 待船长验收） | 2026-09-17 | 21 KB / 196 行 | 1 / 0 |
