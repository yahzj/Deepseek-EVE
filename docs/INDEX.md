...
- 文档总数 **336** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6186** KB · **43632** 行
- 状态分布：**未标注** 181 · **已确认/已实现** 112 · **进行中** 30 · **待裁定** 12 · **历史留档** 1
- 孤儿文档（0 引用）**50** 份 · 状态未标注 **181** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/design/handbook-polish-20260926.md` | 手册优化批（势力染色 ＋ 一次全册优化）· 2026-09-26 | 待裁定（待船长验收） | 2026-09-26 | 9 KB / 93 行 | 0 / 0 |
...
- `docs/design/handbook-polish-20260926.md`（2026-09-26 · 9 KB）—— 手册优化批（势力染色 ＋ 一次全册优化）· 2026-09-26
