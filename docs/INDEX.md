...
- 文档总数 **264** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5126** KB · **36395** 行
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/review/first-tasks-review-20260917.md` | 核验件：「第一次」任务系列全表（2026-09-18 版 · 供船长逐条审核） | 未标注 | 2026-09-17 | 12 KB / 148 行 | 1 / 0 |
...
| `docs/design/first-tasks-rework-20260917.md` | 教程重做：「第一次」任务系列 ＋ 前置解锁（2026-09-17 · 船长） | 待裁定（实现完成 · 待船长验收） | 2026-09-17 | 19 KB / 184 行 | 1 / 0 |
