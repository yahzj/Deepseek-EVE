...
- 文档总数 **320** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5905** KB · **42413** 行
- 状态分布：**未标注** 171 · **已确认/已实现** 111 · **进行中** 34 · **待裁定** 3 · **历史留档** 1
- 孤儿文档（0 引用）**47** 份 · 状态未标注 **171** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 464 KB / 985 行 | 213 / 16 |
...
| `docs/design/weekend-flagship-prep-20260925.md` | 旗舰战入口 ＋ 战前准备界面（选船） | 进行中（进行中） | 2026-09-25 | 12 KB / 106 行 | 0 / 0 |
...
- `docs/design/weekend-flagship-prep-20260925.md`（2026-09-25 · 12 KB）—— 旗舰战入口 ＋ 战前准备界面（选船）
