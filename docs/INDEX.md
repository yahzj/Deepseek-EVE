...
- 文档总数 **298** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5665** KB · **40703** 行
- 状态分布：**未标注** 165 · **已确认/已实现** 110 · **进行中** 18 · **待裁定** 4 · **历史留档** 1
- 孤儿文档（0 引用）**28** 份 · 状态未标注 **165** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 438 KB / 945 行 | 200 / 13 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 98 KB / 415 行 | 281 / 14 |
