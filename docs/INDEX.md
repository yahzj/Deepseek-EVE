...
- 文档总数 **265** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5159** KB · **36395** 行
...
| `docs/design/side-task-v2-20260918.md` | 时效任务板改版：级别 / 更多席位 / 虚拟货物快递 / 限时快递 / 接单（2026-09-18 船长令） | 待裁定（已实现 · 待船长实机验收） | 2026-09-18 | 7 KB / 73 行 | 0 / 0 |
