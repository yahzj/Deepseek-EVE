...
- 文档总数 **298** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5540** KB · **40371** 行
...
| `docs/design/player-bugs-wh-fight-click-ach-20260920.md` | 玩家报障三件：遗迹收尾战 · 虫洞地图点不动 · 已建成的空间站拿不到成就（2026-09-20） | 进行中（进行中） | 2026-09-20 | 8 KB / 103 行 | 0 / 0 |
...
- `docs/design/player-bugs-wh-fight-click-ach-20260920.md`（2026-09-20 · 8 KB）—— 玩家报障三件：遗迹收尾战 · 虫洞地图点不动 · 已建成的空间站拿不到成就（2026-09-20）
