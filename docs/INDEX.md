...
- 文档总数 **261** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5129** KB · **36198** 行
- 状态分布：**未标注** 145 · **已确认/已实现** 107 · **待裁定** 7 · **进行中** 1 · **历史留档** 1
- 孤儿文档（0 引用）**12** 份 · 状态未标注 **145** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 363 KB / 812 行 | 182 / 8 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 81 KB / 261 行 | 248 / 10 |
...
| `docs/design/fit-presets-20260914.md` | 装配方案（预设）：保存当前装配 / 套用预设（2026-09-14） | 未标注 | 2026-09-14 | 9 KB / 112 行 | 6 / 0 |
...
| `docs/archive/roadmap-2026-09-16.md` | 封存卷 · roadmap 批次条目 2026-09-16 | 未标注 | — | 90 KB / 77 行 | 1 / 0 |
