...
- 文档总数 **308** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5787** KB · **41148** 行
- 状态分布：**未标注** 170 · **已确认/已实现** 111 · **进行中** 23 · **待裁定** 3 · **历史留档** 1
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 461 KB / 983 行 | 207 / 16 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 85 KB / 321 行 | 295 / 17 |
