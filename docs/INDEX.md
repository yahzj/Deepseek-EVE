...
- 文档总数 **321** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6030** KB · **42253** 行
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 105 KB / 316 行 | 327 / 17 |
...
| `docs/design/handbook-bp-filter-dupe-20260926.md` | 工作文档 · 手册蓝图图鉴筛选不消失（BP_MAIN 重复键）（2026-09-26 · 三号） | 进行中（进行中 —— 根因已实锤、已落码、闸） | 2026-09-26 | 6 KB / 92 行 | 0 / 0 |
| `docs/design/handoff-20260926-to-pilot2.md` | 交接卡：新二号（2026-09-26 · 旧二号交班） | 未标注（交接中） | 2026-09-26 | 11 KB / 106 行 | 0 / 0 |
| `docs/design/l10n-leak-sweep-20260926.md` | 工作文档 · 本地化遗漏扫批（舰船类型 / 高中低槽位文本等）（2026-09-26 · 三号） | 进行中（进行中 —— 甲批已落码、闸门待跑） | 2026-09-26 | 8 KB / 103 行 | 0 / 1 |
...
| `docs/archive/roadmap-2026-09-26.md` | 封存卷 · roadmap 批次条目 2026-09-26 | 未标注 | — | 37 KB / 30 行 | 1 / 0 |
...
- `docs/design/handbook-bp-filter-dupe-20260926.md`（2026-09-26 · 6 KB）—— 工作文档 · 手册蓝图图鉴筛选不消失（BP_MAIN 重复键）（2026-09-26 · 三号）
