...
- 文档总数 **274** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5228** KB · **37782** 行
- 状态分布：**未标注** 147 · **已确认/已实现** 108 · **进行中** 12 · **待裁定** 6 · **历史留档** 1
- 孤儿文档（0 引用）**20** 份 · 状态未标注 **147** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/design/wormhole-box-tier-nebula-20260919.md` | 图纸货柜按层分档 + 星云占比随层递增（2026-09-19） | 进行中（进行中） | 2026-09-19 | 4 KB / 67 行 | 0 / 0 |
...
- `docs/design/wormhole-box-tier-nebula-20260919.md`（2026-09-19 · 4 KB）—— 图纸货柜按层分档 + 星云占比随层递增（2026-09-19）
