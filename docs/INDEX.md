...
- 文档总数 **266** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5151** KB · **36651** 行
- 状态分布：**未标注** 145 · **已确认/已实现** 107 · **待裁定** 7 · **进行中** 6 · **历史留档** 1
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/ew-range-debuff-20260918.md` | 电子舰新特性（压制敌舰射程 15%）＋ 鹦鹉螺槽位 3/4/4（船长 2026-09-18）· 工作文档 | 进行中（进行中） | 2026-09-18 | 8 KB / 89 行 | 0 / 0 |
...
- `docs/design/ew-range-debuff-20260918.md`（2026-09-18 · 8 KB）—— 电子舰新特性（压制敌舰射程 15%）＋ 鹦鹉螺槽位 3/4/4（船长 2026-09-18）· 工作文档
