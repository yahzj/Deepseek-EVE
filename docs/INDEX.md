...
- 文档总数 **283** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5370** KB · **39237** 行
- 状态分布：**未标注** 156 · **已确认/已实现** 108 · **进行中** 16 · **待裁定** 2 · **历史留档** 1
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 81 KB / 288 行 | 256 / 10 |
