...
- 文档总数 **260** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **4868** KB · **35754** 行
...
| `docs/design/hullrep-in-wormhole-20260916.md` | 报障核查：船体维修装置在虫洞里无效（2026-09-16） | 待裁定（待船长裁决） | 2026-09-16 | 5 KB / 59 行 | 0 / 0 |
...
- `docs/design/hullrep-in-wormhole-20260916.md`（2026-09-16 · 5 KB）—— 报障核查：船体维修装置在虫洞里无效（2026-09-16）
