...
- 文档总数 **321** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5919** KB · **42547** 行
...
| `docs/design/rare-supply-single-piece-20260925.md` | 稀有供给单「每次恒 1 件」（2026-09-25） | 进行中（进行中 —— 改动已落码） | 2026-09-25 | 4 KB / 61 行 | 0 / 0 |
...
| `docs/design/weekend-flagship-prep-20260925.md` | 旗舰战入口 ＋ 战前准备界面（选船） | 进行中（进行中） | 2026-09-25 | 22 KB / 179 行 | 0 / 0 |
...
- `docs/design/weekend-flagship-prep-20260925.md`（2026-09-25 · 22 KB）—— 旗舰战入口 ＋ 战前准备界面（选船）
