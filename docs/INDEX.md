...
- 文档总数 **329** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6034** KB · **43826** 行
- 状态分布：**未标注** 172 · **已确认/已实现** 111 · **进行中** 39 · **待裁定** 6 · **历史留档** 1
- 孤儿文档（0 引用）**52** 份 · 状态未标注 **172** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
|---|---|---|---|---|---|
| `AGENTS.md` | AGENTS.md — 大鲸鱼-深空放置 · 仓库级 AI 工作约定(开工必读) | 未标注 | — | 14 KB / 97 行 | 173 / 5 |
| `docs/architecture.md` | 架构文档 | 未标注 | — | 22 KB / 223 行 | 31 / 1 |
| `docs/catalog.md` | 文档目录（指路 · 开工先读） | 未标注 | — | 5 KB / 57 行 | 24 / 3 |
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 464 KB / 985 行 | 215 / 16 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 95 KB / 318 行 | 301 / 17 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/foe-ship-art-20260926.md` | 敌舰逐舰形象（30 条）· 工作文档 | 进行中（进行中） | 2026-09-26 | 15 KB / 222 行 | 1 / 1 |
...
| `docs/design/h-fleet-art-20260925.md` | H 族 · 墨潮帮（The Ink Tide）· 舰船形象设计契约（2026-09-25） | 未标注（已并入后续批次） | 2026-09-25 | 3 KB / 43 行 | 0 / 0 |
...
| `docs/design/weekend-flagship-prep-20260925.md` | 旗舰战入口 ＋ 战前准备界面（选船） | 进行中（进行中） | 2026-09-25 | 70 KB / 556 行 | 1 / 0 |
...
| `docs/design/market-bp-learn-filter-20260924.md` | 工作文档 · 市场「蓝图」二级筛选：加入「未学会」（2026-09-24 · 三号） | 进行中（进行中） | 2026-09-24 | 4 KB / 52 行 | 0 / 0 |
| `docs/design/mod-order-20260924.md` | 工作文档 · 装备库排序（按武器攻击类别 · rank 从低到高）（2026-09-24 · 三号） | 进行中（进行中） | 2026-09-24 | 4 KB / 58 行 | 0 / 0 |
| `docs/design/shield-field-cpu-20260924.md` | 护盾充能力场装置 MK2 / MK3 的 CPU 占用上调（2026-09-24） | 进行中（进行中 —— 改动已落码） | 2026-09-24 | 3 KB / 43 行 | 0 / 0 |
...
| `docs/design/system-scan-unattended-20260915.md` | 星系扫描无人化（扫描艇 · 不占主控 · 完成待查看）—— 2026-09-15 船长定案 | 已确认/已实现（已确认 · 已落码） | 2026-09-15 | 7 KB / 84 行 | 2 / 0 |
...
| `docs/design/skill-effects-audit-20260911.md` | 技能说明 ↔ 引擎效果核查（2026-09-11） | 已确认/已实现（已完成核查 + 护栏转正） | 2026-09-11 | 7 KB / 80 行 | 4 / 0 |
...
| `docs/design/t7-time-consistency.md` | T7 星图时间口径统一 + 换船中断移动（状态：已确认） | 已确认/已实现（已确认） | — | 4 KB / 50 行 | 5 / 0 |
...
| `docs/design/v13-exploration.md` | V13 设计：星图探索系统（迷雾 · 点亮 · 扫描探索） | 已确认/已实现（已确认） | — | 7 KB / 97 行 | 7 / 1 |
...
| `docs/design/weekend-invasion.md` | 周末入侵活动（设计定稿 · M1 已上线 · M2–M4 待开工） | 未标注（M1 机制骨架已上线） | — | 20 KB / 198 行 | 5 / 2 |
...
| `docs/archive/README.md` | 封存区（docs/archive/）—— 冻结的历史件 | 未标注 | — | 2 KB / 30 行 | 55 / 10 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/glossary-en.md` | 英文术语与专名译名表（English Glossary & Naming Table） | 未标注（P0 已冻结） | — | 43 KB / 764 行 | 10 / 14 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/test-saves/README.md` | 测试门槛存档（Test Saves） | 未标注 | — | 65 KB / 643 行 | 55 / 10 |
...
| `docs/design/ship-battle-art/README.md` | 舰船战斗图形重设计(三号 · 样稿阶段,2026-09-09) | 未标注 | — | 8 KB / 87 行 | 55 / 10 |
...
| `docs/design/archive/README.md` | 归档区说明（docs/design/archive/） | 未标注 | — | 14 KB / 159 行 | 55 / 10 |
...
- `docs/design/h-fleet-art-20260925.md`（2026-09-25 · 3 KB）—— H 族 · 墨潮帮（The Ink Tide）· 舰船形象设计契约（2026-09-25）
...
- `docs/design/market-bp-learn-filter-20260924.md`（2026-09-24 · 4 KB）—— 工作文档 · 市场「蓝图」二级筛选：加入「未学会」（2026-09-24 · 三号）
- `docs/design/mod-order-20260924.md`（2026-09-24 · 4 KB）—— 工作文档 · 装备库排序（按武器攻击类别 · rank 从低到高）（2026-09-24 · 三号）
- `docs/design/shield-field-cpu-20260924.md`（2026-09-24 · 3 KB）—— 护盾充能力场装置 MK2 / MK3 的 CPU 占用上调（2026-09-24）
...
## 附：状态未标注（172 份，待补一行 `状态：…`）

- `docs/design/h-fleet-art-20260925.md`（2026-09-25）—— H 族 · 墨潮帮（The Ink Tide）· 舰船形象设计契约（2026-09-25）
