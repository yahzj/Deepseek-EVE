...
- 文档总数 **264** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5167** KB · **36573** 行
- 状态分布：**未标注** 145 · **已确认/已实现** 108 · **待裁定** 7 · **进行中** 3 · **历史留档** 1
- 孤儿文档（0 引用）**14** 份 · 状态未标注 **145** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 363 KB / 812 行 | 184 / 8 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 81 KB / 261 行 | 250 / 10 |
...
| `docs/design/ew-range-debuff-20260918.md` | 电子舰新特性（压制敌舰射程 15%）＋ 鹦鹉螺槽位 3/4/4（船长 2026-09-18）· 工作文档 | 进行中（进行中） | 2026-09-18 | 9 KB / 110 行 | 0 / 0 |
...
| `docs/design/fit-presets-20260914.md` | 装配方案（预设）：保存当前装配 / 套用预设（2026-09-14） | 未标注 | 2026-09-14 | 9 KB / 112 行 | 7 / 0 |
...
- `docs/design/ew-range-debuff-20260918.md`（2026-09-18 · 9 KB）—— 电子舰新特性（压制敌舰射程 15%）＋ 鹦鹉螺槽位 3/4/4（船长 2026-09-18）· 工作文档
