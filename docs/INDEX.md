...
- 文档总数 **264** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **4925** KB · **36148** 行
- 状态分布：**未标注** 144 · **已确认/已实现** 106 · **进行中** 8 · **待裁定** 5 · **历史留档** 1
...
| `docs/design/copy-audit-20260916.md` | 装备与物品文案审查（出清单待裁）· 工作文档 | 进行中（进行中） | 2026-09-16 | 11 KB / 109 行 | 0 / 0 |
...
- `docs/design/copy-audit-20260916.md`（2026-09-16 · 11 KB）—— 装备与物品文案审查（出清单待裁）· 工作文档
