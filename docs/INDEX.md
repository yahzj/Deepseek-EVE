...
- 文档总数 **310** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5796** KB · **41290** 行
- 状态分布：**未标注** 170 · **已确认/已实现** 111 · **进行中** 25 · **待裁定** 3 · **历史留档** 1
- 孤儿文档（0 引用）**38** 份 · 状态未标注 **170** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/development-conventions.md` | 开发约定（Development Conventions） | 未标注 | — | 63 KB / 681 行 | 73 / 3 |
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 461 KB / 983 行 | 208 / 16 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 85 KB / 321 行 | 296 / 17 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/glossary-en.md` | 英文术语与专名译名表（English Glossary & Naming Table） | 未标注（P0 已冻结） | — | 43 KB / 764 行 | 7 / 14 |
