...
- 文档总数 **317** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5883** KB · **42194** 行
- 状态分布：**未标注** 172 · **已确认/已实现** 111 · **进行中** 30 · **待裁定** 3 · **历史留档** 1
- 孤儿文档（0 引用）**44** 份 · 状态未标注 **172** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
- 三、现行设计稿（design）：**203** 份
...
|---|---|---|---|---|---|
| `AGENTS.md` | AGENTS.md — 大鲸鱼-深空放置 · 仓库级 AI 工作约定(开工必读) | 未标注 | — | 14 KB / 97 行 | 167 / 5 |
