...
- 文档总数 **299** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5647** KB · **40789** 行
- 状态分布：**未标注** 165 · **已确认/已实现** 111 · **进行中** 17 · **待裁定** 5 · **历史留档** 1
...
| `docs/design/new-skills-20260922.md` | 新增六条技能（精炼 T4 / 制造 T5 / 舰种操作 T4·T5）· 2026-09-22 | 进行中（进行中 · 除技能树排布体检外全闸门） | 2026-09-22 | 7 KB / 99 行 | 0 / 0 |
...
- `docs/design/new-skills-20260922.md`（2026-09-22 · 7 KB）—— 新增六条技能（精炼 T4 / 制造 T5 / 舰种操作 T4·T5）· 2026-09-22
