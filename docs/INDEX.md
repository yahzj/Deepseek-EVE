...
- 文档总数 **263** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5151** KB · **36447** 行
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 362 KB / 813 行 | 180 / 8 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 94 KB / 267 行 | 247 / 10 |
...
| `docs/design/fit-presets-20260914.md` | 装配方案（预设）：保存当前装配 / 套用预设（2026-09-14） | 未标注 | 2026-09-14 | 9 KB / 116 行 | 5 / 0 |
