...
- 文档总数 **303** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5697** KB · **40757** 行
- 状态分布：**未标注** 166 · **已确认/已实现** 112 · **进行中** 20 · **待裁定** 4 · **历史留档** 1
...
| `docs/design/shield-charger-halved-20260923.md` | 护盾充能装置：冷却与效果值减半 · 2026-09-23 | 已确认/已实现（已完成） | 2026-09-23 | 2 KB / 34 行 | 0 / 0 |
| `docs/design/skills-merge-20260923.md` | 技能页合并（旧目录 → 科技树页）· 2026-09-23 | 未标注（已落码） | 2026-09-23 | 8 KB / 78 行 | 0 / 0 |
| `docs/design/weekend-invasion-20260923.md` | 周末入侵活动（设计定稿 · 挂起待开工）· 2026-09-23 | 待裁定（挂起 · 待船长裁决 7 条） | 2026-09-23 | 13 KB / 137 行 | 0 / 0 |
| `docs/design/wh-spawn-layer7-20260923.md` | 虫洞：强度增幅上调 ＋ 第 7 层起「逐回合刷怪」（2026-09-23） | 进行中（进行中 —— ①数值回调已确认并落码） | 2026-09-23 | 5 KB / 63 行 | 0 / 0 |
| `docs/design/wormhole-loot-box-20260923.md` | 虫洞敌人掉落货柜概率提到 5% · 2026-09-23 | 已确认/已实现（已完成） | 2026-09-23 | 2 KB / 29 行 | 0 / 0 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/glossary-en.md` | 英文术语与专名译名表（English Glossary & Naming Table） | 未标注（P0 已冻结） | — | 43 KB / 764 行 | 7 / 13 |
...
- `docs/design/shield-charger-halved-20260923.md`（2026-09-23 · 2 KB）—— 护盾充能装置：冷却与效果值减半 · 2026-09-23
- `docs/design/skills-merge-20260923.md`（2026-09-23 · 8 KB）—— 技能页合并（旧目录 → 科技树页）· 2026-09-23
- `docs/design/weekend-invasion-20260923.md`（2026-09-23 · 13 KB）—— 周末入侵活动（设计定稿 · 挂起待开工）· 2026-09-23
- `docs/design/wh-spawn-layer7-20260923.md`（2026-09-23 · 5 KB）—— 虫洞：强度增幅上调 ＋ 第 7 层起「逐回合刷怪」（2026-09-23）
- `docs/design/wormhole-loot-box-20260923.md`（2026-09-23 · 2 KB）—— 虫洞敌人掉落货柜概率提到 5% · 2026-09-23
