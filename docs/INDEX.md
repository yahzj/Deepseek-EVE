...
- 文档总数 **305** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5649** KB · **41523** 行
- 状态分布：**未标注** 157 · **已确认/已实现** 109 · **进行中** 37 · **待裁定** 1 · **历史留档** 1
- 孤儿文档（0 引用）**31** 份 · 状态未标注 **157** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 418 KB / 932 行 | 219 / 12 |
...
| `docs/design/find-humans-gate-20260920.md` | 「寻找人类」发布闸门：全部「第一次」完成后才出现（2026-09-20） | 进行中（进行中） | 2026-09-20 | 6 KB / 85 行 | 2 / 0 |
| `docs/design/first-task-flow-inventory-20260920.md` | 「第一次」13 步全清点：会发生什么 · 通讯 · 任务文本（2026-09-20） | 进行中（进行中） | 2026-09-20 | 23 KB / 242 行 | 1 / 0 |
...
| `docs/design/first-task-swap-and-tail-batch-20260920.md` | 「第一次」队列：悬赏↔打捞对调 · 末段并列批 · 三条奖励填充（2026-09-20 第三道令） | 进行中（进行中） | 2026-09-20 | 11 KB / 141 行 | 1 / 0 |
...
| `docs/design/task-center-seq-milestone-20260920.md` | 任务中心：「第一次」顺序解锁 ＋ 新子页「里程碑任务」（2026-09-20） | 进行中（进行中） | 2026-09-20 | 8 KB / 97 行 | 4 / 0 |
