...
- 文档总数 **325** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6152** KB · **42892** 行
- 状态分布：**未标注** 182 · **已确认/已实现** 111 · **进行中** 26 · **待裁定** 5 · **历史留档** 1
- 孤儿文档（0 引用）**42** 份 · 状态未标注 **182** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 82 KB / 343 行 | 333 / 18 |
...
| `docs/archive/roadmap-2026-09-26.md` | 封存卷 · roadmap 批次条目 2026-09-26 | 未标注 | — | 44 KB / 36 行 | 1 / 0 |
