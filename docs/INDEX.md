...
- 文档总数 **332** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6138** KB · **43219** 行
...
| `docs/design/player-web-range-20260926.md` | 我方捕获网：距离上限 4000 米 ＋ 减速降为 50%（2026-09-26） | 已确认/已实现（已实现） | 2026-09-26 | 5 KB / 69 行 | 0 / 0 |
