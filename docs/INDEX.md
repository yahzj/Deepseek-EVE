...
- 文档总数 **306** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5732** KB · **40995** 行
- 状态分布：**未标注** 170 · **已确认/已实现** 110 · **进行中** 21 · **待裁定** 4 · **历史留档** 1
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/foe-mounts-20260924.md` | 敌方挂载件：A 族「姿态陀螺仪」＋ G 族「船体修理装置」（2026-09-24） | 待裁定（已落码 · 四闸门全绿 · 待船长验） | 2026-09-24 | 12 KB / 125 行 | 0 / 3 |
| `docs/design/one-time-blueprint-loss-20260924.md` | 一次性图纸"在造时被吞"（2026-09-24 玩家报障 · 船长转述） | 未标注（已修并合入 main） | 2026-09-24 | 6 KB / 72 行 | 0 / 0 |
| `docs/design/ships-workbench-20260924.md` | 船长工作台回写：我方 8 艘虫洞舰船属性 ＋ 鱼雷舰豁免裁决（2026-09-24） | 进行中（进行中 —— 改动已落码） | 2026-09-24 | 5 KB / 62 行 | 0 / 0 |
| `docs/design/side-tasks-courier-and-damage-popup-20260924.md` | 任务板：快递任务周期（2026-09-24）＋ 战斗伤害飘字（已落码 · 待验收） | 未标注（已落码、四闸门全绿、已推送） | 2026-09-24 | 6 KB / 76 行 | 0 / 0 |
...
- `docs/design/one-time-blueprint-loss-20260924.md`（2026-09-24 · 6 KB）—— 一次性图纸"在造时被吞"（2026-09-24 玩家报障 · 船长转述）
- `docs/design/ships-workbench-20260924.md`（2026-09-24 · 5 KB）—— 船长工作台回写：我方 8 艘虫洞舰船属性 ＋ 鱼雷舰豁免裁决（2026-09-24）
- `docs/design/side-tasks-courier-and-damage-popup-20260924.md`（2026-09-24 · 6 KB）—— 任务板：快递任务周期（2026-09-24）＋ 战斗伤害飘字（已落码 · 待验收）
...
- `docs/design/one-time-blueprint-loss-20260924.md`（2026-09-24）—— 一次性图纸"在造时被吞"（2026-09-24 玩家报障 · 船长转述）
