...
- 文档总数 **332** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6071** KB · **44062** 行
- 状态分布：**未标注** 173 · **已确认/已实现** 111 · **进行中** 38 · **待裁定** 9 · **历史留档** 1
- 孤儿文档（0 引用）**55** 份 · 状态未标注 **173** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/design/announcement-draft-20260925-weekend-invasion.md` | 公告待审稿 · 周末星域入侵（新玩法）（2026-09-25） | 未标注（船长手改稿） | 2026-09-25 | 6 KB / 72 行 | 0 / 0 |
...
- `docs/design/announcement-draft-20260925-weekend-invasion.md`（2026-09-25 · 6 KB）—— 公告待审稿 · 周末星域入侵（新玩法）（2026-09-25）
