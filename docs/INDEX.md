...
- 文档总数 **292** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5609** KB · **40318** 行
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 101 KB / 420 行 | 274 / 14 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/archived-window-embed-20260922.md` | 归档备用：窗口化 / 嵌入主区 这一整套界面改动（2026-09-22） | 未标注（已封存 · 备用） | 2026-09-22 | 9 KB / 101 行 | 1 / 6 |
