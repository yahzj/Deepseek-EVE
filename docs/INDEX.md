...
- 文档总数 **301** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5672** KB · **40974** 行
- 状态分布：**未标注** 165 · **已确认/已实现** 111 · **进行中** 20 · **待裁定** 4 · **历史留档** 1
- 孤儿文档（0 引用）**31** 份 · 状态未标注 **165** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 434 KB / 944 行 | 199 / 13 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 110 KB / 440 行 | 279 / 14 |
...
| `docs/design/ui-theme-20260922.md` | 界面配色（皮肤切换）：深空 / 亮白 / 高对比（2026-09-22） | 进行中（进行中） | 2026-09-22 | 17 KB / 166 行 | 0 / 1 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/glossary-en.md` | 英文术语与专名译名表（English Glossary & Naming Table） | 未标注（P0 已冻结） | — | 43 KB / 758 行 | 8 / 13 |
