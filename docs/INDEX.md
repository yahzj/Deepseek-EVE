...
- 文档总数 **304** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5635** KB · **41361** 行
- 状态分布：**未标注** 157 · **已确认/已实现** 109 · **进行中** 36 · **待裁定** 1 · **历史留档** 1
- 孤儿文档（0 引用）**33** 份 · 状态未标注 **157** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 418 KB / 932 行 | 217 / 12 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 112 KB / 419 行 | 260 / 10 |

## 七、评审与体检（review） —— 10 份

| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/review/first-tasks-review-20260917.md` | 核验件：「第一次」任务系列全表（2026-09-18 版 · 供船长逐条审核） | 未标注 | 2026-09-17 | 12 KB / 148 行 | 2 / 0 |
...
| `docs/design/chain-time-ratio-plan-20260920.md` | 方案：链上耗时比 4 : 2 : 1（原矿→原材料→零件→高级零件）· 2026-09-20 | 未标注（方案） | 2026-09-20 | 8 KB / 113 行 | 2 / 0 |
| `docs/design/courier-home-origin-20260920.md` | 快递任务：出发地钉成母港（不在母港则自动返航）· 2026-09-20 | 进行中（进行中） | 2026-09-20 | 5 KB / 68 行 | 0 / 0 |
| `docs/design/find-humans-gate-20260920.md` | 「寻找人类」发布闸门：全部「第一次」完成后才出现（2026-09-20） | 进行中（进行中） | 2026-09-20 | 6 KB / 85 行 | 0 / 0 |
| `docs/design/first-task-flow-inventory-20260920.md` | 「第一次」13 步全清点：会发生什么 · 通讯 · 任务文本（2026-09-20） | 进行中（进行中） | 2026-09-20 | 20 KB / 221 行 | 0 / 0 |
| `docs/design/first-task-order-gate-20260920.md` | 「第一次」队列：未显示的任务不许提前完成（判定与显示同一把尺）· 2026-09-20 | 进行中（进行中） | 2026-09-20 | 8 KB / 108 行 | 0 / 0 |
| `docs/design/first-task-reward-move-20260920.md` | 「第一次」任务奖励前移：采集器 ⇒ 扫描 · 打捞器 ⇒ 挖矿（2026-09-20） | 进行中（进行中） | 2026-09-20 | 6 KB / 80 行 | 0 / 1 |
| `docs/design/foe-a-minrange-20260920.md` | A 族全族贴脸：除劫掠狙击舰外，最小射程改为 1（2026-09-20） | 进行中（进行中） | 2026-09-20 | 7 KB / 108 行 | 0 / 0 |
| `docs/design/friend-audit-20260920.md` | 外部审查报告逐条核对与处置（朋友发来的 project_bug_analysis_report.md · 2026-09-20） | 进行中（进行中） | 2026-09-20 | 19 KB / 218 行 | 0 / 1 |
| `docs/design/handoff-20260920-to-new-pilot1.md` | 交接文档 · 大鲸鱼深空工业 · 2026-09-20 早（一号 → 下一任一号） | 未标注 | 2026-09-20 | 17 KB / 148 行 | 3 / 0 |
| `docs/design/haul-interrupt-warning-20260920.md` | 「第一次采集原矿」换船引导 ＋ 100 橄榄岩补偿 ＋ 长途运输中断警告（2026-09-20） | 进行中（进行中） | 2026-09-20 | 6 KB / 80 行 | 0 / 0 |
| `docs/design/main-activity-win-20260920.md` | 主控活动窗口 ＋ 战斗窗口非全屏化（2026-09-20） | 进行中（进行中） | 2026-09-20 | 15 KB / 226 行 | 0 / 1 |
| `docs/design/matter-tech-t4-ai-20260920.md` | 谜质科技 · 洞外工业新增 T4「工业多核调度」（工业 AI 工位上限 +1/级 · 5 级）· 2026-09-20 | 进行中（进行中） | 2026-09-20 | 5 KB / 61 行 | 0 / 0 |
| `docs/design/part-card-batch-20260920.md` | 零件卡产物行补"每批 10 件" ＋ 精炼增幅基线读数（2026-09-20） | 进行中（进行中） | 2026-09-20 | 6 KB / 74 行 | 0 / 0 |
| `docs/design/part-time-adv-20260920.md` | 高级零件工时 ×0.25（缩短至 25%）· 2026-09-20 | 进行中（进行中） | 2026-09-20 | 3 KB / 59 行 | 0 / 1 |
| `docs/design/part-time-basic-20260920.md` | 基础零件工时 ×0.5（缩短至 50%）· 2026-09-20 | 进行中（进行中） | 2026-09-20 | 3 KB / 52 行 | 1 / 1 |
| `docs/design/player-bugs-wh-fight-click-ach-20260920.md` | 玩家报障三件：遗迹收尾战 · 虫洞地图点不动 · 已建成的空间站拿不到成就（2026-09-20） | 进行中（进行中） | 2026-09-20 | 11 KB / 137 行 | 0 / 0 |
| `docs/design/salvage-hint-and-industry-gate-20260920.md` | 打捞门槛提示（＋去装配入口）与工业页解锁改挂「第一次操作精炼炉」（2026-09-20） | 进行中（进行中） | 2026-09-20 | 7 KB / 83 行 | 0 / 0 |
| `docs/design/task-center-nav-badge-20260920.md` | 导航「任务中心」的「第一次」推进提醒（2026-09-20） | 进行中（进行中） | 2026-09-20 | 5 KB / 76 行 | 1 / 0 |
| `docs/design/task-center-seq-milestone-20260920.md` | 任务中心：「第一次」顺序解锁 ＋ 新子页「里程碑任务」（2026-09-20） | 进行中（进行中） | 2026-09-20 | 8 KB / 97 行 | 2 / 0 |
| `docs/design/thruster-stacking-additive-20260920.md` | 推进器多件：由「EVE 曲线乘算」改为「折权加算」（2026-09-20） | 进行中（进行中） | 2026-09-20 | 4 KB / 68 行 | 0 / 0 |
| `docs/design/wh-beacon-rate-20260920.md` | 虫洞信标：出现率 50% + 每层保底 1 个（2026-09-20） | 进行中（进行中） | 2026-09-20 | 4 KB / 58 行 | 0 / 0 |
| `docs/design/wh-grid-deep-save-20260920.md` | 深层盘读档被丢 —— 结案「深入下一层后，显示本层没有网格」（2026-09-20） | 进行中（进行中） | 2026-09-20 | 4 KB / 63 行 | 1 / 0 |
| `docs/design/wh-grid-ladder-2-20260920.md` | 盘面阶梯回退（每 2 层 +1 环、不封顶）＋ 虫洞地图可拖动（2026-09-20 二批） | 进行中（进行中） | 2026-09-20 | 9 KB / 122 行 | 0 / 1 |
...
| `docs/design/foe-faction-a-numbers-20260911.md` | A 族数值落地方案（2026-09-11 · 已确认） | 未标注 | 2026-09-11 | 58 KB / 683 行 | 23 / 2 |
...
| `docs/design/npc-factions-20260911.md` | NPC 势力档案（协会侧）· 设定与口径（2026-09-11 船长定） | 已确认/已实现（已确认） | 2026-09-11 | 8 KB / 93 行 | 7 / 5 |
...
| `docs/design/thruster-charge-20260910.md` | 推进器周期爆发 + 高威胁近战敌突进（2026-09-10 · 状态：已确认并实现） | 已确认/已实现（已确认并实现） | 2026-09-10 | 10 KB / 126 行 | 8 / 1 |
...
- `docs/design/courier-home-origin-20260920.md`（2026-09-20 · 5 KB）—— 快递任务：出发地钉成母港（不在母港则自动返航）· 2026-09-20
- `docs/design/find-humans-gate-20260920.md`（2026-09-20 · 6 KB）—— 「寻找人类」发布闸门：全部「第一次」完成后才出现（2026-09-20）
- `docs/design/first-task-flow-inventory-20260920.md`（2026-09-20 · 20 KB）—— 「第一次」13 步全清点：会发生什么 · 通讯 · 任务文本（2026-09-20）
- `docs/design/first-task-order-gate-20260920.md`（2026-09-20 · 8 KB）—— 「第一次」队列：未显示的任务不许提前完成（判定与显示同一把尺）· 2026-09-20
- `docs/design/foe-a-minrange-20260920.md`（2026-09-20 · 7 KB）—— A 族全族贴脸：除劫掠狙击舰外，最小射程改为 1（2026-09-20）
- `docs/design/haul-interrupt-warning-20260920.md`（2026-09-20 · 6 KB）—— 「第一次采集原矿」换船引导 ＋ 100 橄榄岩补偿 ＋ 长途运输中断警告（2026-09-20）
- `docs/design/matter-tech-t4-ai-20260920.md`（2026-09-20 · 5 KB）—— 谜质科技 · 洞外工业新增 T4「工业多核调度」（工业 AI 工位上限 +1/级 · 5 级）· 2026-09-20
- `docs/design/part-card-batch-20260920.md`（2026-09-20 · 6 KB）—— 零件卡产物行补"每批 10 件" ＋ 精炼增幅基线读数（2026-09-20）
- `docs/design/player-bugs-wh-fight-click-ach-20260920.md`（2026-09-20 · 11 KB）—— 玩家报障三件：遗迹收尾战 · 虫洞地图点不动 · 已建成的空间站拿不到成就（2026-09-20）
- `docs/design/salvage-hint-and-industry-gate-20260920.md`（2026-09-20 · 7 KB）—— 打捞门槛提示（＋去装配入口）与工业页解锁改挂「第一次操作精炼炉」（2026-09-20）
- `docs/design/thruster-stacking-additive-20260920.md`（2026-09-20 · 4 KB）—— 推进器多件：由「EVE 曲线乘算」改为「折权加算」（2026-09-20）
- `docs/design/wh-beacon-rate-20260920.md`（2026-09-20 · 4 KB）—— 虫洞信标：出现率 50% + 每层保底 1 个（2026-09-20）
...
## 附：状态未标注（157 份，待补一行 `状态：…`）

- `docs/design/archive/announcement-draft-20260920-parts-shipyard.md`（2026-09-20）—— 待审稿 · 2026-09-20 推送批（零件体系 / 造船厂 / 机群补足）
- `docs/design/chain-time-ratio-plan-20260920.md`（2026-09-20）—— 方案：链上耗时比 4 : 2 : 1（原矿→原材料→零件→高级零件）· 2026-09-20
