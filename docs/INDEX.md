...
- 文档总数 **269** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5018** KB · **36639** 行
...
| `docs/design/wh-dmg-retune-20260916.md` | 洞内伤害重调（全族 ×0.7 降火 · 错开首轮 · D 族血火力重配 · 炮台增程距离门）· 工作文档 | 进行中（进行中） | 2026-09-16 | 5 KB / 70 行 | 0 / 2 |
