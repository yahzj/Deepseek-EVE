...
- 文档总数 **307** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5783** KB · **41090** 行
- 状态分布：**未标注** 170 · **已确认/已实现** 111 · **进行中** 22 · **待裁定** 3 · **历史留档** 1
...
|---|---|---|---|---|---|
| `AGENTS.md` | AGENTS.md — 大鲸鱼-深空放置 · 仓库级 AI 工作约定(开工必读) | 未标注 | — | 14 KB / 97 行 | 163 / 5 |
...
| `docs/design/ironman-compensation-20260924.md` | 工作文档 · 玩家存档「补偿性开启铁人模式」（2026-09-24 · 三号） | 已确认/已实现（已完成） | 2026-09-24 | 4 KB / 58 行 | 0 / 0 |
...
- `docs/design/ironman-compensation-20260924.md`（2026-09-24 · 4 KB）—— 工作文档 · 玩家存档「补偿性开启铁人模式」（2026-09-24 · 三号）
