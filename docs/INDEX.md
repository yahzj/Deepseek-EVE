...
- 文档总数 **297** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5633** KB · **40594** 行
- 状态分布：**未标注** 165 · **已确认/已实现** 110 · **进行中** 16 · **待裁定** 5 · **历史留档** 1
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 107 KB / 432 行 | 277 / 14 |
...
| `docs/design/core-smelting-all-workers-20260922.md` | 炉心熔炼学改为对所有劳动者生效（2026-09-22 · 船长令） | 待裁定（已实现并验证 · 待船长验收） | 2026-09-22 | 4 KB / 63 行 | 0 / 0 |
...
- `docs/design/core-smelting-all-workers-20260922.md`（2026-09-22 · 4 KB）—— 炉心熔炼学改为对所有劳动者生效（2026-09-22 · 船长令）
