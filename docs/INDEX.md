...
- 文档总数 **327** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6069** KB · **42692** 行
- 状态分布：**未标注** 180 · **已确认/已实现** 111 · **进行中** 28 · **待裁定** 7 · **历史留档** 1
- 孤儿文档（0 引用）**43** 份 · 状态未标注 **180** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/development-conventions-changelog.md` | 开发约定 · 变更记录（development-conventions.md 的历次变更） | 未标注 | — | 213 KB / 252 行 | 14 / 2 |
| `docs/development-conventions.md` | 开发约定（Development Conventions） | 未标注 | — | 64 KB / 685 行 | 75 / 3 |
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 481 KB / 987 行 | 217 / 16 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 106 KB / 316 行 | 328 / 17 |
...
| `docs/design/cpu-blueprint-rarity-20260926.md` | 协处理器 MK1/MK2 蓝图：稀有度比产物高一级（2026-09-26） | 待裁定（已实现 · 待船长验收） | 2026-09-26 | 3 KB / 48 行 | 0 / 0 |
...
| `docs/design/ship-attr-ia-20260926.md` | 舰船属性表信息架构调整（动力 → 间接属性 · 机动速度进主表 · 括号瘦身） | 未标注 | 2026-09-26 | 6 KB / 73 行 | 0 / 0 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/glossary-en.md` | 英文术语与专名译名表（English Glossary & Naming Table） | 未标注（P0 已冻结） | — | 43 KB / 764 行 | 13 / 15 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/test-saves/README.md` | 测试门槛存档（Test Saves） | 未标注 | — | 67 KB / 677 行 | 56 / 13 |
...
- `docs/design/cpu-blueprint-rarity-20260926.md`（2026-09-26 · 3 KB）—— 协处理器 MK1/MK2 蓝图：稀有度比产物高一级（2026-09-26）
...
- `docs/design/ship-attr-ia-20260926.md`（2026-09-26 · 6 KB）—— 舰船属性表信息架构调整（动力 → 间接属性 · 机动速度进主表 · 括号瘦身）
