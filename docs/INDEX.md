...
- 文档总数 **301** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5661** KB · **40946** 行
- 状态分布：**未标注** 165 · **已确认/已实现** 111 · **进行中** 18 · **待裁定** 6 · **历史留档** 1
...
| `docs/design/offline-faction-day-20260922.md` | 离线跨天时「敌对派系活跃」按哪一天算（船长之问 · 已查明，附读数）· 2026-09-22 | 待裁定（待裁决） | 2026-09-22 | 6 KB / 60 行 | 0 / 0 |
...
- `docs/design/offline-faction-day-20260922.md`（2026-09-22 · 6 KB）—— 离线跨天时「敌对派系活跃」按哪一天算（船长之问 · 已查明，附读数）· 2026-09-22
