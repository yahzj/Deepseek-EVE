...
- 文档总数 **332** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6071** KB · **44057** 行
...
| `docs/design/announcement-draft-20260925-weekend-invasion.md` | 公告待审稿 · 周末星域入侵（新玩法）（2026-09-25） | 未标注（船长已定稿 · 待发布） | 2026-09-25 | 6 KB / 67 行 | 0 / 3 |
