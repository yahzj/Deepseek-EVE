...
- 文档总数 **321** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **5924** KB · **42597** 行
- 状态分布：**未标注** 171 · **已确认/已实现** 111 · **进行中** 35 · **待裁定** 3 · **历史留档** 1
- 孤儿文档（0 引用）**48** 份 · 状态未标注 **171** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
|---|---|---|---|---|---|
| `AGENTS.md` | AGENTS.md — 大鲸鱼-深空放置 · 仓库级 AI 工作约定(开工必读) | 未标注 | — | 14 KB / 97 行 | 171 / 5 |
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 464 KB / 985 行 | 214 / 16 |
...
| `docs/design/rare-supply-single-piece-20260925.md` | 稀有供给单「每次恒 1 件」（2026-09-25） | 进行中（进行中 —— 改动已落码） | 2026-09-25 | 4 KB / 72 行 | 0 / 0 |
...
| `docs/design/weekend-flagship-prep-20260925.md` | 旗舰战入口 ＋ 战前准备界面（选船） | 进行中（进行中） | 2026-09-25 | 27 KB / 218 行 | 0 / 0 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/test-saves/README.md` | 测试门槛存档（Test Saves） | 未标注 | — | 61 KB / 611 行 | 55 / 10 |
...
- `docs/design/rare-supply-single-piece-20260925.md`（2026-09-25 · 4 KB）—— 稀有供给单「每次恒 1 件」（2026-09-25）
...
- `docs/design/weekend-flagship-prep-20260925.md`（2026-09-25 · 27 KB）—— 旗舰战入口 ＋ 战前准备界面（选船）
