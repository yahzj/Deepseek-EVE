...
- 文档总数 **334** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6192** KB · **43591** 行
- 状态分布：**未标注** 181 · **已确认/已实现** 111 · **进行中** 30 · **待裁定** 11 · **历史留档** 1
- 孤儿文档（0 引用）**48** 份 · 状态未标注 **181** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
...
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 98 KB / 343 行 | 330 / 18 |
...
| `docs/archive/roadmap-2026-09-24.md` | 封存卷 · roadmap 批次条目 2026-09-24 | 未标注 | — | 35 KB / 30 行 | 1 / 0 |
| `docs/archive/roadmap-2026-09-25-26.md` | 封存卷 · roadmap 批次条目 2026-09-25/26 | 未标注 | — | 9 KB / 10 行 | 0 / 0 |
| `docs/archive/roadmap-2026-09-25.md` | 封存卷 · roadmap 批次条目 2026-09-25 | 未标注 | — | 28 KB / 24 行 | 1 / 0 |
