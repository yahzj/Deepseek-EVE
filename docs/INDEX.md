...
- 文档总数 **330** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6184** KB · **43124** 行
...
| `docs/design/invasion-kill-roll-20260926.md` | 报障分析：入侵活动里「没有判定击杀」（2026-09-26 晚 · 二号 · d2） | 未标注（根因已定位 · 缺失的那一掷已修） | 2026-09-26 | 6 KB / 102 行 | 0 / 0 |
...
| `docs/design/standing-clawback-blackbox-20260926.md` | 声望账本回正 ＋ 入侵黑匣补发（2026-09-26 晚 · 二号 · d2） | 待裁定（已实现 · 待船长验收） | 2026-09-26 | 9 KB / 120 行 | 0 / 0 |
