...
- 文档总数 **332** 份（本表收录 `docs/**/*.md` + 根 `AGENTS.md`）· 合计 **6069** KB · **44033** 行
- 状态分布：**未标注** 172 · **已确认/已实现** 111 · **进行中** 38 · **待裁定** 10 · **历史留档** 1
- 孤儿文档（0 引用）**55** 份 · 状态未标注 **172** 份
- 一、权威文档（开工必读）：**8** 份
- 七、评审与体检（review）：**10** 份
- 三、现行设计稿（design）：**218** 份
...
| `docs/glossary.md` | 术语词典（Glossary） | 未标注 | — | 464 KB / 985 行 | 216 / 16 |
| `docs/roadmap.md` | 后续工作流备忘（Roadmap / Backlog） | 未标注 | — | 101 KB / 321 行 | 302 / 17 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/design/announcement-draft-20260925-save-guard.md` | 公告待审稿 · 存档更稳（2026-09-25） | 待裁定（待船长审核） | 2026-09-25 | 2 KB / 34 行 | 0 / 0 |
| `docs/design/announcement-draft-20260925-weekend-invasion.md` | 公告待审稿 · 周末星域入侵（新玩法）（2026-09-25） | 待裁定（待船长审核） | 2026-09-25 | 4 KB / 43 行 | 0 / 0 |
...
| `docs/design/weekend-flagship-prep-20260925.md` | 旗舰战入口 ＋ 战前准备界面（选船） | 进行中（进行中） | 2026-09-25 | 91 KB / 723 行 | 1 / 0 |
...
| `docs/design/foe-faction-identity-20260910.md` | 敌族特色 · 设定草案（2026-09-10 · 逐族商讨中） | 未标注 | 2026-09-10 | 24 KB / 203 行 | 26 / 0 |
...
| 文档 | 标题 | 状态 | 日期 | 体量 | 被引（文档/代码） |
|---|---|---|---|---|---|
| `docs/glossary-en.md` | 英文术语与专名译名表（English Glossary & Naming Table） | 未标注（P0 已冻结） | — | 43 KB / 764 行 | 11 / 14 |
...
- `docs/design/announcement-draft-20260925-save-guard.md`（2026-09-25 · 2 KB）—— 公告待审稿 · 存档更稳（2026-09-25）
- `docs/design/announcement-draft-20260925-weekend-invasion.md`（2026-09-25 · 4 KB）—— 公告待审稿 · 周末星域入侵（新玩法）（2026-09-25）
